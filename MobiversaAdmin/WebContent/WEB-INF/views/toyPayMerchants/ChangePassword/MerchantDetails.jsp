         ...
         <h3 >Merchant List</h3>
				...
				<select name="merchantName" style="width:100%"  class="browser-default select-filter"
								...
								<c:forEach items="${merchant1}" var="merchant1">
									...
									<option value="${pageContext.request.contextPath}/superagent/MerchantDetailsToChangePasswordByToypay?mid=${merchant1.id}">
...
Change MobileApp User Password</button></center>
  ...
  <style>
 	...
 	<form method="get"  id="form"
			name="form" action="${pageContext.request.contextPath}/superagent/ChangeMerchPassByToypay" >
...
Submit</button>
  ...
  <form method="get"  id="form"
			name="form" action="${pageContext.request.contextPath}/superagent/ChangeMobileuserPassByToypay">

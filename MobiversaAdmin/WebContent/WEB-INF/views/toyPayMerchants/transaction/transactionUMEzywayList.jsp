...
function openNewWin(mrn,merchantid){
	//alert(txnID);
	
	var url=window.location;
	//alert(url);
	var src = document.getElementById('popOutiFrame').src;
	 src=url+'transactionUmweb/UMdetailsAgent/'+mrn+'/'+merchantid;
	//    alert(src);
	//src = pdffile_url;
	//alert(src);
	var h = 600;
...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/superagent/transaction/searchUMEzyway?date='
	...
	function loadExpData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/superagent/transaction/umEzywayExport?fromDate=' +fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/superagent/transaction/umEzywayExport?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
					  ...
					  <div class="col s12">
					      <div class="card border-radius">
							...
							<a href="javascript:void(0)" id="openNewWin"
											onclick="javascript: openNewWin('${dto.f263_MRN}','${dto.merchantId}')">

      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Master Merchant Volume Summary</strong></h3>
          </div>
					...
					<h3 >Merchant Details</h3>
					   ...
					   <select   id="merchantName" path="merchantName"
					    class="browser-default select-filter">
							<%-- <input type="hidden" value="${merchant1.merchantType}" name="type" path="type"/> --%>									
								...
								<c:forEach items="${merchant1}" var="merchant1">
									<option value="${pageContext.request.contextPath}/agentVolume/listmastermerchantvolumesummary?id=${merchant1.mmId}">
										${merchant1.username}~${merchant1.mmId}
					...
					<div class="row">
					  <div class="col s12">
					      <div class="card border-radius">
					        <div class="card-content padding-card">
					         <div class="d-flex align-items-center">
					         <h3> Master Merchant Volume Summary</h3>
					         </div>

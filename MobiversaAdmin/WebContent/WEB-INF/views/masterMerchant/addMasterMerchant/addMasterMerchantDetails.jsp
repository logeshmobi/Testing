...
var an1 = document.getElementById("agentName").value;
...
<body onload="disableRow()">
	<form:form method="post" action="masterMerchant/addMasterMerchant" commandName="masterMerchant"
		name="form1" id="form1">
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Add Master Merchant </strong></h3>
          </div>         
        ...
        <div class="card-content padding-card">
						...
						<div class="row">
							<div class="input-field col s12 m6 l6 ">
								...
								<div class="input-field col s12 m6 l6 ">
									<label for="Email">Master Merchant Id</label>
									<form:input type="text" class="" id="mmId"
										path="mmId" name="mmId" placeholder="MasterMerchantId" />
						...
						<form:select class="" name="agentName" id="agentName"
						path="agentName">
						<form:option value="">Agent Name</form:option>
								<c:forEach items="${agentNameList}" var="agentName">
								<option  value="${agentName}">${agentName}</option>
			</c:forEach>
			</form:select>
			<label for="Address2">Agent Name</label>

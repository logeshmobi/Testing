        	...
        	<div class="row">
							...
							<div class="input-field col s12 m5 l5">
								...
								<c:forEach items="${merchant1}" var="merchant1">
									<option value="${pageContext.request.contextPath}/MDR/updateMDRMerchant?id=${merchant1.id}">
...
.select-search-hidden .select2-container{
	display:none !important;
              ...
              <thead>
									...
									<th>Brand</th> 
									<th>Created Date</th> 
									<th>Credit Domestic Host MDR</th> 
									<th>Credit Domestic Merchant MDR</th> 
									<th>Credit Foreign Host MDR</th> 
									<th>Credit Foreign Merchant MDR</th> 
									<th>Debit Domestic Host MDR</th> 
									<th>Debit Domestic Merchant MDR</th> 
									<th>Debit Foreign Host MDR</th> 
									<th>Debit Foreign Merchant MDR</th> 
									<th>Settle Period</th> 
									<th>Pay Later</th> 
									<th>Amount</th> 
									<th>Action</th> 
									...
									<tbody id="prodReportTable">
										<c:forEach items="${paginationBean.itemList}" var="dto">
											<tr>
													...
													<td>${dto.creditLocalHostMDR}</td>
													<td>${dto.creditLocalMerchantMDR}</td>
													
													<td>${dto.creditForeignHostMDR}</td>
													<td>${dto.creditForeignMerchantMDR}</td>
													
													<td>${dto.debitLocalHostMDR}</td>
													<td>${dto.debitLocalMerchantMDR}</td>
													
													<td>${dto.debitForeignHostMDR}</td>
													<td>${dto.debitForeignMerchantMDR}</td>
													
													<td>${dto.settlePeriod}</td>
													<td>${dto.payLater}</td>
													<td style="text-align:right;">${dto.amount}</td>
													<td>${dto.installment}</td>		
													
											<td><a style="margin-left: -43px !important;"
											href="${pageContext.request.contextPath}/MDR/changeMDRDetails/${dto.mid}">

...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == '' &&  e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/settlementMDRMerchant?date='
	...
	function loadExpData() {
		...
		if (fromdateString == '' &&  e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/settlementMDRExport?fromDate=' + fromdateString + '&id=' + e1 +'&export='+e2; 
			//form.submit;
			//document.getElementById("dateval1").value = e;
			//document.getElementById("dateval2").value = e1;
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Settlement MDR</strong></h3>
          </div>
					...
					<div class="input-field col s12 m5 l5">
						<select name="merchantName" id="merchantName"   class="browser-default select-filter"
											...
											<c:forEach items="${merchant1}" var="merchant1">
											   <option value="${merchant1.id}" >${merchant1.businessName}~${merchant1.username}~${merchant1.role}</option>
											</c:forEach>
										</select>
															</div>	
            ...
            <thead align="center">
					...
					<tbody id="prodReportTable">
						<c:forEach items="${paginationBean.itemList}" var="dto">
							<tr>
							<fmt:parseDate value="${dto.settlementDate}" pattern="yyyy-MM-dd HH:mm:ss" var="myDate"/>

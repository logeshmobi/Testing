...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == '' &&  e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/bizappSettlementMDRMerchant?date='
	...
	function loadExpData() {
		...
		if (fromdateString == '' &&  e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/bizappSettlementMDRExport?fromDate=' + fromdateString + '&id=' + e1 +'&export='+e2; 
			//form.submit;
			//document.getElementById("dateval1").value = e;
			//document.getElementById("dateval2").value = e1;
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Bizapp Settlement MDR</strong></h3>
          </div>
            ...
            <thead align="center">
					...
					<tbody id="prodReportTable">
						<c:forEach items="${paginationBean.itemList}" var="dto">
							<tr>
							<fmt:parseDate <c:out value="${dto.settlementDate}"/> pattern="dd/MM/yyyy" var="myDate"/>

									<td><fmt:formatDate pattern="dd/MM/yyyy" <c:out value="${myDate}"/> /></td> 									

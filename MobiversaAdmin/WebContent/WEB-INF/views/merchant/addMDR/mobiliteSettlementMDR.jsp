...
<script lang="JavaScript">
	function loadSelectData() {
		...
		var e1 = document.getElementById("merchantName").value;
		...
		if (e == '' &&  e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/mobiliteSettlementMDRMerchant?date='
					+ fromdateString + '&id=' + e1 ;
			//form.submit;
			//document.getElementById("dateval1").value = e;
			//document.getElementById("dateval2").value = e1;
	...
	function loadExpData() {
		...
		if (fromdateString == '' &&  e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/mobilitesettlementMDRExport?fromDate=' + fromdateString + '&id=' + e1 +'&export='+e2; 
			//form.submit;
			//document.getElementById("dateval1").value = e;
			//document.getElementById("dateval2").value = e1;
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Mobilite Settlement MDR</strong></h3>
          </div>
					...
					<div class="input-field col s12 m5 l5">
						<select name="merchantName" id="merchantName"   class="browser-default select-filter"
											...
											<c:forEach items="${merchant1}" var="merchant1">
											   <option <c:out value="${merchant1.id}"/>>${merchant1.businessName}~${merchant1.username}~${merchant1.role}</option>
											</c:forEach>
										</select>
															</div>	
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">
					...
					<div class="input-field col s12 m4 l4">
						<label for="from" style="margin:0px;">Settle Date</label>
						<input type="hidden"
					...
					<div class="input-field col s12 m4 l4 export_div">
					...
					<div class="input-field col s12 m4 l4" style="float:right;">
            ...
            <thead align="center">
					...
					<tbody id="prodReportTable">
						<c:forEach items="${paginationBean.itemList}" var="dto">
							<tr>
							<fmt:parseDate value="${dto.subSettleDate}" pattern="yyyy-MM-dd HH:mm:ss" var="myDate"/>
									...
									<c:choose>
                                            <c:when test="${not empty dto.invoiceId}">
                                            <td>${dto.invoiceId}</td>
                                              </c:when>
                                            <c:otherwise>
                                            <td></td>
							...
							<%-- <td align="center"><a class="fa fa-pencil" aria-hidden="true" 
							href="${pageContext.request.contextPath}/MDR/changeMDRDetails/${dto.mid}"></a></td> --%>
							</tr>
						</c:forEach>
					</tbody>
			</table>

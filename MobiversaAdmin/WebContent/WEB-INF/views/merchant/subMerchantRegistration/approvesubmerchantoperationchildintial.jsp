                ...
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="col s12 m4 l4 input-field businessname">
                            <label for="merchantName" id="label_businessname">Select Main Merchant</label>
                            ...
                            <optgroup label="Business Names" style="width: 100%">
                                ...
                                <c:forEach var="merchant" items="${mainmerchantList}">
                                   <%--  <c:if test="${merchant[0] != ''}"> --%>
                                        <option value="${pageContext.request.contextPath}/submerchant/risk-compilence/search/submerchant?mmId=${merchant.mmId}&merchantName=${merchant.businessName}">
                    ...
                    <div class="">
                        ...
                        <div class="table-responsive m-b-20 m-t-15" id="page-table">
                            <table id="data_list_table"
                                ...
                                <c:forEach items="${submerchantList}" var="submerchantList">
                                    <tr>
                                        <%-- <td>${submerchantList.createdDate}</td>
                                        <td>${submerchantList.merchant.businessName}</td>
                                        <td>${submerchantList.merchant.mid.subMerchantMID}</td>
                                        <td>${submerchantList.merchant.mmId}</td> --%>
                                        ...
                                        <td style="text-align: -webkit-center;" id="more_details">
                                            <button class="btn_more"
                                                    onclick="openMoreDetailsPopup('<c:out value="null"/>')">
                                                <img
                    ...
                    <div id="result-modal" class="result_modal">
                        ...
                        <div class="modal-content ">
                            <div class="align-center">
                                <img id="result_popup_image" src="${pageContext.request.contextPath}/resourcesNew1/assets/submerchantregister/Successful.svg" width="40" height="40">
                            </div>
                            <p id="result_popup_text" class="align-center popup_messages"></p>
                        </div>
                        <div class="align-center modal-footer footer">
                            <button id="closebtn_result" class="btn blue-btn closebtn" type="button" onclick="closeResultModal()" name="action">Close</button>
            ...
            <div class="row modal_row">
                <div class="col offset-l3 offset-m2 s12 m8 l7">
                    <div id="preview-modal" class="preview_modal">
                        ...
                        <div class="modal-header">
                            <p class="mb-0  popup_head">Sub Merchant Preview <a id="close_xmark" onclick="closePreviewPopup()">
                                <img src="${pageContext.request.contextPath}/resourcesNew1/assets/submerchantregister/cross_mark.svg" width="12" height="12">
                            </a></p>
                        ...
                        <div class="align-center modal-footer footer">
                            <button id="closebtn_preview" class="btn blue-btn closebtn" type="button" onclick="closePreviewPopup()" name="action">Close</button>
...
<%--        action popup --%>
                    ...
                    <div id="action-modal" class="action_modal">
                     ...
                     <form action="${pageContext.request.contextPath}/submerchant/risk-compilence/validate" id="approvalform" method="post">
                         ...
                         <div class="modal-content confirm_modal_content ">
                            <div class="align-center">
                                <img id="statusImage" src="${pageContext.request.contextPath}/resourcesNew1/assets/submerchantregister/addsubmerchant.svg" width="45" height="45">
                            </div>
                            

                            <div class="radio-group">
                                <label>
                                    <input type="radio" id="approved" name="decision" value="approve" checked onchange="updateContent()">
                                    <span class="label_text">Approve</span>
                                </label>
                                <label>
                                    <input type="radio" id="rejected" name="decision" value="reject" onchange="updateContent()"> 
                                    <span class="label_text">Rejected</span>
                                </label>
                            </div>
                        ...
                        <div class="align-center modal-footer footer">
                            <button id="close_btn" class="btn cancelbtn" type="button" onclick="closeMoredetailsPopup()" name="action">Cancel</button>
                            <button id="submit_approvalresult_btn" class="btn confirmbtn " type="submit">Proceed</button>
        ...
        <input type="hidden" id="pgnum"> <input type="hidden" id="FromDate">
        <input type="hidden" id="ToDate">
        <input type="hidden" id="merchantId">
        <input type="hidden" id="approve_result" value="">

...
<head>
    ...
    <title>SubMerchant Summary</title>    
...
$(document).ready(function() {
	...
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/admmerchant/submersearch?date='
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			//alert("test2: " + e + " " + e1);
			document.location.href = '${pageContext.request.contextPath}/admmerchant/submerexport?date='

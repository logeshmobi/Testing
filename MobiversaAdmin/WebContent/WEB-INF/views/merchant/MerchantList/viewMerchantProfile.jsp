				...
				<div class="card border-radius">
					<div class="card-content padding-card">
						...
						<div class="row">
							...
							<c:if test="${merchant.mid.tngMid!=null}">
								<div class="input-field col s12 m6 l6 ">



									<label for="MID">TNG MID</label> <input class="form-control"
										type="text" placeholder="TngMid" name="TngMid" id="TngMid"
										path="TngMid" value="${merchant.mid.tngMid}"
										readonly="readonly">
								</div>
							</c:if>

							<c:if test="${merchant.mid.shoppyMid!=null}">
								<div class="input-field col s12 m6 l6 ">



									<label for="MID">SHOPPY MID</label> <input class="form-control"
										type="text" placeholder="ShoppyMid" name="ShoppyMid"
										id="ShoppyMid" path="ShoppyMid"
										value="${merchant.mid.shoppyMid}" readonly="readonly">
								</div>
							</c:if>

							<c:if test="${merchant.mid.bnplMid!=null}">
								<div class="input-field col s12 m6 l6 ">

									<label for="MID">BNPL MID</label> <input class="form-control"
										type="text" placeholder="bnplMid" name="bnplMid" id="bnplMid"
										path="bnplMid" value="${merchant.mid.bnplMid}"
										readonly="readonly">
								</div>
							</c:if>

							
							<c:if test="${merchant.mid.fiuuMid != null}">
								<div class="input-field col s12 m6 l6 ">
									<label for="MID">FIUU MID</label> <input class="form-control"
										type="text" placeholder="fiuuMid" name="fiuuMid" id="fiuuMid"
										path="fiuuMid" value="${merchant.mid.fiuuMid}"
										readonly="readonly">
								</div>
							</c:if>


							<c:if test="${merchant.auth3DS!=null}">
								<div class="input-field col s12 m6 l6 ">
									<label for="auth_3ds">3DS</label> <input type="text"
										placeholder="AUTH_3DS" name="AUTH_3DS" id="auth_3ds"
										value="${merchant.auth3DS}" readonly="readonly" path="auth3DS">
							...
							<c:if test="${hDetails.bankName!=null}">
							<%-- 	<div class="input-field col s12 m6 l6 ">
									<label for="PREVIOUS_HOST_BANK">MERCHANT PREVIOUS BANK</label>
									<input type="text" placeholder="PREVIOUS_HOST_BANK"
										name="PREVIOUS_HOST_BANK" id="previous_host_bank"
										value="${prevBank.bankName}" readonly="readonly"
										path="previousBank">
								</div> --%>
								<div class="input-field col s12 m6 l6 ">
									<label for="CURRENT_BANK">MERCHANT CURRENT BANK</label> <input
										type="text" placeholder="CURRENT_BANK" name="CURRENT_BANK"
										id="current_bank" value="${hDetails.bankName}"
										readonly="readonly" path="currentBank">

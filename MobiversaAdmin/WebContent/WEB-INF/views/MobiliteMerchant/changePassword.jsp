...
<%@page
	import="com.mobiversa.payment.controller.MobiliteWebController"%>
...
//new changes  for email validation 18082017
...

{
   //alert("test data 11111");
	...
	return false;
	      ...
	      alert("Error: password must contain alpha numeric with special Characters Eg:GVVx11!");
	      //form1.e.focus();
	      return false;
 ...
 <div class="row">
  <div class="col s12">
	...
	<form method="post" name="form1"
		action="<c:url value='/mobilite/merchProf/confirmPasswordbyMerch' />"  onsubmit="return checkPassword();">  <!-- onsubmit="return checkPassword();" -->
<div class="row">
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">
          <div class="d-flex align-items-center">
           ...
           <b><input style="border-bottom:0px!important; color:#005baa;" type="text" value ="${merchant.username}" readonly> </b></h5>

...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/merchantpreauth/searchPreAuthPaydee?date='
	...
	function loadExpData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/merchantpreauth/ExportPreAuthPaydee?fromDate=' + fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/merchantpreauth/ExportPreAuthPaydee?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
						...
						<div class="row">
							...
							<div class="input-field col s12 m3 l3">
								...
								<input  type="hidden" name="export1" id="export1"
									...
									id="export" class="export" onchange="return loadDropDate13();">
...
/* 	$(function () {
        $(".datepicker").datepicker({ changeMonth: true,
            ...
            buttonImage: 'resourcesNew1/dist/css/images/calendar.gif',
            dateFormat: 'dd/mm/yy',
        });}); */
...
$(document).ready(function() {
	...
	dto.status =='PREAUTH' || dto.status =='PRE-AUTHORIZATION' || dto.status =='PREAUTH SALE'|| dto.status =='PREAUTH CANCEL'
													...
													<a href="javascript:void(0)" id="openNewWin"
														onclick="javascript: openNewWin('${dto.itxnid}')"> <img

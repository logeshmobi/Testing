			...
			<div class="card border-radius">
				<div class="card-content padding-card">
					<form:form method="post" id="form1" name="form1"
						commandName="preAuth"
						action="${pageContext.request.contextPath}/merchantpreauth/ProcessPreAuthVoid">
						...
						<div class="row">
							...
							<form:input type="hidden" value="${preAuth.tid}" path="tid" />
							<form:input type="hidden" value="${preAuth.trxId}" path="trxId" />
							<form:input type="hidden" value="${preAuth.hostType}" path="hostType" />
								...
								<tbody>
									...
									<tr>
										<td><label class="control-label">Transaction
												Date/Time:</label></td>
										<td>${preAuth.date}&nbsp;${preAuth.time}</td>

									</tr>

									<tr>
										<td><label class="control-label">Amount</label></td>
										<td>${preAuth.amount}</td>
									...
									<tr>
										...
										<td>${preAuth.aidResponse}</td>

									</tr>

									<tr>
										<td><label class="control-label">Reference</label></td>
										<td>${preAuth.invoiceId}</td>

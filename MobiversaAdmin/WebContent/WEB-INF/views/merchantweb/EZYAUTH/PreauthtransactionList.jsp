...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/merchantpreauth/searchPreAuth?date='
	...
	function loadExpData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/merchantpreauth/ExportPreAuth?fromDate=' + fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/merchantpreauth/ExportPreAuth?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
...
document.getElementById('hide_rrn_'+id).style.display ="block";
		...
		 
		<script>
    function openDialog(transactionAmount,transactionid) {
         ...
         $.ajax({
   			...
   			success: function (result) {
   				...
   				{      
   					   ...
   					   var url = "${pageContext.request.contextPath}/merchantpreauth/PreAuthList";
									...
									<c:forEach items="${paginationBean.itemList}" var="dto"
										...
										<tr>
											...
											<td class='key_hover'><span
												...
												class="hide_key">${dto.approvalCode}</span></td>
											<td class='key_hover'><span
												onclick="show_rrn('${id.index}')" id="hide_rrn_${id.index}"><img
													class="w24" src='data:image/png;base64,<%=eyeimg%> ' /> </span> <span
												onclick="hide_rrn('${id.index}')" id="show_rrn_${id.index}"
												class="hide_key">${dto.reference}</span></td>

											<td><c:if test="${dto.status == 'PRE-AUTHORIZATION'}">
													<img onclick="openDialog('${dto.amount}','${dto.itxnid}')"
														class="w24" src='data:image/png;base64,<%=saleimg%> ' />
												</c:if></td>
											<td><c:if test="${dto.status == 'PRE-AUTHORIZATION'}">
													<a
														href="${pageContext.request.contextPath}/merchantpreauth/PreAuthVoid/${dto.itxnid}">
			...
			<div class="input-field col s12 m6 l6 ">
				...
				<p>
					<label><input type="radio" checked="checked"
						name="preauth_amt" id="transactionAmount" value=""><span
			...
			<div class="input-field col s12 m6 l6 ">
				...
				<p>
					<label><input type="radio" name="preauth_amt"
						id="userAmount" value=""><span class="c969696">New
							Amount</span></label>
				</p>

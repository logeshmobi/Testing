...
function loadExportdata(){
	console.log("inside load date")
	 var type = document.getElementById("type").value;
		 var expt = document.getElementById("export").value;
	
	console.log(type+" "+ expt);
				...
				<div class="card border-radius">
					<div class="card-content padding-card">
						...
						<input type="hidden" name="export1" id="export1" <c:out value="${status}"/>>
							...
							<br>
							<button type="button"
								class="btn btn-primary curved-btn move-left" onclick="loadSelectDatasubmerchant()">search</button>
								
							<button type="button"
								class="btn btn-primary curved-btn move-left" onclick="loadExportdata()">Export</button>

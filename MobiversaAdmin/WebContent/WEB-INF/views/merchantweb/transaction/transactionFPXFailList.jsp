...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/SearchfpxfailList?date='
	...
	function loadExpData() {
	    ...
	    if (e == null || e == '' || e1 == null || e1 == '') {
	        ...
	        document.location.href = '${pageContext.request.contextPath}/transactionUmweb/exportFpxFailedTxnSummary?fromDate=' + fromdateString
				...
				<div class="card blue-bg text-white">
					<div class="card-content">
						<div class="d-flex align-items-center">
							<h3 class="text-white">
								<strong>FPX Failed Transaction</strong>
							</h3>
						</div>
							...
							<div class="col s12">
								<div class="input-field col s12 m3 l3"
									...
									<select name="drop_search" id="drop_search"
										...
										<option value="Ref">SellerOrderNo</option>
										<option value="Ap_Code">FpxTxnId</option>

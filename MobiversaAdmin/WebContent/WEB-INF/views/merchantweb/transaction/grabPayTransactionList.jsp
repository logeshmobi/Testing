...
function loadSelectData() {
	...
	if (e == '' && e1 == '' && e2 == '' && e3 == '' && e4 == '') {
		...
		/* alert("from date:"+ e);
		alert("todate:"+ e1); */
		document.form1.action = "${pageContext.request.contextPath}/transactionweb/searchgrabpay";
		//form.submit;
	...
	function loadData(num) {
		...
		/* if (e == null || e == '' ) {
			...
			form.submit = false;
				...
				&& (e4 == null || e4 == '')) {
			//alert('both $$ ##');
			document.location.href = '${pageContext.request.contextPath}/transactionweb/listgrabpay/'
					+ pnum;
			form.submit;
		} else {
			//alert("else : "+e+" "+e1);
			document.location.href = '${pageContext.request.contextPath}/transactionweb/searchgrabpay?fromDate='
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.form1.action = "${pageContext.request.contextPath}/transactionweb/grabpayExport";
        ...
        <div class="card-content padding-card">
								...
								<div class="row">
									...
									<div class="input-field col s12 m3 l3">
											...
											<a class="export-btn waves-effect waves-light btn btn-round indigo" href="javascript:vaoid(0);" onclick="return loaddata();"
									...
									<tbody>
										<c:forEach items="${paginationBean.itemList}" var="dto">
											<tr>
												...
												<%-- <td  align="center">
							<c:if test="${dto.status =='GRABPAY SETTLED' || dto.status =='GRABPAY PENDING' ||
							dto.status =='GRABPAY CANCELLED' || dto.status =='GRABPAY REFUND'||dto.status =='GRABPAY COMPLETED'}">

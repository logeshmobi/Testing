													...
													if (e == '' && e1 == '' && e2 == '') {
														...
														if (new Date(from) <= new Date(Checkdate) && new Date(to) <= new Date(Checkdate)) {
															...
															if (new Date(to) <= new Date(Checkdate)) {
																...
																//alert("from date:"+ e);
																//alert("todate:"+ e1);
																document.form1.action = "${pageContext.request.contextPath}/transactionweb/pdfdailysearchOld";
																//form.submit;
		...
		/* if (e == null || e == '' ) {
			...
			form.submit = false;
				...
				&& (e4 == null || e4 == '') */) {
														...
														//alert("else : "+e+" "+e1);
														document.location.href = '${pageContext.request.contextPath}/transactionweb/pdfdailysearchOld?fromDate='

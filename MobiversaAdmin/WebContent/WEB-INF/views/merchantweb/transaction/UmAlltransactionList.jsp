...
$('#export').select2();
	 ...
	 function loadSelectData() {
			...
			if (e == null ||e == '' || e1 == null || e1 == '') {
				...
				document.location.href = '${pageContext.request.contextPath}/transactionUmweb/allUmSearch1?date='
		...
		if((e == null || e == '') && (e1 == null || e1 == '') && (e3 == null || e3 == '')){
			...
			/* document.location.href = '/transaction1/search1?date=' + e
					+ '&date1=' + e1 +'&currPage='+pnum; */
					 document.getElementById("dateval1").value = e;
					document.getElementById("dateval2").value = e1;
			 document.location.href = '${pageContext.request.contextPath}/transactionUmweb/allUmSearch1?date=' + e
	...
	function loaddata() {
		...
		if(e == '' && e1 == '' && e3 == ''){
			...
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/allUmExport?date=' + fromdateString

...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionweb/searchmoto?fromDate='
										...
										<tr>
											...
											<td style="text-align: center;"><c:if
													...
													<c:if test="${dto.status =='NOT SETTLED'}">
														<a
															href="${pageContext.request.contextPath}<%=MerchantWebTransactionController.URL_BASE%>/motoCancelPayment/${dto.trxid}">
															<img class="w24"

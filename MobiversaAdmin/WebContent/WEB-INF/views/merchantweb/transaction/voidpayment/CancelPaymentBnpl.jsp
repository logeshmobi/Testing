...
/* 	document.getElementById('form1').action = '${pageContext.request.contextPath}/transactionweb/ezywaylist'; */
...
<form:form method="post" id="form1" name="form1" commandName="txnDet"
		action="${pageContext.request.contextPath}/transactionweb/cancelPaymentByMerchantBnpl" >
  ...
  <div class="col s12">
      <div class="card border-radius">
		...
		<div class="d-flex align-items-center">
			...
			<p><h3 style="color: blue;font-weight: bold;">${responseData}</h3><br></p>
			</c:when>
			<c:otherwise>
			<p><h3 style="color: blue;font-weight: bold;">Transaction Details to Void</h3></p>
					...
					<div class="row">
					        ...
					        <div class="d-flex align-items-center">
					        <h3 class="card-title">BNPL Transaction Details</h3>
							</div>
						...
						<form:input type="hidden" value="${txnDet.invoiceId}" path="invoiceId" />
						...
						<div class="input-field col s12 m6 l6 ">
											...
											<a href="${pageContext.request.contextPath}/admmerchant/merdashBoard"
											style="color:white;">Cancel</a> 
											</button> 
											
										</div>
											 	<%--  <button class="btn btn-primary">
											<a href="<%= response.encodeURL(response.encodeRedirectURL(request.getHeader("referer"))) %>"
											style="color:white;">Cancel</a> 
											</button> --%> 

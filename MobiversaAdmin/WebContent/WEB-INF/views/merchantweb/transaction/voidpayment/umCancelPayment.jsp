...
<form:form method="post" id="form1" name="form1" commandName="txnDet"
		action="${pageContext.request.contextPath}/transactionUmweb/cancelPaymentByAdmin1" >
				...
				<div class="row">
					...
					<!-- <div class="col-md-6">
						...
						<div class="d-flex align-items-center">
							...
							<table class="table table-striped" width="100%">
								...
								<tr>
									...
									<tr>
										<td><label>Approve Code:</label></td>
						...
						<div class="input-field col s12 m6 l6 ">
											...
											<a href="${pageContext.request.contextPath}/transactionUmweb/umEzywayList"

...
/* For screens with width greater than or equal to 1440px */
...
/* For screens with width greater than or equal to 2560px */
        ...
        <div class="col s12 m12 l5">
          <div class="card blue-bg text-white">
            <div class="card-content">
              <div class="">
                <div class="">
                  <div class="mb-10"><img src="${pageContext.request.contextPath}/resourcesNew1/assets/availablebalanceicon.svg" width="70" height="70"></div>
                  <div class="">
...
<%--       <c:if test="${rawPayoutBalancePageResponse.admin_username.toLowerCase() == rawPayoutBalancePageResponse.login_username.toLowerCase() }"> --%>
      ...
      <div class="col s12 m12 l7">
        ...
        <c:if test="${rawPayoutBalancePageResponse.admin_username.toLowerCase() == 'pcitest' || rawPayoutBalancePageResponse.admin_username.toLowerCase() == 'mobi' || rawPayoutBalancePageResponse.admin_username.toLowerCase() == 'kavin' || rawPayoutBalancePageResponse.admin_username.toLowerCase() == 'anusha' || rawPayoutBalancePageResponse.admin_username.toLowerCase() == 'muthukumar' ||  rawPayoutBalancePageResponse.admin_username.toLowerCase() == 'kanaha' ||  rawPayoutBalancePageResponse.admin_username.toLowerCase() == 'santhosh' || rawPayoutBalancePageResponse.admin_username.toLowerCase() == 'suvetha' }"><%--            finance login withdraw option --%><div class="col s12 m12 l7">
            <div class="card blue-bg text-white">
              <div class="card-content">
                <div class="">
                  <div class="header_text">
                    <div class="mb-10"><img src="${pageContext.request.contextPath}/resourcesNew1/assets/withdraw_icon_finance.svg" width="70" height="70"></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col s12 m6 l7">
                      <div class="input-field col s12 withdrawOption_Col" id="withdrawOption_Col"><select name="withdrawOption" id="withdrawOption">
                          ...
                          <option value="SettlementAdjustment">Withdraw Amount</option>
                          <c:if test="${rawPayoutBalancePageResponse.is_overdraft_available}">
                            <option value="OverDraftAdjustment">Overdraft Fee</option>
                          </c:if>
      ...
      <div id="resultOfCurrencyExchangeWithdrawModal" class="modal">
        <div class="modal-content">
          <div class="modal-header" style="padding: 12px 24px;border-bottom: 1.5px solid orange;">
          ...
          <div class="modal_body" style="padding:15px 24px;">
            <div style=" margin: 8px 0" class="">
              <div style="text-align: center"><img id="resultIcon" src="${pageContext.request.contextPath}/resourcesNew1/assets/Successful.svg" width="50" height="50"></div>
        ...
        <div class="modal-content">
          <div class="modal-header" style="padding: 12px 24px;border-bottom: 1.5px solid orange;">
            <h3 style="margin: 0;color: #005baa;font-size: 16px !important;font-weight: 500; text-align: center;">Confirm Withdraw Request</h3>
          </div>
          <div class="modal_body" style="padding:10px 24px;">
            <div style=" margin: 8px 0" class="">
              ...
              <p class=" fw-400" style="font-size: 16px; text-align: center; color:#2e2e2e;" id="confirmWithdrawContent"></p>
              <div>
              <p class="fw-400" style="font-size: 16px;margin-bottom: 4px; color:#2e2e2e;">Reason : </p>
              <textarea name="reasonforWithdraw" id="reasonforWithdraw" placeholder="Enter the reason for withdrawal" class="text-box"></textarea></div>
              <div>
          ...
          <div class="modal_footer" style="padding: 12px 24px;background: #eff8ff;border-bottom-right-radius: 10px;
                border-bottom-left-radius: 10px; display: flex; align-items: center;justify-content: center;"><button class="cancelbtn" type="button" id="cancel_Btn_Fin" style="font-size: 12px;width: 23%;padding: 10px; margin: 0 5px;">Cancel</button>
                <button class="withdrawbtn " type="button" id="confirmWithdrawBtn_Fin" style="font-size: 12px; width: 45%;padding: 10px; margin: 0 5px;">Confirm Withdrawal</button></div>
        </div>
      </div><%--       confirm overdraft popup for finance --%>
      <div id="confirmOverdraftRequest" class="modal">
        <div class="modal-content">
          <div class="modal-header" style="padding: 12px 24px;border-bottom: 1.5px solid orange;">
            <h3 style="margin: 0;color: #005baa;font-size: 16px !important;font-weight: 500; text-align: center;">Confirm Overdraft Request</h3>
          </div>
          <div class="modal_body" style="padding:10px 24px;">
            <div style=" margin: 8px 0" class="">
              <div style="text-align: center"><img src="${pageContext.request.contextPath}/resourcesNew1/assets/notify.svg" width="50" height="50"></div>
              <p class=" fw-400" id="confirmOverdraftContent" style="font-size: 16px; text-align: center;  color:#2e2e2e;"> </p>
              <div>
               <p class=" fw-400" style="font-size: 16px;margin-bottom: 4px;  color:#2e2e2e;">Reason : </p>
              <textarea name="reasonforOverdraft" id="reasonforOverdraft" placeholder="Enter the reason for withdrawal" class="text-box"></textarea></div>
              <div>
        ...
        <div><input type="hidden" id="available_balance" value="${rawPayoutBalancePageResponse.eligible_settlement_amount}" />
        <input type="hidden" id="withdrawRequestResult" value="${withdrawRequestResult}" />
        <input type="hidden" id="withdrawRequestResultAmount" value="${withdrawRequestResultAmount}" />
        <input type="hidden" id="merchant_id" value="${rawPayoutBalancePageResponse.merchant_id}" />
        <input type="hidden" id="finalEnteredAmount" value="" />
        <input type="hidden" id="finalEnteredAmountForFinance" value="" />
        <input type="hidden" id="totalAmountAfterFee" value="" />
        <input type="hidden" name="exchange_rate_fee" id="exchange_rate_fee" value="${rawPayoutBalancePageResponse.exchange_rate_fee}" />
		...
		<form id="withdrawForm" action="${pageContext.request.contextPath}/transactionUmweb/currency-exchange/confirm-notify" method="POST">
			<input type="hidden" name="actualAmount" id="formActualAmount" />
      ...
      <script>
        ...
        if (requestWithdrawBtnForFinance) {
          requestWithdrawBtnForFinance.onclick = function() {
            ...
            console.log("requestAmount  initially ::",requestAmount)
            console.log(adjustmentType);
            if (adjustmentType === 'SettlementAdjustment') {
              const confirmWithdrawRequest = document.getElementById('confirmWithdrawRequest');
              const confirmWithdrawContent = document.getElementById('confirmWithdrawContent')
              confirmWithdrawRequest.style.display = 'block';
              console.log("requestAmount  after click ::",requestAmount)
              confirmWithdrawContent.innerText = "You are requesting an withdraw of "+requestAmount+". Please confirm the amount before proceeding.";

            } else if (adjustmentType === 'OverDraftAdjustment') {
              const confirmOverdraftRequest = document.getElementById('confirmOverdraftRequest');
              const confirmOverdraftContent = document.getElementById('confirmOverdraftContent');
              confirmOverdraftRequest.style.display = 'block';
              console.log("requestAmount  after click ::",requestAmount)
              confirmOverdraftContent.innerText = "You are requesting an overdraft of "+requestAmount+". Please confirm the amount before proceeding.";
        ...
        if (cancel_Btn_Fin) {
          cancel_Btn_Fin.onclick = function() {
            const confirmWithdrawRequest = document.getElementById('confirmWithdrawRequest');
            var reasonforWithdraw = document.getElementById('reasonforWithdraw');
            reasonforWithdraw.value = "";
        ...
        if (cancel_Overdraft_Btn) {
          cancel_Overdraft_Btn.onclick = function() {
            const confirmOverdraftRequest = document.getElementById('confirmOverdraftRequest');
            var reasonforOverdraft = document.getElementById('reasonforOverdraft');
            reasonforOverdraft.value = "";
        ...
        if (requestAmountInput) {
          requestAmountInput.addEventListener('blur', function() {
            ...
            if ((finalEnteredAmount - available_balance) > 0) {
              ...
              showError("Minimum withdrawal amount is 5.00 RM", "errorMsgForFinance");
            } 
          });
        }
        ...
        var withdrawOption = document.getElementById('withdrawOption');
        if(withdrawOption){
        ...
        function submitWithdrawOptionRequest() {
          ...
          var requestAmount = document.getElementById("requestAmount").value;
          var amountWithoutCurrency = requestAmount.replace(/[^\d.-]/g, "");
          ...
          if (withdrawOption === 'SettlementAdjustment' && reasonforWithdraw.trim() === '') {
            showError('Please provide a reason for withdrawal.', 'popupErrorMsgForWithdraw');
            return;
          } else if (withdrawOption === 'OverDraftAdjustment' && reasonforOverdraft.trim() === '') {
            showError('Please provide a reason for overdraft.', 'popupErrorMsgForOverdraft');
            return;
          }
          if (withdrawOption === 'SettlementAdjustment') {
            $("#overlay").show();
            ...
            const confirmWithdrawRequest = document.getElementById('confirmWithdrawRequest');
            confirmWithdrawRequest.style.display = 'none';
            document.location.href = '${pageContext.request.contextPath}/transactionUmweb/refactoredWithDraw?finalwithdrawamount=' + amountWithoutCurrency + '&merchantId=' + merchantId + '&withdrawType=' + withdrawOption + '&withdrawalComment=' + reasonforWithdraw;
          } else if (withdrawOption === 'OverDraftAdjustment') {
            ...
            const confirmOverdraftRequest = document.getElementById('confirmOverdraftRequest');
            confirmOverdraftRequest.style.display = 'none';
            document.location.href = '${pageContext.request.contextPath}/transactionUmweb/refactoredWithDraw?finalwithdrawamount=' + amountWithoutCurrency + '&merchantId=' + merchantId + '&withdrawType=' + withdrawOption + '&withdrawalComment=' + reasonforOverdraft;
          }
        }
      ...
      document.addEventListener('DOMContentLoaded', function() {
    	  console.log("loaded...btnforfinance");
    	  console.log("withdrawRequestResult: "+ document.getElementById("withdrawRequestResult").value);
          ...
          var resultAmount = document.getElementById('withdrawRequestResultAmount').value;

          showResultModal(result,resultAmount);
        });
        ...
        function updateValuesInModal() {
          ...
          convertionRate = rate + ' ' + selectedCountry;
        ...
        function confirmWithdrawalRequest() {
          ...
          document.getElementById('formActualAmount').value = document.getElementById('amount').value;
        ...
        amountInput.addEventListener('input', function() {
          ...
          updateWithdraw(finalEnteredAmount.value);
        });
        }
        ...
        amountInput.addEventListener('blur', function() {
          ...
          console.log("finalEnteredAmount blur : ", finalEnteredAmount+" ::: "+" available_balance : ",available_balance);
          ...
          if ((finalEnteredAmount - available_balance) > 0) {
            ...
            showError("Minimum withdrawal amount is 5.00 RM", "errorMsg");
          }
        });
        }
        
        function updateWithdraw(finalEnteredAmount) {
            ...
            var exchangeRateFee = document.getElementById('exchange_rate_fee');

            if (withdrawAmtText && withdrawFeeText && totalAmountText && totalAmtAfterFee && exchangeRateFee) {
                finalEnteredAmount = parseFloat(finalEnteredAmount) || 0.00;
                var fee = parseFloat(exchangeRateFee.value.replace(/,/g, '')) || 0.00;

                // Calculate the withdrawal fee and total amount
                /* var withdrawalFee = (finalEnteredAmount * fee).toFixed(2); */
                
                var feeInActualValue = fee/100;
                var withdrawalFee = (finalEnteredAmount * feeInActualValue).toFixed(2)
...
/*         function updateWithdraw(finalEnteredAmount, fee) {
        ...
        var currencyCodeOption = document.getElementById('currencyCode');
        if(currencyCodeOption){
        currencyCodeOption.addEventListener('change', function() {
        ...
        function validateAndToggleButton() {
          ...
          var totalAmtAfterFee = parseFloat(document.getElementById('totalAmountAfterFee').value.replace(/,/g, ''));
          var btn = document.getElementById("requestWithdrawBtn");
          console.log("finalEnteredAmount : ", finalEnteredAmount+" ::: "+" available_balance : ",available_balance);
          if (finalEnteredAmount <= available_balance && finalEnteredAmount >= 5.00 && selectedCurrency !== '') {
            if(btn){
        	btn.disabled = false;
            btn.style.opacity = '1';
            btn.style.pointerEvents = "auto";
        ...
        function showResultModal(result,resultAmount) {
        	
          console.log("Result: "+ result +", Amount: "+ resultAmount);
          ...
          if (result) {
            if (result === 'merchantWithdrawSuccess') {
              resultModal.style.display = 'block';
              resultIcon.src = "${pageContext.request.contextPath}/resourcesNew1/assets/Successful.svg"
              resultContent.innerText = "Withdrawal request of "+resultAmount+" submitted successfully. You'll be notified once processing is complete.";
            } else if (result === 'financeWithdrawRequestSuccess') {
              resultModal.style.display = 'block';
              resultIcon.src = "${pageContext.request.contextPath}/resourcesNew1/assets/Successful.svg"
              resultContent.innerText = "Your Withdrawal request of "+resultAmount+" has been successfully submitted."
            } else if (result === 'financeOverdraftRequestSuccess') {
              resultModal.style.display = 'block';
              resultIcon.src = "${pageContext.request.contextPath}/resourcesNew1/assets/Successful.svg"
              resultContent.innerText = "Your Overdraft request of "+resultAmount+" has been successfully submitted."
            } else if (result === 'merchantWithdrawFailed') {
                resultModal.style.display = 'block';
                resultIcon.src = "${pageContext.request.contextPath}/resourcesNew1/assets/Declined.svg"
                resultContent.innerText = "We encountered an issue processing your withdrawal request for "+resultAmount+". Please Try again or contact support."
            } else if (result === 'financeWithdrawRequestFailed') {
                 resultModal.style.display = 'block';
                 resultIcon.src = "${pageContext.request.contextPath}/resourcesNew1/assets/Declined.svg"
                 resultContent.innerText = "We encountered an issue processing your withdrawal request for "+resultAmount+". Please Try again or contact support."
            } else if (result === 'financeOverdraftRequestFailed') {
                 resultModal.style.display = 'block';
                 resultIcon.src = "${pageContext.request.contextPath}/resourcesNew1/assets/Declined.svg"
                 resultContent.innerText = "We encountered an issue processing your overdraft request for "+resultAmount+". Please Try again or contact support."
            }
          } else {
            resultModal.style.display = 'none';
          }

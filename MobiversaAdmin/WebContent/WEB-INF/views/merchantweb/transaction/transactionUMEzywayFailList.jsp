...
.select-wrapper .caret {
	...
	tbody tr {  border-bottom: 1px solid #ffa500; color:#4377a2; }
...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/searchUMFailEzyway?date='
	...
	function loadExpData() {
		...
		var e2 = document.getElementById("export1").value;
		 ...
		 if (e2 !== 'EXCEL') {
		    alert("Please select 'EXCEL' from the export type dropdown menu.");
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/umEzywayFailExport?fromDate=' + fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/transactionUmweb/umEzywayFailExport?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
				...
				<div class="card blue-bg text-white">
					<div class="card-content">
						<div class="d-flex align-items-center">
							<h3 class="text-white">
								<strong>EZYWAY Transaction</strong>
							</h3>
						</div>
...
function loadSearch() {
    ...
    if (selectedOption === "") {
        ...
        var Value = document.getElementById("searchApi").value.trim(); // Trim to remove leading/trailing whitespace
        var TXNTYPE = 'EZYWAY_FAIL';
               ...
               <div class="card-content">
                      ...
                      <!-- SEARCH TEST -->
                        <div class="row" style="display:flex;align-items:center;justify-content:space-between;margin-left:01%;">
                           ...
                           <option value="Ref">RRN No</option>
                            </select>

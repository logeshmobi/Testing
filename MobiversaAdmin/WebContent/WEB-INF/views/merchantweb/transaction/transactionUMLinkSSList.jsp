...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/searchLinkSS?date='
	...
	function loadExpData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/ezyLinkSSExport?fromDate=' +fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/transactionUmweb/ezyLinkSSExport?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>EZYLINK_SS Transaction Summary</strong></h3>
          </div>
...
<div class="form-group col-md-4" id="divviewer" style="display: none;">
           ...
           <iframe id="popOutiFrame" frameborder="0" scrolling="no" width="800" height="600"></iframe>
			...
			<td>${dto.goodsStatus}</td>
			
		<td>${dto.updatedDate}</td> 
		
			
			<td><a href="${pageContext.request.contextPath}/transactionUmweb/getTrackData/${dto.f263_MRN}">

...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == '' && e1 == '' && e2 == '' && e3 == '' && e4 == '') {
			...
			//alert("from date:"+ e);
			//alert("todate:"+ e1);
			document.form1.action = "${pageContext.request.contextPath}/transactionweb/searchezypass";
			//form.submit;
	...
	function loadData(num) {
		...
		/* if (e == null || e == '' ) {
			...
			form.submit = false;
				...
				&& (e4 == null || e4 == '')) {
			//alert('both $$ ##');
			document.location.href = '${pageContext.request.contextPath}/transactionweb/ezypasslist/'
					+ pnum;
			form.submit;
		} else {
			//alert("else : "+e+" "+e1);
			document.location.href = '${pageContext.request.contextPath}/transactionweb/searchezypass?fromDate='
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			//alert(e);
			document.form1.action = "${pageContext.request.contextPath}/transactionweb/ezypassExport";
			//form.submit();
			document.form1.submit();
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong> EZYPASS Transaction Summary  </strong></h3>
          </div>

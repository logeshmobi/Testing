...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionweb/searchezyway?fromDate='
	...
	function loadExpData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/transactionweb/ezywayExport?fromDate=' + fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/transactionweb/ezywayExport?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
										...
										<tr>
											...
											<td style="text-align: center;"><c:if
													...
													<c:if
														...
														<a href="javascript:void(0)" id="openNewWin"
															...
															class="w24" src='data:image/png;base64,<%=actionimg%> ' /></a>
													</c:if>
												...
												<c:if test="${dto.cardscheme == 'SPP'}">
													<c:if
														test="${dto.status =='SETTLED' || dto.status =='NOT SETTLED'}">
														<a href="javascript:void(0)" id="openShopeeslip"
															onclick="javascript: openShopeepayslip('${dto.trxid}')">
															<img class="w24"
															src='data:image/png;base64,<%=actionimg%> ' />
														</a>
												...
												<c:if test="${dto.cardscheme == 'BNPL'}">
													<c:if
														test="${dto.status =='SETTLED' || dto.status =='NOT SETTLED'|| dto.status =='VOIDED'}">
														<a href="javascript:void(0)" id="openBnplslip"
															onclick="javascript: openBnplslip('${dto.trxid}')">
															<img class="w24"
															src='data:image/png;base64,<%=actionimg%> ' />
														</a>
												 ...
												 <c:set var="fpx" value="${dto.cardscheme}" /> <c:if
											...
											<td style="text-align: center;"><c:if
													...
													<c:if test="${dto.status =='NOT SETTLED'}">
														<a
															href="${pageContext.request.contextPath}<%=MerchantWebTransactionController.URL_BASE%>/cancelPayment/${dto.trxid}"><img
															class="w24" src='data:image/png;base64,<%=voidimg%> ' /></a>
													</c:if>
												</c:if>
											...
											<c:if
													test="${dto.cardscheme == 'BNPL'}">
													<c:if test="${dto.status =='NOT SETTLED'}">
														<a
															href="${pageContext.request.contextPath}<%=MerchantWebTransactionController.URL_BASE%>/bnplCancelPayment/${dto.trxid}"><img
															class="w24" src='data:image/png;base64,<%=voidimg%> ' /></a>
													</c:if>
												</c:if></td>

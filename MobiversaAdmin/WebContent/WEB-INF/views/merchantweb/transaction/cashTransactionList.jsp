...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionweb/searchcardtrans?fromDate='
	...
	function loadExpData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/transactionweb/exportCardTrans?fromDate=' + fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/transactionweb/exportCardTrans?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
									...
									<c:forEach items="${paginationBean.itemList}" var="dto"
										...
										<tr>
											...
											<td class='key_hover'><span
												...
												id="show_rrn_${id.index}" class="hide_key">${dto.rrn}</span></td>
											<td>${dto.status}</td>
											...
											<td style="text-align: center;"><c:if
													...
													<c:if
														...
														<a href="javascript:void(0)" id="openBoostslip"
															onclick="javascript: openBoostslip('${dto.rrn}')">
															<img class="w24"

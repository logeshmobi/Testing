...
/* function openNewWinezywire(txnID){
	//alert(txnID);
...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/searchUMEzyauth?date='
 ...
 /*  SEARCH FUNCTION HERE  */
	...
	function loadExpData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/umEzyauthExport?fromDate=' + fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/transactionUmweb/umEzyauthExport?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
									...
									<c:forEach items="${paginationBean.itemList}" var="dto"
										...
										<tr>
											...
											<td style="text-align: center;"><c:if
													test="${dto.cardType =='MOTOPREAUTH'}">

													<c:if
														test="${dto.STATUS =='PREAUTH' || dto.STATUS =='NOT SETTLED' || dto.STATUS =='VOIDED'}">
												...
												</c:if> <c:if test="${dto.cardType =='EZYWIREAUTH'}">

													<c:if
														test="${dto.STATUS =='SETTLED' || dto.STATUS =='NOT SETTLED' || dto.STATUS =='VOIDED' || dto.STATUS =='PREAUTH'}">
														<a href="javascript:void(0)" id="openNewWinezywire("
															onclick="javascript: openNewWin(
															 '${dto.date}',
                                                             '${dto.time}',
                                                             '${dto.f001_MID}',
											...
											<td style="text-align: center;"><c:if
													test="${(dto.cardType =='MOTOAUTH') && (dto.serviceId == 'FIUU' || dto.serviceId == 'UM')}">

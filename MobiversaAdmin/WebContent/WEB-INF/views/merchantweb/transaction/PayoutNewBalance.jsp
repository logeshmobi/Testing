													...
													<c:choose>
														<c:when test="${dto.depositamount == '200,000.00'}">
															...
															<button
																...
																style="background-color: #005baa; height: 40px; position: absolute; top: 0; right: 10rem;"
														...
														<c:otherwise>
															...
															<button onclick="refildeposit()"
																class="btn btn-primary custom-button w-25 float-start"
																style="background-color: #005baa; height: 40px; position: absolute; top: 0; right: 10rem;">Refill</button>
														</c:otherwise>
													</c:choose>
												</c:if>
												
												<c:if test="${merchantid=='4312'}">
													<c:choose>
														<c:when test="${dto.depositamount == '200,000.00'}">
	...
	text-decoration: none;
		...
		<div class="row justify-content-center">
			...
			<c:choose>
				...
				<c:when test="${adminusername.toLowerCase()=='pcitest'}">

                        ...
                        <div class="col s12 m12">
                            <div class="card shadow-sm radius-10">
                                <div class="card-content color-blue"
                                    ...
                                    <p class="font-size-md" style="margin-bottom: 0 !important;">
                                        ...
                                        <form id="RequestForm" method="post"
                                            ...
                                            <div class="input-field hide col s12 m6 l3"
                                                ...
                                                <select class="" id="payment_type" name="payment_type"
                                                    ...
                                                    <option value="" selected style="color: #ddd !important;">Choose Payment Type
                                                    </option>
                                            ...
                                            <div class="input-field  col s12 m6 l3"
                                                ...
                                                <div class="hide search_type_div"
                                                    ...
                                                    <select class="search_type_empty " id="search_type_empty"
                                                        ...
                                                        <option value="" selected style="color: #ddd !important;">Choose Search Type
                                                        </option>
                                                ...
                                                <div class="hide search_type_div"
                                                    ...
                                                    <select class="search_type_ewallet_boost_grab "
                                                        ...
                                                        <option value="RRN">RRN</option>
                                                                     ...
                                                                     for="search_type_ewallet_boost_grab">Choose
                                                    Type</label>
                                                </div>
...
<%--                                                qr transactions --%>
                                                ...
                                                <div class="hide search_type_div"
                                                     id="search_type_col_qrtxns">
                                                    <select class="search_type_ewallet_qrtxns "
                                                            id="search_type_ewallet_qrtxns"
                                                            name="search_type_ewallet_qrtxns">
                                                        <option value="" selected style="color: #ddd !important;">Choose Search Type
                                                        </option>
                                                        <option value="Reference_No">Reference No</option>
                                                        <option value="Approval_Code">Approval Code</option>
                                                                     ...
                                                                     for="search_type_ewallet_qrtxns">Choose  Type</label>
                                                </div>
                                                ...
                                                <span class="tooltip-text" id="tooltip_text"
                                                      style="word-break: keep-all; font-size: 12px">separate
														each IDs with a comma (,)</span> <label for="transaction_ids"
                                                                                                id="transaction_ids_label">Enter
                                                ID's <span
                                            ...
                                            <c:if test="${txnType == 'Ewallet'}">
                                                <c:forEach items="${paginationBean.itemList}" var="dto">
                                                    <tr>
                                                        ...
                                                        <td class="ewallet_payment_type_td">${ewalletPaymentMethod}</td>
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${dto.status eq 'VOID'}">
                                                                        <img
                                                                                ...
                                                                                width="20" height="20" alt="">
                                                                        <span class="fw-500 ml-1"
                                                                              style="color: #3c7599; text-transform: capitalize !important; font-weight: 500;">Voided</span>
                                                                    </c:when>
                                                        ...
                                                        <c:if test="${dto.status eq 'FAILED'}">
                                                            <button class="declined" id="decline_reason_icon"
                                                                    ...
                                                                    style="border: none;background-color: transparent;cursor: pointer;">
                                                                <img src="${pageContext.request.contextPath}/resourcesNew1/assets/mastersearch/blureye.svg"
                                                                     width="20" height="20"
                                                                     alt="" style="margin-top: 4.5px;">
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${dto.status eq 'VOIDED'}">
                                                                        <img
                                                                                ...
                                                                                width="20" height="20" alt="">
                                                                        <span class="fw-500 ml-1"
                                                                              style="color: #3c7599; font-weight: 500;">Voided</span>
                                                                    </c:when>
                                                                    <c:when test="${dto.status eq 'REFUNDED'}">
                                                                        <img
                                                                                src="${pageContext.request.contextPath}/resourcesNew1/assets/mastersearch/Refunded.svg"
    ...
    <%--        new view card slip xpay--%>

    <div id="cardModalContainer_receipt"
         class="slip_layer modal-container_slip" style="z-index: 99">
        <section class="payout-slip-main-container poppins-regular" id="closeClickOnOutsideCard">
                ...
                <div class="outer_header payout_Scroll_div"
                    ...
                    <div class="title-logo" style="position: relative">
                        ...
                        <img id="cancel-download"
                             ...
                             width="35" height="35" onclick="closeXpayModalCard()"/>
                        <%--<img
                            id="active-download"
...
<%--                        <p class="status status-success">Successful</p>--%>
                        <p class="status" id="cardIsSuccess"></p>
                        <div class="status-container">
                            <p class="sub-head">Transaction Summary</p>
                            <p class="amount poppins-regular">
                                     <span class="poppins-semibold amount-value"
                                           id="card_slip_amt"></span>
                            </p>
                            <p class="time-stamp poppins-semibold">
                                 <span class="poppins-semibold amount-value"
                                       id="card_slip_timestamp"></span>
                            </p>
                    ...
                    <div class="transaction-details">
                        <table>
                            <tr class="no_border_bottom">
                                ...
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    style="text-transform: uppercase;" id="card_slip_PaidTo"></td>
                            </tr>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Order ID</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    style="" id="card_slip_OrderId"></td>
                            </tr>
                            <tr class="no_border_bottom">
                            ...
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Approval Code</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="card_slip_approvalCode"></td>
                            </tr>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">RRN</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="card_slip_rrn"></td>
                            </tr>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Card Holder Name</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="card_slip_cardHolderName"></td>
                            </tr>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">card Number</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="card_slip_cardNumber"></td>
                            </tr>

                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Payment Method</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="card_slip_PaymentMethod"></td>
                            </tr>
                        ...
                        <div class="bill-box-container">
                            ...
                            <div class="poppins-semibold"
                                 ...
                                 id="card_slip_TransferAmount"></div>
                        </div>
                    </div>
                    <hr class="horizontal-default">
    ...
    <%--        new view fpx slip xpay--%>

    <div id="fpxModalContainer_receipt"
         class="slip_layer modal-container_slip" style="z-index: 99">
        <section class="payout-slip-main-container poppins-regular" id="closeClickOnOutsideFPX">
            <div class="slip-card" id="slip-card-id">
                <div class="outer_header payout_Scroll_div"
                     style="padding: 0px 10px;">
                    <div class="title-logo" style="position: relative">
                        ...
                        <img id="cancel-download"
                             style="position: absolute; top: 3px; right: 10px; height: 20px ! important; width: 20px !important; cursor: pointer;"
                             src="${pageContext.request.contextPath}/resourcesNew1/assets/xmark.svg"
                             width="35" height="35" onclick="closeXpayModalFpx()"/>
                        <%--<img
                            id="active-download"
                            style="position: absolute; top: 3px; right: 40px; height: 20px !important; width: 20px !important; cursor: pointer;"
                            src="${pageContext.request.contextPath}/resourcesNew1/assets/download.svg"
                    ...
                    <div class="main-status poppins-semibold">
<%--                        <p class="status status-success" id="fpxIsSuccess"></p>--%>
                        <p class="status" id="fpxIsSuccess"></p>
                        <div class="status-container">
                            <p class="sub-head">Transaction Summary</p>
                            <p class="amount poppins-regular">
                                     <span class="poppins-semibold amount-value"
                                           id="fpx_slip_amt"></span>
                            </p>
                            <p class="time-stamp poppins-semibold">
                                 <span class="poppins-semibold amount-value"
                                       id="fpx_slip_timestamp"></span>
                            </p>
                            <hr class="horizontal-default">
                        </div>
                    </div>
                    ...
                    <div class="transaction-details">
                        <table>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Paid to</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    style="text-transform: uppercase;" id="fpx_slip_PaidTo"></td>
                            </tr>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Order ID</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    style="text-transform: uppercase;" id="fpx_slip_OrderId"></td>
                            </tr>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Transaction ID</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="fpx_slip_TransactionId"></td>
                            </tr>
                        ...
                        <div class="bill-box-container">
                            ...
                            <div class="poppins-semibold"
                                 style="font-size: 1rem; color: var(--value-color);"
                                 id="fpx_slip_TransferAmount"></div>
                        </div>
                    </div>
                    <hr class="horizontal-default">
                    <div class="notes-section">
    ...
    <%--        new view ewallet slip xpay--%>

    <div id="ewalletModalContainer_receipt"
         class="slip_layer modal-container_slip" style="z-index: 99">
        <section class="payout-slip-main-container poppins-regular" id="closeClickOnOutsideEwallet">
            <div class="slip-card" id="slip-card-id">
                <div class="outer_header payout_Scroll_div"
                     style="padding: 0px 10px;">
                    <div class="title-logo" style="position: relative">
                        ...
                        <img id="cancel-download"
                             style="position: absolute; top: 3px; right: 10px; height: 20px ! important; width: 20px !important; cursor: pointer;"
                             src="${pageContext.request.contextPath}/resourcesNew1/assets/xmark.svg"
                             width="35" height="35" onclick="closeXpayModalEwallet()"/>
                        <%--<img
                            id="active-download"
                            style="position: absolute; top: 3px; right: 40px; height: 20px !important; width: 20px !important; cursor: pointer;"
                            src="${pageContext.request.contextPath}/resourcesNew1/assets/download.svg"
                    ...
                    <div class="main-status poppins-semibold">
                        <p class="status" id="ewalletIsSuccess"></p>
                        <div class="status-container">
                            <p class="sub-head">Transaction Summary</p>
                            <p class="amount poppins-regular">
                                     <span class="poppins-semibold amount-value"
                                           id="ewallet_slip_amt"></span>
                            </p>
                            <p class="time-stamp poppins-semibold">
                                 <span class="poppins-semibold amount-value"
                                       id="ewallet_slip_timestamp"></span>
                            </p>
                            <hr class="horizontal-default">
                        </div>
                    </div>
                    ...
                    <div class="transaction-details">
                        <table>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Paid to</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    style="text-transform: uppercase;" id="ewallet_slip_PaidTo"></td>
                            </tr>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Order ID</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    style="text-transform: uppercase;" id="ewallet_slip_OrderId"></td>
                            </tr>
                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Transaction ID</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="ewallet_slip_TransactionId"></td>
                            </tr>

                            <tr class="no_border_bottom " id="mid_in_ewalletslip">
                                <th class="poppins-regular xpay_slip_whiteSpace">MID</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="ewallet_slip_Mid"></td>
                            </tr>

                            <tr class="no_border_bottom">
                                <th class="poppins-regular xpay_slip_whiteSpace">Payment Method</th>
                                <td class="rightSide_color_code_slip poppins-medium xpay_slip_wordBreak"
                                    id="ewallet_slip_PaymentMethod"></td>
                            </tr>
                        </table>
                        <div class="bill-box-container">
                            <div class="poppins-medium">Transfer Amount</div>
                            <div class="poppins-semibold"
                                 style="font-size: 1rem; color: var(--value-color);"
                                 id="ewallet_slip_TransferAmount"></div>
                        </div>
                    </div>
                    <hr class="horizontal-default">
                    <div class="notes-section">
    ...
    <div class="more_info modal-container" id="modalContainerCard">
        <div id="moredetails" class="moredetails-modal-class">
            ...
            <div class=" align-center modal-footer footer  moredetails_footer">
                <button id="closecard"
                        class=" btn waves-effect waves-light blue-btn closebtn"
                        type="button" onclick="closeCard()" name="action">Close
                </button>
            </div>
        </div>
        ...
        <div id="moredetails" class="moredetails-modal-class">
            <div class="outerborder" style="padding: 10px;">
                ...
                <div class="modal-content content-moredetails">
                    ...
                    <div class="txn-table" style="height: auto !important;">
                        <table class="txn-popuptable">
                            <thead>
                            <tr>
                                <!-- <th class="color-blue fw-600 " colspan="3">Transaction Details</th> -->
    ...
    <div class="more_info modal-container" id="modalContainerFPX">
        <div id="moredetails" class="moredetails-modal-class">
            ...
            <div class=" align-center modal-footer footer  moredetails_footer">
                <button id="closefpx"
                        class=" btn waves-effect waves-light blue-btn closebtn"
                        type="button" onclick="closeFPX()" name="action">Close
                </button>
            </div>
        </div>
...
<script>
    ...
    function loadSelectData2() {
        ...
        var chooseType_qrtxns = document.getElementById("search_type_ewallet_qrtxns").value;
        ...
        }else if(chooseType_qrtxns !== ""){
            final_chooseType_value = chooseType_qrtxns;
        }
    ...
    function openCardMoredetailsModal(transactionDate, transactionTime, transactionId,
                                      ...
                                      merchantName, address, contactNumber, auth3Ds, timestamp, refereceNo, country, settlementDateCard,actualPaymentMethod) {
    ...
    function openEwalletMoredetailsModal(Date,
                                         ...
                                         settlementAmount, settlementDate, rrn, approvalCode, subMerchantMID, referanceNo, timeStamp, merchantName, address, contactNumber, country, paidTimeStamp) {
        
        // console.log("ewallet payment method : ",transactionAmount+":::"+paymentMethod);
        ...
        // console.log(rrn+"::"+mid+":::"+tid);

        if (status === 'FAILED' || status === 'PENDING') {
            document.getElementById("receipt_ewallet").classList.add("hidecontent");
        }

// Independent checks for rrn, mid, and tid
        if (rrn === "") {
            document.getElementById("rrn_tr").classList.add("hidecontent");
        }

        if (mid === "") {
            document.getElementById("mid_tr").classList.add("hidecontent");
        }

        if (tid === "") {
            document.getElementById("tid_tr").classList.add("hidecontent");
        }

        if (approvalCode === "") {
            document.getElementById("approvalcode_tr").classList.add("hidecontent");
        }

// If none of the conditions above are met, show the FPX receipt
        if (status !== 'FAILED' && status !== 'PENDING' && rrn !== "" && mid !== "" && tid !== "") {
        ...
        }else if(paymentMethod.toLowerCase() === "duitnow"){
        ...
        const data = {
            ...
            timeStamp: paidTimeStamp || timeStamp,
            merchantName: merchantName,
            address: address,
            contactNumber: contactNumber,
            country: country
    ...
    function removeFPXPrefix(inputString) {
        const prefix = "FPX - ";
    ...
    function openFpxSlip(data) {
        var modal = document.getElementById("fpxModalContainer_receipt");
        var modal1 = document.getElementById("closeClickOnOutsideFPX");
        document.getElementById("fpx_slip_PaidTo").innerText = data.merchanName;
        document.getElementById("fpx_slip_OrderId").innerText = data.sellerOrderNo;
        document.getElementById("fpx_slip_TransactionId").innerText = data.fpxTxnId;
        document.getElementById("fpx_slip_Mid").innerText = data.mid;
        document.getElementById("fpx_slip_PaymentMethod").innerText = "FPX Bank Transfer";
        document.getElementById("fpx_slip_amt").innerText = "MYR " + data.txnAmount;
        document.getElementById("fpx_slip_BankName").innerText = removeFPXPrefix(data.bankName);
        document.getElementById("fpx_slip_TransferAmount").innerText = "MYR " + data.txnAmount;
        document.getElementById("fpx_slip_timestamp").innerText = formatTimeStampNewSlipFPx(data.timestamp);
        var uppercaseStatus=data.status.toUpperCase();
        if(uppercaseStatus==="SETTLED"){
            document.getElementById("fpxIsSuccess").innerText="Successful";
            document.getElementById("fpxIsSuccess").style.color = "var(--success-title)";
        }else if(uppercaseStatus==="REFUNDED") {
            document.getElementById("fpxIsSuccess").innerText = "Voided";
            document.getElementById("fpxIsSuccess").style.color="#D9AA00";
        }else if(uppercaseStatus==="VOIDED") {
            document.getElementById("fpxIsSuccess").innerText = "Voided";
            document.getElementById("fpxIsSuccess").style.color="#D9AA00";
        }else{
            document.getElementById("fpxIsSuccess").innerText= "Successful";
 ...
 */
    ...
    function openCardSlip(data) {
        var modal = document.getElementById("cardModalContainer_receipt");
        var modal1 = document.getElementById("closeClickOnOutsideCard");
        document.getElementById("card_slip_PaidTo").innerText = data.merchantName;
        document.getElementById("card_slip_OrderId").innerText = data.refereceNo;
        document.getElementById("card_slip_Mid").innerText = data.mid;
        document.getElementById("card_slip_approvalCode").innerText = data.approvalCode;
        document.getElementById("card_slip_rrn").innerText = data.rrn;
        document.getElementById("card_slip_cardHolderName").innerText = data.cardHolderName;
        document.getElementById("card_slip_cardNumber").innerText = data.cardNumber;
        document.getElementById("card_slip_PaymentMethod").innerText = data.actualPaymentMethod;
        document.getElementById("card_slip_TransferAmount").innerText = "MYR " + data.transactionAmount;
        document.getElementById("card_slip_amt").innerText = "MYR " + data.transactionAmount;
        document.getElementById("card_slip_timestamp").innerText = formatTimeStampNewSlipFPx(data.timestamp);

        var uppercaseStatus = data.status.toUpperCase();
        if (uppercaseStatus === "SETTLED") {
            document.getElementById("cardIsSuccess").innerText = "Successful";
            document.getElementById("cardIsSuccess").style.color = "var(--success-title)";
        } else if (uppercaseStatus === "VOIDED") {
            document.getElementById("cardIsSuccess").innerText = "Voided";
            document.getElementById("cardIsSuccess").style.color = "#3c7599";
        } else {
            document.getElementById("cardIsSuccess").innerText = "Successful";
            document.getElementById("cardIsSuccess").style.color = "var(--success-title)";
        }
    ...
    function openEwalletSlip(data) {
        var modal = document.getElementById("ewalletModalContainer_receipt");
        var modal1 = document.getElementById("closeClickOnOutsideEwallet");

        // Normalize the paymentMethod string
       // let paymentMethod = data.paymentMethod.trim().toLowerCase();
        
        var paymentMethod = data.paymentMethod ? data.paymentMethod.trim().toLowerCase() : "";
        
        // console.log("payment method : ",paymentMethod);

        if (paymentMethod === "touch n go") {
            paymentMethod = "touch'n_go";
        }else if(paymentMethod === "duitnow qr"){
        	 paymentMethod = "duitnowqr";
        }

        document.getElementById("ewallet_slip_PaidTo").innerText = data.merchantName;

        if (paymentMethod === "boost") {
            document.getElementById("ewallet_slip_TransactionId").innerText = data.approvalCode;
        } else if (paymentMethod === "grab") {
            document.getElementById("ewallet_slip_TransactionId").innerText = data.rrn;
        } else if (paymentMethod === "touch'n_go" || paymentMethod === "shopeepay" || paymentMethod === "duitnowqr") {
            document.getElementById("ewallet_slip_TransactionId").innerText = data.transactionID;
        } else {
            document.getElementById("ewallet_slip_TransactionId").innerText = "";
        }

        if(data.mid === ""){
            document.getElementById("mid_in_ewalletslip").style.display = "none";
        }else{
            document.getElementById("ewallet_slip_Mid").innerText = data.mid;
        }


        if (paymentMethod === "boost") {
            document.getElementById("ewallet_slip_OrderId").innerText = data.referanceNo;
        } else if (paymentMethod === "grab") {
            document.getElementById("ewallet_slip_OrderId").innerText = data.referanceNo;
        } else if (paymentMethod === "shopeepay") {
            document.getElementById("ewallet_slip_OrderId").innerText = data.referanceNo;
        }else if (paymentMethod === "touch'n_go") {
            document.getElementById("ewallet_slip_OrderId").innerText = data.referanceNo;
        } else if (paymentMethod === "duitnowqr") {
            document.getElementById("ewallet_slip_OrderId").innerText = data.referanceNo;
        } else {
            document.getElementById("ewallet_slip_OrderId").innerText = "";
        }



        if(data.paymentMethod ==="Touch N go"){
            data.paymentMethod="Touch'n Go";
        }else if(data.paymentMethod==="Shopeepay"){
            data.paymentMethod="Shopee Pay"
        }else{
            data.paymentMethod=data.paymentMethod;
        }
        document.getElementById("ewallet_slip_PaymentMethod").innerText = data.paymentMethod;

        document.getElementById("ewallet_slip_amt").innerText = "MYR "+data.transactionAmount;
        document.getElementById("ewallet_slip_timestamp").innerText = formatTimeStampNewSlipFPx(data.timeStamp);
        document.getElementById("ewallet_slip_TransferAmount").innerText = "MYR "+data.transactionAmount;


        var uppercaseStatus = data.status.toUpperCase();
        if (uppercaseStatus === "SETTLED") {
            document.getElementById("ewalletIsSuccess").innerText = "Successful";
            document.getElementById("ewalletIsSuccess").style.color = "var(--success-title)";
        } else if (uppercaseStatus === "VOID") {
            document.getElementById("ewalletIsSuccess").innerText = "Voided";
            document.getElementById("ewalletIsSuccess").style.color = "#3c7599";
        } else if (uppercaseStatus === "REFUNDED") {
            document.getElementById("ewalletIsSuccess").innerText = "Voided";
            document.getElementById("ewalletIsSuccess").style.color = "#3c7599";
        } else {
    ...
    function formatDate(dateString) {
        ...
        var formattedDateString = datePart[2] + "-" + datePart[1] + "-" + datePart[0] + " " + timePart;
    ...
    function validateForm() {
        ...
        if (paymentMethod === "Card") {
            if (chooseType_empty === "" && chooseType_card === "" && chooseType_fpx === "" && chooseType_boostgrab === "" && chooseType_tngspp === "" && chooseType_qrtxns === "" && chooseType_payout === '') {
                alert("Please choose any option in choose type");
                return false;
            } else if (transactionIds === "") {
        ...
        // }
            ...
            if (payment_type === "") {
                alert("Please Choose Payment Type...");
                return false;
            } else if (chooseType_empty === "" && chooseType_card === "" && chooseType_fpx === "" && chooseType_boostgrab === "" && chooseType_tngspp === "" && chooseType_qrtxns === "" && chooseType_payout === '') {
                alert("Please choose any option in choose type");
                return false;
            } else if (transactionIds === "") {
                if (chooseType_tngspp.toUpperCase() === 'REFERENCE_NO' || chooseType_boostgrab.toUpperCase() === 'REFERENCE_NO' || chooseType_qrtxns.toUpperCase() === "REFERENCE_NO") {
                    alert("Please enter the Reference no to search");
                    return false;
                } else if (chooseType_tngspp.toUpperCase() === 'APPROVAL_CODE' || chooseType_boostgrab.toUpperCase() === 'APPROVAL_CODE' || chooseType_qrtxns.toUpperCase() === 'APPROVAL_CODE') {
    ...
    document.addEventListener("DOMContentLoaded", function () {
            ...
            var chooseType_qrtxns = document.getElementById("search_type_col_qrtxns");
            ...
            document.getElementById("payment_method").addEventListener("change", function () {
                ...
                if (paymentMethodSelect.value === "Ewallet") {
                    handleEwalletOptionChange(chooseType_empty, chooseType_card, chooseType_fpx, chooseType_boostgrab, chooseType_tngspp, chooseType_qrtxns,chooseType_payout);
                }
            ...
            function handlePaymentMethodChange(paymentMethodSelect) {
                ...
                if (val == "Card") {
                    ...
                    chooseType_qrtxns.classList.add('hide');
                    ...
                    handleEwalletOptionChange(chooseType_empty, chooseType_card, chooseType_fpx, chooseType_boostgrab, chooseType_tngspp,chooseType_qrtxns);
                    ...
                    if (backEndEwalletPaymentType) {
                        ...
                        } else if (backEndEwalletPaymentType.toUpperCase() === "DUITNOW") {
                            $("#payment_type").prop("selectedIndex", 5);
                        } else {
                    ...
                    if (backEndChooseType) {
                        ...
                        }else if ((payment_type_value.value).toUpperCase() === "DUITNOW" ) {


                            $("#search_type_col #search_type_col_qrtxns .select-dropdown").val(backEndChooseType);
                            M.updateTextFields();


                            if (backEndChooseType.toUpperCase() === 'REFERENCE_NO') {
                                $("#search_type_ewallet_qrtxns").prop("selectedIndex", 1);
                            } else if (backEndChooseType.toUpperCase() === 'APPROVAL_CODE') {
                                $("#search_type_ewallet_qrtxns").prop("selectedIndex", 2);
                            }
            ...
            function handleEwalletOptionChange(chooseType_empty, chooseType_card, chooseType_fpx, chooseType_boostgrab, chooseType_tngspp,chooseType_qrtxns) {
                ...
                if (walletOpt === "TOUCH'N_GO" || walletOpt === 'SHOPEEPAY') {
                    ...
                    chooseType_tngspp.classList.add('hide');
                    chooseType_qrtxns.classList.add('hide');
                } else if (walletOpt === "DUITNOW") {
                    chooseType_empty.classList.add('hide');
                    chooseType_card.classList.add('hide');
                    chooseType_fpx.classList.add('hide');
                    chooseType_boostgrab.classList.add('hide');
                    chooseType_tngspp.classList.add('hide');
                    chooseType_qrtxns.classList.remove('hide');
                }
                else if (walletOpt === "") {
                    chooseType_empty.classList.remove('hide');
                    chooseType_card.classList.add('hide');
...
<script>
    ...
    if ("${ewalletPaymentMethod}" !== "") {
    	...
    	if ("${ewalletPaymentMethod}".toLowerCase() === "DuitNow".toLowerCase()) {
    	    document.querySelectorAll('.ewallet_payment_type_td').forEach(element => {
    	        element.innerText = "DuitNow QR";
    	    });
    	}
...
<script>
    function formatTimeStampNewSlipFPx(dateString) {
        try {
    ...
    function closeXpayModalFpx() {
        document.getElementById("fpxModalContainer_receipt").style.display = "none";
    }

    function closeXpayModalCard() {
        document.getElementById("cardModalContainer_receipt").style.display = "none";
    }

    function closeXpayModalEwallet() {
        document.getElementById("ewalletModalContainer_receipt").style.display = "none";
    }
</script>

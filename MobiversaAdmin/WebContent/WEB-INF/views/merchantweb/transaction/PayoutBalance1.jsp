...
.navbar-nav .nav-link:hover {
	text-decoration: none;
		...
		<div class="row justify-content-center">
			...
			<c:choose>
				<c:when test="${merchantid=='4312' || merchantid=='2867'}">
											...
											<table class="table table-borderless">
												<tbody>
													<c:forEach items="${paginationBean.itemList}" var="dto"
														...
														<c:if test="${adminusername.toLowerCase()=='pcitest'}">
															<c:choose>
			...
			<div class="card card-mobi  p-3 "
				...
				<div class="row-c">
					...
					<c:choose>
						...
						<c:when test="${adminusername.toLowerCase()=='pcitestNotUse'}">
...
.drop-down-card {
    ...
    <c:when test="${merchantid !='4312' && merchantid !='2867'}">
        <div class="row-c">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="card card-mobi p-3 " style="border-radius: 0.9rem; min-height: 300px;">
                    <div class="col-12">
                        <h1 style="font-size: 22px; font-weight: bold; margin-bottom: 1.5rem !important">Adjustments</h1>
                    </div>
                    <div class="row-c">
                        <div class="col-md-12 col-lg-12 adjustment">
                            <div>
                                <label style="margin-bottom: 0px !important;">Adjustment Type</label>
                                <select name="languages" id="adjustment" placeholder="hello" onchange="openDialog(this.value)">
                                    <option value="">Choose Type</option>
                                    <option value="settlementadjust">Settlement Adjustment</option>
                                    <option value="depositadjust">Deposit Adjustment</option>
                                    <option value="overdraftadjust">Overdraft Adjustment</option>
    ...
    <c:otherwise>
        <!-- Code to execute if merchantid is not '4' or '2867' -->
    </c:otherwise>
</c:choose>

...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchRecplus?date='
...
return false;
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/exportRecplus?date='
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>EZYRECPLUS Transaction Summary</strong></h3>
          </div>
...
<div class="form-group col-md-4" id="divviewer" style="display: none;">
           ...
           <iframe id="popOutiFrame" frameborder="0" scrolling="no" width="800" height="600"></iframe>
			...
			<td  align="center">
												...
												<a
															href="${pageContext.request.contextPath}<%=TransactionController.URL_BASE%>/cancelPaymentRecplus/${dto.trxId}"
															><i class="material-icons">create</i></a>
												</c:if>
												</td>		

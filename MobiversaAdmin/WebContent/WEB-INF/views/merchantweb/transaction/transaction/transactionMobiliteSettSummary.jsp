...
<script lang="JavaScript">
	...
	var toDate = new Date(e1);
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchMobiliteSettlement?date='
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Mobilite Settlement Summary </strong></h3>
          </div>
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">
			 <div class="d-flex align-items-center">
					...
					<fmt:parseDate value="${setDate}" pattern="yyyy-MM-dd" var="myDate"/>
						<h3 class="card-title">Settlement Date : <font color="blue"><fmt:formatDate pattern="dd-MMM-yyyy" value="${myDate}" /></font> </h3>
</div>
						<div class="row">
							<div class="input-field col s12 m6 l6 ">
						
								<div class="d-flex align-items-center">HOST MDR Amount:
           									<h3 style="color:red;margin-top:10px">${subHostMdrAmt}</h3>
          							</div>
									
								 </div>
							<div class="input-field col s12 m6 l6 ">
											
											<div class="d-flex align-items-center">MOBI MDR Amount:
           									<h3 style="color:red;margin-top:10px">${subMobiMdrAmt}</h3>
          							</div>
											
										</div>
							<div class="input-field col s12 m6 l6 ">
											
											 <div class="d-flex align-items-center">Deduction Amount:
           									<h3 style="color:red;margin-top:10px">${extraDeductAmt}</h3>
          							</div>
											
										</div>
							<div class="input-field col s12 m6 l6 ">
									
											<div class="d-flex align-items-center">Total Transaction Amount:
           									<h3 style="color:red;margin-top:10px">${txnAmount}</h3>
          							</div>
										</div>
							<div class="input-field col s12 m6 l6 ">
										
											
											<div class="d-flex align-items-center">Total Net Amount:
           									<h3 style="color:red;margin-top:10px">${subNetAmount}</h3>
          							</div>
           	...
           	<table id="data_list_table" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<c:forEach items="${paginationBean.itemList}" var="dto">
									<tr>
									<fmt:parseDate value="${dto.subSettleDate}" pattern="yyyy-MM-dd" var="myDate"/>
										<td><fmt:formatDate pattern="dd-MMM-yyyy" value="${myDate}" /></td> 
										<td>${dto.subMerchantName}</td>
										<td>${dto.subHostMdrAmt}</td>
										<td>${dto.subMobiMdrAmt}</td>
										<td>${dto.extraDeductAmt}</td>
										<td>${dto.txnAmount}</td>
										<td>${dto.subNetAmount}</td>
										<c:choose>

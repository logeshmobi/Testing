...
<script lang="JavaScript">
	...
	var toDate = new Date(e1);
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchSettlement?date='
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Settlement Summary </strong></h3>
          </div>
						...
						<div class="row">
							<div class="input-field col s12 m6 l6 ">
								...
								<div class="d-flex align-items-center">HOST MDR Amount:
           									<h3 style="color:red;margin-top:10px">${hostMdrAmt}</h3>
          							</div>
							...
							<div class="input-field col s12 m6 l6 ">
											...
											<div class="d-flex align-items-center">MOBI MDR Amount:
           									<h3 style="color:red;margin-top:10px">${mobiMdrAmt}</h3>
          							</div>
							...
							<div class="input-field col s12 m6 l6 ">
											...
											<div class="d-flex align-items-center">Total Net Amount:
           									<h3 style="color:red;margin-top:10px">${netAmount}</h3>
          							</div>
           	...
           	<table id="data_list_table" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<c:forEach items="${paginationBean.itemList}" var="dto">
									<tr>
									<fmt:parseDate value="${dto.settlementDate}" pattern="yyyy-MM-dd" var="myDate"/>
										...
										<td>${dto.netAmount}</td>
										<c:choose>
                                            <c:when test="${not empty dto.settleType && dto.settleType != 'Normal'}">
                                            <td>T+${dto.settleType}</td>
                                              </c:when>
                                            <c:otherwise>
                                            <td>Normal</td>
                                              </c:otherwise>

...
$(document).ready(function() {
	...
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/plMerchantSearch?date='
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/plMerchantExport?date='
				...
				<div class="row">
					...
					<div class="input-field col s12 m3 l3" style="float:right !important;" >
					  <div class="button-class">
						...
						<input type="hidden" name="date1" id="dateval1"> <input
									type="hidden" name="date2" id="dateval2">
						<a  type="button" class="export-btn waves-effect waves-light btn btn-round indigo" onclick="loaddata()">Export</a> 
					 </div> 
					 </div> 
				</div>
				<style>
            ...
            <table id="data_list_table" class="table table-striped table-bordered">
              ...
              <c:forEach items="${paginationBean.itemList}" var="merc">
                <tr>
                 ...
                 <td>${merc.city}</td>
                 <td style="text-align:right;">${merc.referralId}</td>
                  <td style="text-align:right;">${merc.mdr}</td>

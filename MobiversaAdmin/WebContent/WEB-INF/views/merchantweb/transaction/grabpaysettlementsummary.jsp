...
$('#export').select2();
	 ...
	 function loadSelectData() {
			...
			if (e == null ||e == '' || e1 == null || e1 == '') {
				...
				document.location.href = '${pageContext.request.contextPath}/transactionweb/grabpaysettlesearch?date='
		...
		if((e == null || e == '') && (e1 == null || e1 == '') && (e3 == null || e3 == '')){
			...
			/* document.location.href = '/transaction1/search1?date=' + e
					+ '&date1=' + e1 +'&currPage='+pnum; */
					 document.getElementById("dateval1").value = e;
					document.getElementById("dateval2").value = e1;
			 document.location.href = '${pageContext.request.contextPath}/transactionweb/grabpaysettlesearch?date=' + e
	...
	function loaddata() {
		...
		if(e == '' && e1 == '' && e3 == ''){
			...
			document.location.href = '${pageContext.request.contextPath}/transactionweb/grabpaysettleexport?date=' + fromdateString
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong> GRABPAY Settlement Summary</strong></h3>
          </div>
        ...
        <div class="card-content padding-card">
				...
				<div class="row">
					<div class="input-field col s12 m3 l3">
						<label for="from" style="margin:0px;">Settlement From Date </label>
						<input type="hidden"
					...
					<div class="input-field col s12 m3 l3">
						...
						<label for="to" style="margin:0px;">Settlement To Date</label>
						<input type="hidden"
					...
					<tbody>
						<c:forEach items="${paginationBean.itemList}" var="dto">
							...
							<tr> 
								...
								<td style="text-align:right"  width="75px">${dto.hostNetAmt}	</td>
								<td style="text-align:right"  width="75px">${dto.mdr}</td>

...
<script type="text/javascript">
    ...
    function loadSearch()
    {
        ...
        document.location.href = '${pageContext.request.contextPath}/searchNew/searchOnHoldPayout?id='
            + Value+'&idType=' + type;
        form.submit;
            ...
            <div class="card blue-bg text-white">
                <div class="card-content" >
                    <div class="d-flex align-items-center">
                        <h3 class="text-white" style="margin:4px 8px; font-family: Poppins, sans-serif !important; "><strong>Payout Account Enquiry </strong></h3>
                    </div>
...
<%--                                            <button onclick="openApprove('${enquiry.invoiceId}')" class="btn waves-effect waves-light blue-btn-for-Approve-green closebtn btnbtn">--%>
...
<%--                                            </button>--%>
        ...
        <div id="moredetails" class="moredetails-modal-class">
            <div class="outerborder" style="padding: 0;">
                ...
                <div class="modal-content content-moredetails">
                    <div class="color-blue" style="font-size: 16px; font-weight: 500; margin: 10px 0;padding: 0px 8px">Transaction Details
                    </div>
                    <div class="txn-table">
                        <div class="transaction-details">
                            ...
                            <table class="info_table">
                                ...
                                <tr>
                                    ...
                                    <td class="separator">-</td>
                                    <td class="value more_info_details" id="info-nameInBank">Dhianesh Saravanan</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="separator">-</td>
                                    <td class="value more_info_details" id="info-pendingReason">Account name mismatch</td>
                                </tr>
                                <tr>
                        ...
                        <div style="margin: 15px 0; padding: 3px 10px;">
                            <p class="comment-box" style="color: #6d6868; font-weight: 500; margin-bottom: 5px;">Comment Box <span class="required-text">(Required for Rejection)</span></p>

                            <textarea placeholder="Enter Your comments here... " id="commentsTextarea" required
                                      style="width: 60%; min-height: 6rem; background-color: transparent; font-family: 'Poppins';
                                       color: #858585; resize: none; border-color: #ADADAD; padding: 10px ;
                                      border-radius: 6px; margin-top: 4px; height: auto; content:'';">
                            </textarea>
            ...
            <div class=" align-center modal-footer footer  moredetails_footer" style="gap: 18px">
                <button id="reject"
                        style="color: red !important;background-color: transparent !important;border-style: solid;border-width: 1px !important;font-family: 'Poppins' !important;"
                        class="btn waves-effect waves-light blue-btn closebtn"
                        type="button" onclick="more_info_reject(document.getElementById('info-invoiceId').value)" name="action">Reject
                </button>
                <button id="approve"
                        class="btn waves-effect waves-light blue-btn closebtn" style="font-family: 'Poppins' !important;"
                        type="button" onclick="this.disabled = true; more_info_approve(document.getElementById('info-invoiceId').value)" name="action">Approve
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        //     };
        //
        //     // Make the AJAX request to the payout service endpoint
        //     const xhr = new XMLHttpRequest();
        //     xhr.open("POST", "/payoutservice", true);
        ...
        //                 document.getElementById("dynamic_message").innerText = "The Transaction has been approved successfully";
        //             } else {
        //                 // Handle error response
        //                 document.getElementById("dynamic_message").innerText = "Failed to approve the transaction";
        //             }
        //         }
        //     };
        //
        ...
        function more_info_approve(invoiceId) {
          ...
          //  document.getElementById("approve-modal-id").style.display = "block";
            ...
            document.location.href = '${pageContext.request.contextPath}/searchNew/approvePayout?invoiceID=' + encodedInvoiceID;
        ...
        function more_info_reject(invoiceID) {
         ...
         //   document.getElementById("reject-modal-id").style.display = "block";
            ...
            var encodedInvoiceID = btoa(invoiceID);
            document.location.href = '${pageContext.request.contextPath}/searchNew/rejectPayout?invoiceID='+encodedInvoiceID+'&reason='+comment;
    ...
    <div id="approve-modal-id" class="approve-modal-class">
        <div class="approve-modal-content">
            <div>
                <div style="border-bottom: 2.5px solid orange; padding: 10px 24px; text-align: center; font-size: 16px; color: #005baa; font-weight: 600">
                    Notification
                ...
                <div class="reason-div" style="padding: 15px 30px 0px 30px; text-align: center;">
                    <img src="${pageContext.request.contextPath}/resourcesNew1/assets/Done 2.svg" width="40"
                         height="40"/>
                    <p id="reason-id" class="reason-class"></p>
                </div>
                <div class="center-text" style="font-size: 18px;font-weight: 400; color: #858585">
                    <p>The Transaction has been successfully<br></p>
                    <p>approved</p>
                </div>
                ...
                <div class="approve-button"
                    ...
                    <button type="button" class="close-Approve" id="closeApprove-id" style="font-family: 'Poppins'; font-weight: 400" onclick="closeApprove()">Close
                    </button>
                </div>
            </div>
        </div>
...
<%--                    <p id="reason-id" class="reason-class"></p>--%>
                ...
                <div class="center-text"  style="font-size: 18px;font-weight: 400; color: #858585">
                    <p>This Transaction has already been ${rareScenarioAction}<br></p>

                </div>

                <div class="approve-button"
                     style="padding: 10px; display: flex; justify-content: center; background-color: #EFF8FF;gap: 18px; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                    <button type="button" class="close-Approve" id="closeRare-id"  style="font-family: 'Poppins'; font-weight: 400" onclick="closeRare()">Close
                    </button>
                </div>
            </div>
        </div>
    ...
    <div id="reject-modal-id" class="approve-modal-class">
        <div class="approve-modal-content">
            <div>
                <div style="border-bottom: 1px solid orange; padding: 10px 24px; text-align: center; font-size: 16px; color: #005baa; font-weight: 500">
                    Notification
                    <%--<span style="float: right">X</span>--%>
                </div>
                ...
                <div class="approve-button"
                     style="padding: 10px; display: flex; justify-content: center; background-color: #EFF8FF;gap: 18px; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                    <button type="button" class="close-Approve" id="closeReject"  style="font-family: 'Poppins'; font-weight: 400" onclick="closeReject()">Close
                    </button>
                </div>
            </div>
        </div>
            ...
            <div>
                ...
                <div class="approve-button"
                    ...
                    <button
                            ...
                            onclick="this.disabled = true; approvePayout(document.getElementById('invoice-for-approve').value);">
                        Confirm
                    </button>
                    </button>
                </div>
    ...
    <div class="approve-modal-class" id="reject-modal-id-confirmation" >
        ...
        <div class="approve-modal-content" style="margin-top: 80px">
            <div>
                <div style="border-bottom: 2.5px solid orange; padding: 12px 24px; text-align: center; font-size: 16px; color: #005baa; font-weight: 600">
                    Confirmation
                </div>
                ...
                <div class="center-text" style="font-size: 18px; color: #858585; margin:20px 0 5px 0">
                    <p>Please provide a reason for rejecting<br></p>
                ...
                <div style="margin-bottom: 3%; text-align: center">
                    ...
                    <div>
                        <textarea placeholder="Enter the reason for rejection..."
                                  ...
                                  style="width: 85%; font-family: 'Poppins';padding: 10px; min-height: 6rem; background-color: transparent; color: #586570; resize: none; border-color: #ADADAD; border-radius: 6px; margin-top: 4px; height: auto; font-size: 14px;">
                        </textarea>
                ...
                <div class="approve-button"
                    ...
                    <button type="button" class="close-Approve" id="reject_cancel" style="font-size: 13px;font-family: 'Poppins';font-weight: 400;" onclick="rejectPayout(document.getElementById('invoice-for-rejecting-the-Payout').value)">confirm
                    </button>
                </div>
            </div>
        </div>
...
<script>
    ...
    function goToPage(pageNum) {
        ...
        document.location.href = '${pageContext.request.contextPath}/searchNew/accountEnquiry?currentPage=' + pageNum;
    }

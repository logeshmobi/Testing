   ...
   <script lang="JavaScript">
      ...
      /* 	var e2 = document.getElementById("txnType").value; */
        var e2 = "CARD";
      	...
      	if (e == null ||e == '' || e1 == null || e1 == '') {
      		...
      		var TxnType ="CARD";
      		document.location.href = '${pageContext.request.contextPath}/transactionUmweb/searchUMEzywire?date='
      ...
      function loadExpData() {
      	...
      	if (e == null || e == '' || e1 == null || e1 == '') {
      		...
      		/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
      				+ e + '&date1=' + e1 + '&txnType=' + e2; */
      				document.location.href = '${pageContext.request.contextPath}/transactionUmweb/umEzywireExport?fromDate=' + fromdateString

    ...
    /*   function openNewWin(mrn){
      ...
      function formatTopDate(dateString) {
        ...
        if (status === "SETTLED") {
            ...
            statusElement.style.color = "#3c7599"; // voided status color
        } else {
            statusElement.innerText = "Successful";
               ...
               <div class="card border-radius">
                  <div class="card-content padding-card">
                   ...
                   <!--      <div class="input-field col s12 m3 l3">
                           ...
                           <label for="name">Payment Method</label> <input type="hidden"
                           ...
                           <tbody>
                              <c:forEach items="${paginationBean.itemList}" var="dto"
                                 ...
                                 <tr>
                                    ...
                                    <c:if test="${score == 'yes'}">
                                       <td>${dto.fraudScore}</td>
                                       <td>${dto.fraudId}</td>
                                    </c:if>
                                    <td>${dto.ezysettleAmt}</td>
                                    <td style="text-align: center;">
                                       <c:if
                                          test="${dto.cardType == 'MASTERCARD DEBIT' || dto.cardType == 'MASTERCARD CREDIT' || dto.cardType == 'VISA DEBIT' || dto.cardType == 'VISA CREDIT' || dto.cardType == 'VISA' || dto.cardType == 'MASTERCARD'}">
                                          <c:if
                                       ...
                                       <c:if test="${dto.cardType == 'GRABPAY'}">
                                          <c:if
                                             test="${dto.STATUS =='SETTLED' || dto.STATUS =='NOT SETTLED' || dto.STATUS =='VOIDED'}">
                                    ...
                                    <td style="text-align: center;">
                                       <c:if test="${(dto.cardType == 'MASTERCARD DEBIT' || dto.cardType == 'MASTERCARD CREDIT' || dto.cardType == 'VISA DEBIT' || dto.cardType == 'VISA CREDIT' || dto.cardType == 'VISA' || dto.cardType == 'MASTERCARD') && (dto.serviceId == 'FIUU' || dto.serviceId == 'UM')}">

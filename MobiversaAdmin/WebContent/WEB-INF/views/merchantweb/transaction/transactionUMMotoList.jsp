...
statusElement.style.color = "#3c7599"; // Refunded status color
} else {
statusElement.innerText = "Successful";
...
<script lang="JavaScript">
	...
	/* 	var e2 = document.getElementById("txnType").value; */
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/searchUMMoto?date='
 ...
 /*  SEARCH FUNCTION HERE  */
	...
	function loadExpData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/umMotoExport?fromDate=' +fromdateString
					+ '&toDate=' + todateString + '&txnType=' + txnType + '&export='+e2;
			form.submit;
			//document.getElementById("dateval1").value = e;
			//document.getElementById("dateval2").value = e1;
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/transactionUmweb/umMotoExport?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
				...
				<div class="card blue-bg text-white">
					<div class="card-content">
						<div class="d-flex align-items-center">
							<h3 class="text-white">
								<strong>EZYMOTO Transaction Summary</strong>
							</h3>
						</div>
									...
									<c:forEach items="${paginationBean.itemList}" var="dto"
										...
										<tr>
											...
											<td align="center"><c:if
													test="${dto.cardType == 'MASTERCARD DEBIT' || dto.cardType == 'MASTERCARD CREDIT' || dto.cardType == 'VISA DEBIT' || dto.cardType == 'VISA CREDIT' || dto.cardType == 'MASTERCARD '}">
													<c:if
											...
											<td style="text-align: center;"><c:if
													test="${(dto.cardType == 'MASTERCARD DEBIT' || dto.cardType == 'MASTERCARD CREDIT' || dto.cardType == 'VISA DEBIT' || dto.cardType == 'VISA CREDIT' || dto.cardType == 'MASTERCARD ' ) && (dto.serviceId == 'FIUU' || dto.serviceId == 'UM')}">

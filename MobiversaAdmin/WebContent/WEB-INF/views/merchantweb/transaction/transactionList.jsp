...
<script lang="JavaScript">
	...
	function loadData(num) {
		...
		/* if (e == null || e == '' ) {
			...
			form.submit = false;
				...
				&& (e4 == null || e4 == '')) {
			//alert('both $$ ##');
			document.location.href = '${pageContext.request.contextPath}/transactionweb/list/'
					+ pnum;
			form.submit;
		} else {
			//alert("else : "+e+" "+e1);
			document.getElementById('devId').disabled = false;
			document.getElementById('tid').disabled = false;
			document.location.href = '${pageContext.request.contextPath}/transactionweb/search?fromDate='
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null ||e1 == '') {
			...
			document.getElementById('devId').disabled = false;
			document.getElementById('tid').disabled = false;
			//window.open("${pageContext.request.contextPath}/transactionweb/export", '_blank').focus();
			document.form1.action = "${pageContext.request.contextPath}/transactionweb/export";
			//form.submit();
			document.form1.submit();
									...
									<div class="input-field col s12 m3 l3">
											...
											<div class="input-field col s12 m3 l3">
											 <input type="hidden"
												...
												onchange="return loadDropDate12();" style="width: 100%"
												>

												<option selected value=""><c:out value="DevID" /></option>
												<c:forEach items="${terminalDetailsList}" var="t">
													<option value="${t.deviceId}">${t.deviceId}</option>
												</c:forEach>
											</select>
								...
								<div class="row">
									...
									<div class="input-field col s12 m3 l3">
											 ...
											 <input type="hidden" name="status1"
												...
												name="status" id="status" onchange="return loadDropDate11();"
												>
									...
									<div class="input-field col s12 m3 l3">
											 ...
											 <input type="hidden"
												...
												name="export" id="export" onchange="return loadDropDate13();"
												>
...
<!-- 						dhinesh    <th>Void</th> -->
									...
									<!-- d -->  <td>${dto.pan}</td>
												...
												<td>${dto.status}</td>	
   <td align="center">
   <c:if test="${dto.txnType !='BOOST' && dto.txnType != 'GRABPAY' && dto.txnType != 'FPX'}">

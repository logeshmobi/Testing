      ...
      <div class="row">
         <div class="col s12">
            <div class="d-flex align-items-center">
               <div id="right">
                  <div class="menu menu1">EZYLINK</div>
                  <div class="r-bg">
                     <div class="row">
                        <img src="${pageContext.request.contextPath}/resourcesNew/img/ezylinkcircle.png"
                           class="home_icon">
                        <div class="column2">
                     ...
                     <div class="bg">
                        ...
                        <div class="mb-2">
                           <input type="checkbox" style="opacity: 1; pointer-events: auto; position: inherit;"
                              id="multiuse" class="largerCheckbox" value="Yes" > <label
                              class="checkbox-cls"> Multi Use</label>
                        </div>
<%--                         
                        <div class="mb-1">
...
--%>
   ...
   <!--EZYLINK form  -->
   <form:form id="Linkform" action="${pageContext.request.contextPath}/transactionMoto/motoLinkSubmit" commandName="motoTxnDet" method="post">
...
//         const transactionAmount = document.getElementById("c_code").value;
		var formatterAmount = amount ? parseFloat(amount) : 0;
         ...
         Swal.fire({
             ...
             text: "The EZYLINK transaction amount is "+ formatterAmount +" RM. Do you want to submit this transaction?",
             icon: "question",
...
function TransactionRequestForCopy() {        
 	   var CustomerName = document.getElementById("Name").value;
	   var referrence = document.getElementById("reference").value;
	   var referrence = document.getElementById("referrence")
	   var amount = document.getElementById("c_code").value;
	   var multiOption = document.getElementById("multiOption")
...
//		   const transactionAmount = document.getElementById("c_code").value;
			...
			formatterAmount = formatterAmount.toLocaleString();
	         ...
	         Swal.fire({
	             title: "Confirm Transaction",
	             text: "The EZYLINK transaction amount is "+ formatterAmount +" RM. Would you like to proceed without sending an email?",
	             icon: "question",
	             iconColor: "#005BAA",// Blue icon color
	             showCancelButton: true,
	             confirmButtonText: "Yes, Submit",

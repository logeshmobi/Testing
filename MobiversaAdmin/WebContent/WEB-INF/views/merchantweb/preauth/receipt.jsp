			...
			<tr>
				<td>
					...
					<table cellpadding="0" cellspacing="0" align="center"
						...
						<tr>
							<td
								style="padding: 5px; text-align: center; font-size: 16px; display: block; font-family: Lao UI;">${dto.merchantName}</td>
						</tr>
						<tr>
							<td
								style="padding: 5px; text-align: center; font-size: 10px; font-family: Lao UI;">
								${dto.merchantAddr1}<br /> <%-- , ${dto.merchantAddr2} --%>
					...
					<table cellpadding="0" cellspacing="0" align="center"
						...
						<tr id="nsign">
							...
							<td valign="top" style="padding-top: 5px;"><small>Signature
									Not Required</small></td>
					...
					<h4
						...
						<c:if test="${dto.txnType =='SALE' || dto.txnType =='PREAUTH SALE' || dto.txnType =='PRE-AUTHORIZATION'
					|| dto.txnType =='VOID' || dto.txnType =='PREAUTH CANCEL'}">
					<table cellpadding="0" cellspacing="0" align="center"
						style="font-size: 8px;">
						<tr>
							<td
								style="padding: 2px; text-align: center; font-family: Lao UI; font-size: 8px;">
				  ...
				  <img width=\"250\" src=\"http://maps.google.com/maps/api/staticmap?center="
				   ...
				   +templetFields.getLatitude()+","+templetFields.getLongitude()+"&size=255x255&sensor=TRUE_OR_FALSE\" alt=\"Google Map of Mobiversa, KL\"> </a>" -->
								...
								href="https://www.google.com/maps/place/${dto.latitude},${dto.longitude}\">
									<%-- <img width="250"
									src="${dto.mapUrl}"
									alt="Google Map of Mobiversa, KL\"> --%>
									<img width="350" height="200"
									src="https://maps.google.com/maps/api/staticmap?center=${dto.latitude},${dto.longitude},
									&zoom=14&markers=${dto.latitude},${dto.longitude}|${dto.latitude},${dto.longitude}
									&path=color:0x0000FF80|weight:5|${dto.latitude},${dto.longitude}&size=350x200&
									sensor=TRUE_OR_FALSE&key=AIzaSyD7Yaz1aSMli9-dEkNLkzigM3fBUai64Io"
									alt="Google Map of Mobiversa, KL\">
							</a>
							</td>
						</tr>
					...
					<table cellpadding="0" cellspacing="0" align="center"
						...
						<tr>
							<td
								style="padding: 2px; text-align: center; font-family: Lao UI; font-size: 8px;">
								<small>I AGREE TO PAY ABOVE TOTAL AMOUNT ACCORDING TO
									CARD ISSUER AGREEMENT</small>
							</td>
						</tr>
						<tr>
							<td
								style="padding: 2px; text-align: center; font-family: Lao UI; font-size: 9px;">

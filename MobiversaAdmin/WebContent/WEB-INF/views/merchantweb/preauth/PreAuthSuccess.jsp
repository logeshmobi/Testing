      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong> PREAUTH Transaction Details</strong> </h3>
          </div>
...
<p><h3 style="color: #005baa !important;font-weight: bold;">${requestScope.responseData}</h3></p>
				 <div class="d-flex align-items-center">
				 <h3>PREAUTH Transaction Details</h3>
				 </div>

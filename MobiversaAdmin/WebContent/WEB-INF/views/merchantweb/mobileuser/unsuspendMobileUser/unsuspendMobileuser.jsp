...
$(document).ready(function() {
	...
	<%-- <div class="bar-switch-record col-xs-12 padding-top-10">
		<div class="pull-left">Your are Currently viewing mobile User ID/terminal ID: ${mobileUser.username }</div>
	</div> --%>
	<div style="float-left:30px;" class="col-xs-12 padding-10">
<!-- Content Header (Page header) -->
        <section class="content-header">
          <h1 style="color:#0989af;">
            Un-Suspend MobileUser
          </h1>  
       </section>
   </div>   


	<form method="post" action="/mobileUserweb/unsuspend/dounSuspend" id="form-suspend">
		<input type="hidden" name="id" value="${mobileUser.id }"> <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		<div class="col-xs-9">
			<div class="row">
					...
					<div class="panel-body">
						...
						<div class="form-body">
							<div class="form-group">
								<div class="col-md-2 control-label"><b>Effective Date:</b> </div>
								<div class="col-md-9">
							...
							<div class="form-group">
								<div class="col-md-2 control-label"><b>Reason:</b> </div>
								<div class="col-md-9">
									<select class="form-control" name="reason">
										<c:forEach items="${reasonList}" var="reason">
											<c:choose>

												<c:when test="${mobileUserStatusHistory.reason == reason }">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<textarea class="form-control" rows="3" maxlength="250" name="description"><c:out escapeXml='true'
											value="${mobileuserStatusHistory.description}" /></textarea>
	...
	<div id="dialog" class="web_dialog">
		<div class="content">Are you sure you want to un-suspend this user:${mobileUser.username }

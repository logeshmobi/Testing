...
function load() {
	//alert("fcancel data");
	 document.location.href = "${pageContext.request.contextPath}/transactionMoto/motoLinkTransaction";
	form.submit;
}
</script>
				...
				<div class="card blue-bg text-white">
					<div class="card-content">
						<div class="d-flex align-items-center">
							<h3 class="text-white">
								<strong> EZYLINK Transaction Details</strong>
							</h3>
						</div>
							...
							<div class="row-fluid">
								<table class="table table-striped">
									<tbody>
										...
										<tr>
											<td colspan="2"
												style="color: #005baa !important; font-weight: bold; font-size: 20px !important;">${rd.responseDescription}</td>
										</tr>

										<tr>

											<td colspan="2" style="font-size: 20px !important;">EZYLINK

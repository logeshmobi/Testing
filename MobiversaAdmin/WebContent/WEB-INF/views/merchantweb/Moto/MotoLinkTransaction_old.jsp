	 ...
	 $(document).ready(function() {
		...
		/* 	function validateForm1(){ */
			...
			&& checkExpireDevice()) {
			 ...
			 var r = confirm("EZYMOTO Transaction Amount is RM "+document.getElementById("amount").value
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>EZYLINK Transaction</strong></h3>
          </div>
 ...
 <form:form method="post" id="form1" name="form1" commandName="motoTxnDet"
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">
					<p id="hide"><h3 style="color: blue;font-weight: bold;">${requestScope.responseData}</h3></p>
								...
								<div class="row" >
									...
									<form:input type="hidden" id="tid" path="tid" value=""/>
										...
										<div class="input-field col s12 m6 l6">
											...
											<div class="input-field col s12 m6 l6 "> Multi Use :
						<p><label><input type="radio" name="multiOption" path="multiOption"
							 value="Yes" id="multiOption" /><span>Yes</span></label>   
						<label><input type="radio" checked="checked"
							name="multiOption" value="No"  id="multiOption"  path="multiOption"/> <span>No</span></label></p>

...
<script lang="JavaScript">
	 ...
	 $(document).ready(function() {
		...
		if(amount<5){
			...
			if (validateForm() && validatemailmobno()  && SubmitFormAmount()
					&& checkExpireDevice()) {
			 
				
			 var r = confirm("EZYLINK Transaction Amount is RM "+document.getElementById("c_code").value
...
.bb{border-bottom: solid 1px #bababa;}
...
.c092540{color:#092540;}
.c9f9f9f{color:#9f9f9f;}
...
width:40px;box-shadow: -1px 1px 0px 0px #ccc !important;}


.br707070{border: solid 1px #707070;}
.too_small{font-size: .675em;}

.keybpad-btn:focus{border:solid 1px #005baa;box-shadow:none;border-radius:4px;}
.x-btn{width:4px;height:4px;padding:0.3rem;border:solid 1px #DDD;}
.btn-mobi{background:#005baa !important;}



.mobi-container, .mobi-container-fluid, .mobi-container-lg, .mobi-container-md, .mobi-container-sm, .mobi-container-xl, .mobi-container-xxl {
width: 100%;
...
.mobi-btn-group-vertical > .mobi-btn-group:not(:first-child), .mobi-btn-group-vertical > .mobi-btn:not(:first-child) {
margin-top: -1px;
}
...
<form:form method="post" id="form1" name="form1" commandName="motoTxnDet"
		action="${pageContext.request.contextPath}/transactionMoto/motoLinkSubmit" >
...
<div class="side-panel-dialog" id="mobi-ezylink-dialog" >
    <div class="side-panel-container">
		...
		<div class="mobi-container-fluid d-grid mobi-gap-3 mobi-align-items-center mobi-mt-2 mobi-color" style="grid-template-columns: 1fr 1fr;display:grid;">
      <div class="mobi-dropdown">
       <img src="${pageContext.request.contextPath}/resourcesNew/images/ezylink.png" class="mobi-img-fluid mobi-me-3"> 

      </div>

      <div class="">
        <span class="w-100 mobi-me-3 mobi-small-20 color-005baa mobi-font-bold ">
          Ezylink Transaction 
        </span>
    ...
    <div class="d-block d-md-none">
						<div
							...
							<div class="mobi-text-center">
								<span class="w-100  mobi-me-3 mobi-small-20 color-005baa mobi-font-bold "> Ezylink
									Transaction </span>
		...
		<div class="mobi-px-5 ">
            ...
            <div class="mobi-tab-content" id="pills-tabContent">
                <div class="tab-pane mobi-fade show mobi-active" id="mdr-rates" role="tabpanel" aria-labelledby="mdr-rates-tab">
...
<div class="mobi-btn-group-vertical mobi-col-12 ml-4 mt-1" role="group" aria-label="Basic example">
    <div class="btn-group">
        <input type="text" value="RM 0.00"  disabled class="text-center form-control mobi-color mobi-mb-2" id="keypad">
		<input type="hidden" class="" value="" id="code"  value="" >
		<input type="hidden" class="" value="" id="c_code"  value="" name="amount"  path="amount">
    </div>
     <div class="mobi-btn-group">
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1  mobi-me-2 mobi-mb-1 mt-1" onclick="keypadd(1)">1</button>
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1 mobi-ms-2 mobi-me-2 mobi-mb-1 mt-1" onclick="keypadd(2)">2</button>
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1 mobi-ms-2  mobi-mb-1 mt-1" onclick="keypadd(3)">3</button>
    </div>
    <div class="mobi-btn-group">
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1  mobi-me-2 mobi-mb-1 mt-1" onclick="keypadd(4)">4</button>
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1 mobi-ms-2 mobi-me-2 mobi-mb-1 mt-1" onclick="keypadd(5)">5</button>
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1 mobi-ms-2  mobi-mb-1 mt-1" onclick="keypadd(6)">6</button>
    </div>
    <div class="mobi-btn-group">
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1  mobi-me-2 mobi-mb-1 mt-1" onclick="keypadd(7)">7</button>
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1 mobi-ms-2 mobi-me-2 mobi-mb-1 mt-1" onclick="keypadd(8)">8</button>
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1 mobi-ms-2  mobi-mb-1 mt-1" onclick="keypadd(9)">9</button>
    </div>
    <div class="mobi-btn-group">
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1  mobi-me-2 mobi-mb-1 mt-1 text-danger" onclick="keypadd('C')">C</button>
        <button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1 mobi-ms-2 mobi-me-2 mobi-mb-1 mt-1"  onclick="keypadd(0)">0</button>
		<button type="button" class="mobi-btn mobi-rounded keybpad-btn mobi-py-1 mobi-ms-2  mobi-mb-1 mt-1" onclick="keypadd('X')">&#8592;</button>
    </div>
</div>
 ...
 <div class="mobi-row">
                            <div class="mobi-col-12">
                                <div class="mobi-mb-1">
                                    <label for="Product" class="mobi-form-label  mobi-c969696">Enter Reference</label>
                                    <input type="text" class="form-control" name="referrence" path="referrence" id="reference" placeholder="">
                                </div>
                            </div>
</div>
 ...
 <div class="mobi-row">
                            <div class="mobi-col-12">
                                <div class="mobi-mb-1">
                                  <label for="Product" class="mobi-form-label  mobi-c969696">Choose User Name</label>
                                   
                                <select class = "browser-default custom_select mobi-text-dark"  onchange="this.value;"
													name="tids" id="tids">
 ...
 <div class="mobi-row">
                            <div class="mobi-col-12">
                                <div class="mobi-mb-1">
                                    <label for="Product" class="mobi-form-label  mobi-c969696">Email Address</label>
...
<!--                                     <label for="Product" class="mobi-form-label too_small c969696">Mobile Number</label> -->
                                   ...
                                   <input type="tel" class="form-control" value="" name="phno" id="mobile" placeholder="Enter your mobile number">
                                </div>
                            </div>
	 ...
	 <div class="mobi-row mobi-mt-2 ">
                            <div class="mobi-col-12">
                                <div class="mobi-mb-1">	   
		   <label for="Product" class="mobi-form-label mobi-small mobi-color ">Multi Link Use</label>
		  <input type="checkbox" style="margin-top: 2px; opacity: 1;pointer-events: auto;width: 20px;height: 20px;margin-left: 180px;" name="multiOption" value="yes" id="multiOption" path="multiOption">
               ...
               <form:input type="hidden" name="latitude" value="" id="latitude" path="latitude"/>
                    ...
                    <div class="side-panel-footer mobi-mb-2">
                        <div class="mobi-mb-3">
                            ...
                            <button class="btn  btn-mobi mobi-float-end mobi-mb-2 mobi-p-30" >Submit</button>
                            <button class="btn  mobi-mb-2 btn-cancel-mobi mobi-p-30" onclick="loadCancelData()">Cancel</button>
	...
	<script src="${pageContext.request.contextPath}/resourcesNew/js/intlTelInput.js"></script>
...
if(num=='X'){
current_val = document.getElementById('code').value=document.getElementById('code').value ;
...
if(existing_val.length<=12) current_val = document.getElementById('code').value=document.getElementById('code').value + num;
else current_val = document.getElementById('code').value=document.getElementById('code').value;
}
current_val_decimal = (current_val/100);
current_val_decimal_display =(Math.round(current_val_decimal * 100) / 100).toFixed(2);


document.getElementById('c_code').value= current_val_decimal_display;

document.getElementById('keypad').value='RM ' + current_val_decimal_display;

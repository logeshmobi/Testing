...
function add(pro) {
	...
	for (j = 1; j <= 15; j++) {
		...
		try {
			...
			var reference = document.getElementById("reference"+ j +"").value;
			...
			document.getElementById("cref"+ j +"").value = reference ;
           ...
           <h5>EZYMOTO Virtual Credit Card</h5>
				...
				<div class="row">
					...
					<div class="input-field col s12 m2 l2">
						<input type="text" id="reference1"  maxlength="10" 
											name="reference[]" value="" placeholder="Reference">
						<!-- <label for="Amount">Amount</label> -->
					</div>
  ...
  function AddMore() {   
	...
	var html='';
	          html+='<div class="row inner_row_'+x+'">';
				...
				html+='<div class="input-field col s12 m2 l1">';
				html+='<label>';
				html+='<input type="checkbox" name="ckId" id="ckId'+ x +'" >';
				html+= '<span class="selectSpan">Select</span>';
				html+='</label>';
				html+='</div>';
					html+='<div class="input-field col s12 m2 l2">';
						html+='<input type="text" class="form-control c1" id="cardName'+ x +'" style="width: 100%;" maxlength="26"'
			    		 +'name="cardName[]" value="" placeholder="Card Name">';
						/* html+='<label for="card">Card Name</label>'; */
					html+='</div>';
					html+='<div class="input-field col s12 m3 l3">';
						html+='<input type="text" class="form-control creditCardText" id="cardNo'+ x +'" maxlength="19" onclick="return isNumberKey1(event)"'
			    		 +'name="cardNo[]" value="" placeholder="Card Number">';
						/* html+='<label for="name">Card Number</label>'; */
					html+='</div>';
					
					html+='<div class="input-field col s12 m1 l1">';
					html+='<input type="text" class="form-control creditCardExdt" id="exdt'+ x +'"  maxlength="5" onkeypress="return isNumberKey2(event)" onpaste="return false;"'
		    		 +'name="exdt[]" value="" placeholder="MM-YY">';
					/* html+='<label for="name">MM-YY</label>'; */
					html+='</div>';
				
					html+='<div class="input-field col s12 m1 l1">';
						html+='<input type="password" class="form-control" id="cvv'+ x +'" maxlength="3" onkeypress="return isNumberKey(event)" onpaste="return false;"'
			    		 +'name="cvv[]" value="" placeholder="CVV">';
					...
					html+='<div class="input-field col s12 m2 l1">';
						html+='<input type="text" class="form-control" id="amount'+ x +'" maxlength="10"'
			    		 +'name="amount[]" value="" placeholder="Amount">';
					...
					html+='<div class="input-field col s12 m2 l2">';
						html+='<input type="text" class="form-control" id="reference'+ x +'" maxlength="10"'
			    		 +'name="reference[]" value="" placeholder="Reference">';
						/* html+='<label for="name">Reference</label>'; */
					html+='</div>';

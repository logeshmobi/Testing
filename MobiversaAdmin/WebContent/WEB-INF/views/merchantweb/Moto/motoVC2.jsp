      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white" ><strong>EZYMOTO Virtual Credit Card</strong> </h3>
          </div>
  ...
  <div class="col s12">
      <div class="card border-radius">
        <div class="card-content padding-card">
         ...
         <button type="button" class="export-btn waves-effect waves-light btn btn-round indigo"
							onclick="add_fields();">
							Add Card
						</button>
				<div class="row">
						 <div class="table-responsive m-b-20 m-t-15">
								...
								<tbody id="add_fields">
									<tr>
										...
										<td >
										<div class="container">
										<input type="checkbox" class="checkboxNotify" name="ckId" id="ckId1" >
										<span class="checkmark"></span>
										</div>
										</td>
										<td><input type="text" id="cardName1" style="width: 100%;"  maxlength="26" 
												name="cardName[]" value="" placeholder="Card Name"></td>
										<td><input type="text" class="creditCardText" id="cardNo1"  maxlength="19" onclick="return isNumberKey1(event)" 
												name="cardNo[]" value="" placeholder="Card Number"></td>
										<td><input type="password" id="cvv1"  maxlength="3" onkeypress="return isNumberKey(event)" onpaste="return false;"
												name="cvv[]" value="" placeholder="CVV"></td> 
										<td><input type="text" class="creditCardExdt" id="exdt1" " maxlength="5" onkeypress="return isNumberKey2(event)" onpaste="return false;"
												name="exdt[]" value="" placeholder="MM-YY"></td>
										<td><input type="text" id="amount1"  maxlength="10" 
											name="amount[]" value="" placeholder="Amount"></td>
							...
							<div class="input-field col s12 m3 l3">
								...
								<div class="input-field col s12 m3 l3">	
								<button class="btn btn-primary blue-btn" id="save"
									onclick="return add('save')">Save</button>
									</div>
								<div class="input-field col s12 m3 l3" style="width:185px !important;">	
								<button class="btn btn-primary blue-btn" id="sumbit"
									onclick="return add('submit')">Save & Proceed</button>
									</div>
								</div>
							</div>

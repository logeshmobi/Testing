...
<form:form method="post" id="form1" name="form1" commandName="motoTxnDet"
		action="${pageContext.request.contextPath}/transactionMoto/motoSubmit" >
...
<div class="side-panel-dialog" id="mobi-ezylink-dialog" >
    <div class="side-panel-container">
		...
		<div class="mobi-container-fluid mobi-text-center d-grid mobi-gap-3 mobi-align-items-center mobi-mt-2 mobi-color"  >

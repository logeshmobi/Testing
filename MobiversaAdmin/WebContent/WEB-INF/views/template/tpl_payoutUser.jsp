			...
			<ul id="slide-out" class="sidenav">
				...
				<li>
					<ul class="collapsible">
						...
						<li><a
							href="${pageContext.request.contextPath}/payoutDataUser/list/1"
							class="collapsible-header"><i class="payout_menu"></i><span
								class="hide-menu"> Summary</span></a></li>


						<li><a
							href="${pageContext.request.contextPath}/payoutDataUser/merchantTopupList"
							class="collapsible-header"><i class="payout_menu"></i><span
								class="hide-menu">Merchant Topup</span></a></li>

						<li><a
							href="${pageContext.request.contextPath}/payoutDataUser/payoutbalance/1"
							class="collapsible-header"><i class="payout_menu"></i><span
								class="hide-menu">Payout Balance</span></a></li>

						<li><a
							href="${pageContext.request.contextPath}/payoutDataUser/payoutbankbalance"
							  class="collapsible-header" onclick="loader()"><i
								class="payout_summary_menu"></i><span cclass="hide-menu">Payout
									Bank Balance </span></a></li>

						<li><a
								href="${pageContext.request.contextPath}/payoutDataUser/accountEnquiry"
								class="collapsible-header " onclick="loader()"><i
					...
					<%-- 	<li><a
							href="${pageContext.request.contextPath}/payoutDataUser/manualSettlementJobTriggerIntial"
							  class="collapsible-header" onclick="loader()"><i
								class="payout_summary_menu"></i><span cclass="hide-menu">Settlement Job Trigger</span></a></li>

 --%>

						<li><a href="javascript: void(0);"
							class="collapsible-header has-arrow "> <i class="statuscheck"></i><span
								class="hide-menu">Status Check</span></a>
							<div class="collapsible-body statusbody ">
								<ul style="border: none; box-shadow: none">

									<li><a
										href="${pageContext.request.contextPath}/payoutDataUser/statusCheckFPX"><i
											class="statuscheck"></i><span class="hide-menu"> FPX
												Status</span></a></li>
									<li><a
										href="${pageContext.request.contextPath}/payoutDataUser/statusCheckBoost"><i
											class="statuscheck"></i><span class="hide-menu">Boost
												Status</span></a></li>

									<li><a
										href="${pageContext.request.contextPath}/payoutDataUser/statusCheckTngAndSpp"><i
											class="statuscheck"></i><span class="hide-menu">TNG &
												SPP Status</span></a></li>

									<%-- <li><a
										href="${pageContext.request.contextPath}/payoutDataUser/statusCheckShopeePay"><i class="statuscheck"></i><span
											class="hide-menu">Shopee Pay Status</span></a></li>	 --%>
						...
						<%-- <li><a
								href="${pageContext.request.contextPath}/duitnow/getDuitnowTxn"
								class="collapsible-header"><i class="material-icons">view_list</i><span
								class="hide-menu">DuitNow Transaction Summary</span></a></li> --%>

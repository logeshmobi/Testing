			...
			<ul id="slide-out" class="sidenav">
				...
				<li>
					<ul class="collapsible">
						...
						<li><a
							href="${pageContext.request.contextPath}/merchants/testPayout"
							class="collapsible-header"><i class="payout_menu"></i><span
								class="hide-menu"> Payout Request</span></a></li>
						<li><a
							href="${pageContext.request.contextPath}/testpayout/checkStatus"
							class="collapsible-header"><i class="payout_menu"></i><span
								class="hide-menu"> Check Status</span></a></li>

						<li><a
							href="${pageContext.request.contextPath}/testpayout/transactionSummary"
							class="collapsible-header"><i class="payout_menu"></i><span

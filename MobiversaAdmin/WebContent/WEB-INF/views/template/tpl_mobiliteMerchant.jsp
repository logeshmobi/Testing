...
<body>
	...
	id="mobiLogoCenterImg" alt="MobiLogo">
      ...
      <!--     <li>
         ...
         <li><a href="${pageContext.request.contextPath}/mobilite/merchProf/detailsMerchProf"><i class="material-icons">account_circle</i> Change Password</a></li>      
...
<li>
    ...
    <li>
        <a href="${pageContext.request.contextPath}/mobilite/merdashBoard" class="collapsible-header"><i class="material-icons">dashboard</i><span class="hide-menu"> Dashboard</span></a> 
      </li> 
      <li>
        <a href="${pageContext.request.contextPath}/mobilite/ezyLinkList" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu">Ezylink Summary</span></a> 
      </li> 
      </ul>
  </li>
</ul>

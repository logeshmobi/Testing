...
<link
	...
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resourcesNew1/dist/css/newstyle.css"
	rel="stylesheet">
...
.u-text {
	...
	display: table;
			...
			<ul id="slide-out" class="sidenav">
				<li>
					<ul class="collapsible">
						...
						<c:if test="${localAdmin == 'No'}">
							<c:if
								test="${ merchant.mid.umEzywayMid == '000000000021591' || UmEzywayMid == '000000000021591' || merchant.mid.boostMid == '000000000055813' || boostMid == '000000000055813' }">
								...
								<li><a href="javascript: void(0);"
									...
									<div class="collapsible-body">
										<ul>
											...
											<li><a
												href="${pageContext.request.contextPath}/admin/addSubMerchant"><i
													class="material-icons">person_add</i><span
													class="hide-menu">Add Merchant</span></a></li>
											<li><a
												href="${pageContext.request.contextPath}/admin/submerchantSum"><i
													class="material-icons">view_list</i><span class="hide-menu">Sub
														Merchant Summary</span></a></li>
						...
						<c:if test="${merchant.mid.mid != null ||  merchant.mid.motoMid != null || merchant.mid.ezyrecMid != null || merchant.mid.ezywayMid != null || merchant.mid.ezypassMid != null}">
						<li><a href="javascript: void(0);"
								...
								<ul>
										...
										<%-- <li><a
											href="${pageContext.request.contextPath}/transactionweb/listcash"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYCASH
													Transaction Summary</span></a></li> --%>
										<li><a
											href="${pageContext.request.contextPath}/transactionweb/listcard"><i
									...
									<c:if test="${merchant.mid.motoMid != null}">
										...
										<c:if
											...
											<li><a
												href="${pageContext.request.contextPath}/transactionweb/motolist"><i
										...
										<c:if
											...
											<li><a
												href="${pageContext.request.contextPath}/transactionweb/motoLinklist"><i
													class="material-icons">view_list</i><span class="hide-menu">EZYLINK
														Transaction Summary</span></a></li>
										</c:if>
									</c:if>
									<c:if test="${merchant.mid.ezywayMid != null}">
										<li><a
											href="${pageContext.request.contextPath}/transactionweb/ezywaylist"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYWAY
													Transaction Summary</span></a></li>
									</c:if>
									<c:if test="${merchant.mid.ezyrecMid != null}">
										<li><a
											href="${pageContext.request.contextPath}/transactionweb/ezyreclist"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYREC
													Transaction Summary</span></a></li>
										<li><a
											href="${pageContext.request.contextPath}/transactionweb/ezyrecpluslist"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYRECPLUS
													Transaction Summary</span></a></li>
									</c:if>
									...
									<c:if test="${ezyPodCheck == 'Yes'}">
										<li><a
											href="${pageContext.request.contextPath}/transactionweb/ezypodlist"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYPOD
													Transaction Summary</span></a></li>
									</c:if>

									<c:if test="${merchant.preAuth == 'Yes'}">
										<li><a
											href="${pageContext.request.contextPath}/merchantpreauth/PreAuth"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYAUTH
													Transaction Summary</span></a></li>
									</c:if>
        ...
        <li><a href="${pageContext.request.contextPath}/transactionweb/boostlist"><i class="material-icons">view_list</i><span class="hide-menu">BOOST Transaction Summary</span></a></li>
						...
						<li><a href="javascript: void(0);"
							class="collapsible-header has-arrow"><i class="umobile_menu"></i><span
							...
							<div class="collapsible-body">
								<ul>
										...
										<%-- <li><a
											href="${pageContext.request.contextPath}/transactionweb/listcash"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYCASH
													Transaction Summary</span></a></li> --%>
										<li><a
											href="${pageContext.request.contextPath}/transactionUmweb/alllist/1"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYWIRE
													Transaction Summary</span></a></li>
									</c:if>
									...
									<c:if
										...
										<li><a
											href="${pageContext.request.contextPath}/transactionUmweb/umEzywayList"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYWAY
													Transaction Summary</span></a></li>
											...
											<%-- <li><a
												href="${pageContext.request.contextPath}/transactionweb/listcash"><i
													class="material-icons">view_list</i><span class="hide-menu">EZYCASH
														Transaction Summary</span></a></li> --%>
											<li><a
												href="${pageContext.request.contextPath}/transactionUmweb/umMotoList"><i
													class="material-icons">view_list</i><span class="hide-menu">EZYMOTO
														Transaction Summary</span></a></li>
										</c:if>
									</c:if>
                    ...
                    <li><a href="${pageContext.request.contextPath}/transactionUmweb/UMMotoenquiryTransaction/1"><i class="material-icons">view_list</i><span class="hide-menu">UM_MOTO Transaction Enquiry</span></a></li>
											...
											<%-- <li><a
												href="${pageContext.request.contextPath}/transactionweb/listcash"><i
													class="material-icons">view_list</i><span class="hide-menu">EZYCASH
														Transaction Summary</span></a></li> --%>
											<li><a
												href="${pageContext.request.contextPath}/transactionUmweb/umLinkList"><i
													class="material-icons">view_list</i><span class="hide-menu">EZYLINK
														Transaction Summary</span></a></li>
									...
									<c:if test="${merchant.mid.splitMid != null}">
										<li><a
											href="${pageContext.request.contextPath}/transactionUmweb/umSplitList"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYSPLIT
													Transaction Summary</span></a></li>
									</c:if>
									...
									<c:if test="${merchant.mid.umMotoMid != null}">
										<li><a
											href="${pageContext.request.contextPath}/transactionUmweb/umEzyauthList/1"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYAUTH
													Transaction Summary</span></a></li>
									</c:if>
									...
									<c:if test="${merchant.mid.umEzyrecMid != null}">
										<li><a
											href="${pageContext.request.contextPath}/transactionUmweb/umEzyrecList"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYREC
													Transaction Summary</span></a></li>
									</c:if>
...
<c:if test="${merchant.mid.umMotoMid != null || merchant.mid.umEzyrecMid != null || merchant.mid.umEzywayMid != null || merchant.mid.umMid != null}">
						<li><a href="javascript: void(0);"
							class="collapsible-header has-arrow"><i class="failedtr_menu"></i><span
								class="hide-menu">U Mobile Failed Transactions</span></a>
							<div class="collapsible-body">
								<ul>
									<c:if test="${merchant.mid.umEzywayMid != null}">
										<li><a
											href="${pageContext.request.contextPath}/transactionUmweb/umEzywayFailList"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYWAY
									...
									<c:if test="${merchant.mid.umMotoMid != null}">
										<c:if
											test="${merchant.auth3DS == 'YES' || merchant.auth3DS == 'Yes'}">
											<li><a
												href="${pageContext.request.contextPath}/transactionUmweb/umLinkFailList"><i
													class="material-icons">view_list</i><span class="hide-menu">EZYLINK
														Transaction</span></a></li>
										</c:if>
									</c:if>
									...
									<c:if test="${merchant.mid.umMotoMid != null || merchant.mid.umMid != null}">
										
											<li><a
												href="${pageContext.request.contextPath}/transactionUmweb/umEzyauthFailList"><i
													class="material-icons">view_list</i><span class="hide-menu">EZYAUTH
														Transaction</span></a></li>
									...
									<c:if test="${merchant.mid.umMotoMid != null}">
										<c:if
											test="${merchant.auth3DS == null || merchant.auth3DS == 'NO' || merchant.auth3DS == 'No'}">
											<li><a
												href="${pageContext.request.contextPath}/transactionUmweb/umMotoFailList"><i
													class="material-icons">view_list</i><span class="hide-menu">EZYMOTO
														Transaction</span></a></li>
										</c:if>
									</c:if>
									...
									<c:if test="${merchant.mid.umEzyrecMid != null}">
										<li><a
											href="${pageContext.request.contextPath}/transactionUmweb/umEzyrecFailList"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYREC
													Transaction</span></a></li>
									</c:if>
									...
									<c:if test="${merchant.mid.umMid != null}">
										<li><a
											href="${pageContext.request.contextPath}/transactionUmweb/alllistFail/1"><i
												class="material-icons">view_list</i><span class="hide-menu">EZYWIRE
													Transaction</span></a></li>
									</c:if>
						...
						<c:if
							...
							<li><a href="javascript: void(0);"
								class="collapsible-header has-arrow"><i class="wallet_menu"></i>
										...
										<span class="hide-menu">EZYMOTO VCC</span>
									</a>
								<div class="collapsible-body">
									<ul>
										<c:if
											test="${merchant.ezyMotoVcc == 'YES' || merchant.ezyMotoVcc == 'Yes'}">
											<li><a
												href="${pageContext.request.contextPath}/transactionMoto/motovc"><i
													class="material-icons">account_balance_wallet</i><span
													class="hide-menu">Add EZYMOTO VCC</span></a></li>
											<li><a
												href="${pageContext.request.contextPath}/transactionMoto/vcSummary"><i
													class="material-icons">account_balance_wallet</i><span
													class="hide-menu">EZYMOTO VCC Details</span></a></li>
										</c:if>
									</ul>
								</div>
								</li>
						...
						<c:if test="${merchant.mid.ezyrecMid != null}">
							<li><a href="javascript: void(0);"
								...
								<div class="collapsible-body">
									<ul>
										<li><a
											href="${pageContext.request.contextPath}/transactionMoto/recurringList"><i
												class="material-icons">view_list</i><span class="hide-menu">Recurring
													Summary</span></a></li>
									</ul>
								</div></li>
						</c:if>
								...
								<div class="collapsible-body">
									<ul>
										...
										<c:if
											...
											<li><a
												href="${pageContext.request.contextPath}/merchantpreauth/PreAuthList"><i
										...
										<c:if
											test="${merchant.merchantType != null && (merchant.merchantType == 'U' || merchant.merchantType == 'FIUU')}">
											<li><a
												href="${pageContext.request.contextPath}/merchantpreauth/PreAuthList1"><i
													class="material-icons">view_list</i><span class="hide-menu">PREAUTH
														Transaction Summary</span></a></li>
						...
						<li><a href="javascript: void(0);"
							...
							<div class="collapsible-body">
								<ul>
									<li><a
										href="${pageContext.request.contextPath}/DailyReport/Card"><i
											class="material-icons">view_list</i><span class="hide-menu">
												CARD</span></a></li>
									<li><a
										href="${pageContext.request.contextPath}/transactionweb/dailypdf"><i
											class="material-icons">view_list</i><span class="hide-menu">
												EWALLETS and FPX</span></a></li>

									<li><a
										href="${pageContext.request.contextPath}/transactionweb/pdf"><i
											class="material-icons">view_list</i><span class="hide-menu">
												MONTHLY REPORT</span></a></li>
						...
						<li><a
							href="${pageContext.request.contextPath}/transactionUmweb/EzySettleList/1"
							class="collapsible-header"><i class="material-icons">view_list</i><span
								...
								<li><a
											...
											class="collapsible-header"><i class="material-icons">view_list</i><span
												cclass="hide-menu">PAYOUT Summary
													</span></a></li>
								</c:if>

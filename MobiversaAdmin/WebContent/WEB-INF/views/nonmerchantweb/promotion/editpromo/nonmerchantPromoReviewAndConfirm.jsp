...
function load()
{
 ...
 //$('#testing').click(function(){
      	...
      	swal({
      		title: "Are you sure? you want to edit this NonMerchant Promotion Details",
      	  ...
      	  cancelButtonClass: 'btn btn-danger',
      		...
      		if (isConfirm) {
      			 ...
      			 var url = "${pageContext.request.contextPath}/promotionwebNonmerchant1/list/1";
      			  $(location).attr('href',url);
      			//return true;
      		}
      	});
...
<body  onload="addrow()">
<form  method="post" id="form-edit" action="${pageContext.request.contextPath}<%=NonMerchantWebAddPromoController.URL_BASE%>/editReviewandConfirm" commandName="merchantPromo"> 
	...
	<div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-12 formContianer">
              <h3 class="card-title">Edit EZYAds Confirmation</h3>
	...
	<!-- <div class="card-body formbox"> -->	
							 <div class="row">		
								...
								<div class="form-group">
									<label for="PromoName">EZYAds Name</label>
										<%-- <input type="text" class="form-control" id="promoName" name="promoName" value="${merchantPromo.promoName}" disabled="disabled"> --%>	
										<textarea   class="form-control" id="promoDesc"   style="word-break:break-all;" rows="3" cols="2" maxlength="100"
										placeholder="promoName" name="promoName" path="promoName"   disabled="disabled">${merchantPromo.promoName}</textarea>
									<%-- ${agent.addr1} --%>
									</div>
									</div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="pCode" name="pCode" value="${merchantPromo.pCode}" disabled="disabled">
									<%-- ${agent.addr2} --%>
									</div>
									</div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="username" name="username" value="${merchantPromo.username}" disabled="disabled">
									<%-- ${agent.addr2} --%>
									</div>
									</div></div>
								<div class="row">		
									<div class="form-group col-md-4">
								<div class="form-group">
									<label for="promoDesc">EZYAds Desc</label>
										<input type="hidden" class="form-control" id="promoDesc" name="promoDesc" value="${merchantPromo.promoDesc}">	
										
										
										<textarea   class="form-control" id="promoDesc"   style="word-break:break-all;" rows="3" cols="2" maxlength="100"
										placeholder="promoDesc" name="promoDesc" path="promoDesc"   disabled="disabled">${merchantPromo.promoDesc}</textarea>
							 ...
							 <div class="row">		 -->
									<div class="form-group col-md-4">
								<div class="form-group">
									<label for="promoLogo1">EZYAds Image</label>
									</div>	
										<div class="form-group">
					...
					<div class="form-group col-md-4">
								<div class="form-group">
									<label for="points">Message Count</label>
									...
									<div class="form-group col-md-4">
								<div class="form-group">
									<label for="validFrom">Valid_From</label>
									...
									<div class="form-group col-md-4">
								<div class="form-group">
									<label for="validTo">Valid_To</label>
...
<button type="button"  id="testing" class="btn btn-primary icon-btn" onclick="return load()" >Confirm</button>  <!-- id="testing" -->

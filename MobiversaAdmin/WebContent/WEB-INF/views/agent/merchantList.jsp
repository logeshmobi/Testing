...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/agent/searchAgent?date='
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			//alert("test2: " + e + " " + e1);
			document.location.href = '${pageContext.request.contextPath}/agent/exportAgentList?date='
					+ fromdateString
					+ '&date1='
					+ todateString
					+ '&export='
				...
				<div class="card border-radius">
					<div class="card-content padding-card">
						...
						<div class="row">
							...
							%>
							<c:set var="backendUserName" value="${username}" />
							<%
							String backendUserName = (String) pageContext.getAttribute("backendUserName");
							boolean showDiv = dgUserName == null && !dgUserName.equals(backendUserName);
							%>

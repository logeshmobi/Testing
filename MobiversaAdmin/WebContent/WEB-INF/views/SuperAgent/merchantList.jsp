      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong> Merchant Detail Summary  </strong></h3>
          </div>
            ...
            <table id="data_list_table" class="table table-striped table-bordered">
              ...
              <c:forEach items="${paginationBean.itemList}" var="merc">
				...
				<td>${merc.createdBy}</td>  
                 ...
                 <td>${merc.ownerName}</td>
                 <td style="text-align:right;">${merc.autoSettled}</td>
                  <td align="center"><a href="${pageContext.request.contextPath}/superagent/viewMerchantDetailSummary/${merc.approved}/${merc.ownerName}">

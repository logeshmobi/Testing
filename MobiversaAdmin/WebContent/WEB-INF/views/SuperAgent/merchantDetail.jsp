      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          ...
          <div class="d-flex align-items-center">
           ...
           <%-- <div class="d-flex align-items-center">
          <h3> <a class="btn btn-primary btn-flat pull-right"
           href="${pageContext.request.contextPath}/superagent/loadTxnDetails/${merchant.id}/1">Load Transaction Details</a></h3>
          </div> --%>
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">  
           ...
           <table  id="data_list_table" class="display table table-striped table-bordered">
              ...
              <tbody>
               <c:forEach items="${paginationBean1.itemList}" var="termDet">
              <tr>
				 <td>${termDet.deviceType}</td>				
                 <td>${termDet.merchantId}</td>  
                  <td>${termDet.tid}</td>                   
                 <td>${termDet.connectType}</td> 
				<td>${termDet.activeStatus}</td> 
				<td style="text-align:right;">${termDet.remarks}</td> 

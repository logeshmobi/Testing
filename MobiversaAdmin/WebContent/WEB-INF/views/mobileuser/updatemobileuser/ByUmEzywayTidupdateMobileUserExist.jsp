      ...
      <div class="card border-radius">
		...
		<div class="input-field col s12 m6 l6 ">
				...
				placeholder="remarks" name="remarks"  value="${mobileUser.remarks }"/>
									...
									<c:if test="${mobileUser.um_ezywayMid !=null && mobileUser.um_ezywayMid !=null}">
						...
						<div class="row">
							...
							<div class="input-field col s12 m6 l6 ">
								...
								<c:forEach items="${mobileUser.um_ezywaytidList}" var="um_ezywayTid">
									...
									<option value="${pageContext.request.contextPath}/mobileUser/findUmMotoTidUserDetails?umEzywayTid=${um_ezywayTid}&umEzywayMid=${mobileUser.um_ezywayMid}">
							...
							<div class="input-field col s12 m6 l6 ">
									...
									<input type="text" id="um_ezywayTid" value="${mobileUser.um_ezywayTid}"
										placeholder="um_ezywayTid" name="um_ezywayTid"  path="um_ezywayTid" readonly="true"/>
							...
							<div class="input-field col s12 m6 l6 ">
								<label for="DTL">DTL</label> <input type="text" id="DTL1"
									value="${mobileUser.DTL}" placeholder="DTL1" name="DTL1"
									path="DTL1" />
							</div>

...
.drop-details .select-wrapper .caret {
  ...
  <div class="col s12">
      <div class="card border-radius">
		...
		<div class="input-field col s12 m6 l6 ">
				...
				<c:if test="${mobileUser.um_ezywayTid != null}">
  ...
  <div class="col s12">
      <div class="card border-radius">
        <div class="card-content padding-card">
		 <div class="d-flex align-items-center">
						<h3 >MobileUser UMEzywayDetails <font color="blue"> Mid: ${mobileUser.um_ezywayMid}</font> </h3>
</div>
						<div class="row">
							...
							<div class="input-field col s12 m6 l6 ">
									...
									<input type="text"  id="ezywayTid" value="${mobileUser.um_ezywayTid}"
												placeholder="ezywayTid" name="ezywayTid"  path="ezywayTid" readonly="true"/>
											
									
								 </div>
							<div class="input-field col s12 m6 l6 ">
											<label for="Email">User Name</label>
											<input type="text"  id="ezywayusername" value="${mobileUser.ezywayusername }"
												placeholder="ezywayusername" name="ezywayusername" path="ezywayusername"
												readonly="true"/>
										</div>

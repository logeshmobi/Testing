	...
	<div class="card border-radius">
        <div class="card-content padding-card">
			...
			name="form1" commandName="mobileUser">		
					...
					<input type="hidden" name="updateType" value="moto" path="updateType"/>
	<div class="row">
  <div class="col s12">
      <div class="card border-radius">
        <div class="card-content padding-card">
		 ...
		 <div class="d-flex align-items-center">
						...
						<div class="row">
							<div class="input-field col s12 m6 l6 ">
									...
									<label id="ezyrecTiderr"><c:if test="${responseDataezyrectid != null}">
									...
									<input type="text"  id="ezyrecTid" value="${mobileUser.ezyrecTid}"
										...
										onclick="document.getElementById('ezyrecTiderr').style.display='none';"/>
							...
							<div class="input-field col s12 m6 l6 ">
									...
									<label id="ezyrecdeviceIdErr"><c:if test="${responseDataezyrecdeviceid != null}">
													<H4 id="ezyrecdeviceIdErr" style="color: #ff4000;" align="center">${responseDataezyrecdeviceid}</H4>
												</c:if></label>
								...
								<div class="input-field col s12 m6 l6 ">
									...
									<select  name="ezyrecrefNo" path="ezyrecrefNo"
										id="ezyrecrefNo" style="width:100%" value="${mobileUser.ezyrecrefNo}">
										<option selected value=""><c:out value="refNo" /></option>
										<c:forEach items="${refNoList}" var="refNo">
											<option value="${refNo}">${refNo}</option>
						...
						Mid:${mobileUser.ezypassMid}</font></h3>
							...
							<div class="input-field col s12 m6 l6 ">
									...
									<label id="ezypassTiderr"><c:if test="${responseDataezypasstid != null}">
											<H4 id="ezypassTiderr" style="color: #ff4000;" align="center">${responseDataezypasstid}</H4>
										</c:if></label>
							...
							<div class="input-field col s12 m6 l6 ">
											<label for="Email">Device Id</label>
									<label id="epassdeviceIdErr"><c:if test="${responseDataepassdeviceid != null}">
													<H4 id="epassdeviceIdErr" style="color: #ff4000;" align="center">${responseDataepassdeviceid}</H4>
												</c:if></label>
											<input type="text" id="ezypassdeviceId" value="${mobileUser.ezypassdeviceId}"
												...
												onclick="document.getElementById('epassdeviceIdErr').style.display='none';"/>

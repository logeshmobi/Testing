...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/mobileUser/search?date='
	...
	function loadData(num) {
		...
		/* if (e == null || e == '' ) {
			...
			//alert('both $$ ##');
			document.location.href = '${pageContext.request.contextPath}/mobileUser/list/'
					+ pnum;
			form.submit;
		} else {
			//alert("else : "+e+" "+e1);
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			//alert("test2: " + e + " " + e1);
			document.location.href = '${pageContext.request.contextPath}/mobileUser/export?date='
            ...
            <table id="data_list_table" class="table table-striped table-bordered">
              ...
              <c:forEach items="${paginationBean.itemList}" var="dto">
						<tr>
							...
							<td >${dto.renewalDate}</td>
							<td >${dto.expiryDate}</td>

									<td>
									
				<form  method="post" id="form-edit" 
					action="${pageContext.request.contextPath}/mobileUser/details/" > 

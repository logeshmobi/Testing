...
/* var date;*/
	...
	function loadSelectData() {
		...
		if (e == null || e == '' ) {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchUM?days=' + e;
			form.submit;
			document.getElementById("dateval1").value = e;
		}
		//alert(e + " " + e1);
	...
	function loadData(num){
		...
		/* if (e == null || e == '' ) {
			...
			//alert('both $$ ##');
			document.location.href = '${pageContext.request.contextPath}/unusedmerchant/listUM/'+pnum;
			form.submit;
		}else {
			//alert("else : "+e+" "+e1);
			document.location.href = '${pageContext.request.contextPath}/unusedmerchant/searchUM?days=' + e
					+ '&currPage='+pnum;
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>UM_Unused Merchant Summary</strong></h3>
          </div>

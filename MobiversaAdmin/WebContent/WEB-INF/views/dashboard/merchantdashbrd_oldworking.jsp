	...
	<div class="container-fluid">
		...
		<div class="row-c" id="">
			...
			<div class="col-4 mb-2 side-panal" style="display: none;"
				...
				<div class="card-mobi p-3 rounded-0 height_80">
					<h3 class="c092540 h3-mobi">Payout Transaction</h3>
					<div class="row-c p-2">
						...
						<div class="col-10">
							<h6 class="small c969696 h6-mobi">Payout Date</h6>
					...
					<div class="row-c p-2">
						<div class="col-12 mobi-mt-30">
							<h6 class="c7e7e7e small mobi-mt-2 h6-mobi fz22">TRANSACTION
								DETAILS</h6>
					...
					<div class="row-c">
						<div class="col-6 pe-0">
							<button type="button" onclick="closeSidePanel()"
								class="btn-custom-1 btn-mobi bgA1A0A2 bcA1A0A2  text-white-mobi col-12">Cancel</button>
						</div>
						<div class="col-6 ps-0">
							<button type="button" onclick="closepayoutPanel()"
								class="btn-custom-2 btn-mobi bg005baa1 text-white-mobi col-12 ">Submit</button>
						</div>
					</div>
				</div>
			</div>
	...
	-webkit-tap-highlight-color: transparent;
			...
			<script>
				...
				function closepayoutPanel() {
					...
					var FinalPayableAmt = document
							.getElementById('input-payable-amt').value;
					var FinalWithdrawfee = document
							.getElementById('input-withdraw-amt').value;
					var FinalNetamt = document
							.getElementById('input-netamt-amt').value;
					var FinalPayoutdate = document
							.getElementById('input-payout-date').value;

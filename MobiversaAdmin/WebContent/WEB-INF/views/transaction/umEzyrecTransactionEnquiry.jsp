      ...
      <script lang="JavaScript">
         function loadSelectData() {
         	...
         	if (e == null || e == '' || e1 == null || e1 == '') {
         		...
         		document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyrecEnquiry?date='
         ...
         function loadExpData() {
         	...
         	if (e == null || e == '' || e1 == null || e1 == '') {
         		...
         		/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
         				+ e + '&date1=' + e1 + '&txnType=' + e2; */
         		document.location.href = '${pageContext.request.contextPath}/transaction/umEzyrecEnqExport?fromDate=' + fromdateString
            ...
            <div class="card blue-bg text-white">
               <div class="card-content">
                  <div class="d-flex align-items-center">
                     <h3 class="text-white">  <strong>EZYREC Transaction Enquiry</strong></h3>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="card-content padding-card">
                  <div class="row">
                     ...
                     <div class="input-field col s12 m3 l3">
                        ...
                        type="hidden" name="export1" id="export1" 
                        <c:out value="${status}"/>
                        >
                     </div>

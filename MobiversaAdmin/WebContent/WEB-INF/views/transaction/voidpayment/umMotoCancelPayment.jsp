...
<form:form method="post" id="form1" name="form1" commandName="txnDet"
		action="${pageContext.request.contextPath}/transaction/cancelMotoPaymentByAdmin" >
			...
			<p><h3 style="color: blue;font-weight: bold;">Transaction Details to Void</h3></p>
						...
						<form:input type="hidden" value="${txnDet.f260_ServID}" path="f260_ServID" />
							...
							<h3 class="card-title">MOTO Transaction Details</h3>
						...
						<div class="row">
										<div class="input-field col s12 m6 l6 ">
											...
											<a href="${pageContext.request.contextPath}/transaction/umMotoList/1"
											style="color:white;">Cancel</a>
											
											</button> --%>
											
											<a href="${pageContext.request.contextPath}/transaction/umMotoList" class="btn btn-primary blue-btn" style="color:white;">Cancel</a>

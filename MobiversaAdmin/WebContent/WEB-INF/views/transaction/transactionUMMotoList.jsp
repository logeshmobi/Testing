...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchUMMoto?date='
	...
	function loadExpData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			/* document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ e + '&date1=' + e1 + '&txnType=' + e2; */
			document.location.href = '${pageContext.request.contextPath}/transaction/umMotoExport?fromDate=' + fromdateString
...
function loaddata() {
	...
	if (e == null || e1 == null || e == '' || e1 == '') {
		...
		//alert("test2: " + e + " " + e1);
		 document.location.href = '${pageContext.request.contextPath}/transaction/umMotoExport?fromDate=' + e
				+ '&toDate=' + e1 +'&export='+e5; 
		//alert(e);
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>EZYMOTO Transaction Summary</strong></h3>
          </div>
               ...
               <div class="card-content">
                      ...
                      <!-- SEARCH TEST -->
                        <div class="row" style="display:flex;align-items:center;justify-content:space-between;margin-left:01%;">
                           ...
                           <option value="Aid_response">AID Response</option>
...
<div class="form-group col-md-4" id="divviewer" style="display: none;">
           ...
           <iframe id="popOutiFrame" frameborder="0" scrolling="no" width="800" height="600"></iframe>
										...
										<td  align="center">
												...
												<a href="${pageContext.request.contextPath}/transaction/cancelMotoPayment/${dto.f263_MRN}">
															<i class="material-icons">create</i></a>
												</c:if> --%>
										</td>
									 </tr>

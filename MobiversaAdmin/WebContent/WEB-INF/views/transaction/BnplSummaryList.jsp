...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchBnplAdmin?date='
					+ fromdateString
					+ '&date1='
					+ todateString
					+ '&txntype='
	...
	function loadSearch()
    {
  		...
  		document.location.href = '${pageContext.request.contextPath}/adminsearchNew/findBnpl?VALUE='
	...
	function loadExpData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/exportBnplAdmin?date='
					+ fromdateString
					+ '&date1='
					+ todateString
					+ '&txntype='

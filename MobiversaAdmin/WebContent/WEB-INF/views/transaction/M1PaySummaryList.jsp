...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchm1PayTransaction?date='
					+ fromdateString
					+ '&date1='
					+ todateString
					+ '&txntype='
	...
	function loadExpData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/exportm1PayTransaction?date='
					+ fromdateString
					+ '&date1='
					+ todateString
					+ '&txntype='
	  	  ...
	  	  var e = document.getElementById("drop_search");
	      	...
	      	if (strUser == "Invoice") {
	      		document.getElementsByName('search')[0].placeholder = 'Ex: Invoice Id';
	      		  ...
	      		  document.getElementsByName('search')[0].placeholder = 'Ex: Aproval Code';
	      	  }
	      	  else if(strUser == ""){
	...
	function loadSearch()
    {
  		...
  		document.location.href = '${pageContext.request.contextPath}/adminsearchNew/findM1pay?VALUE='
				...
				<div class="card blue-bg text-white">
					<div class="card-content">
						<div class="d-flex align-items-center">
							<h3 class="text-white">
								<strong>M1 PAY Transaction Summary</strong>
							</h3>
						</div>
					...
					<div class="card-content padding-card">
						...
						<div class="row">
							<div class="input-field col s12 m3 l3">
								<label id = "datef" for="from" style="margin: 0px;">Transaction
							...
							<div class="input-field col s12 m3 l3">
								...
								<label id = "datet" for="to" style="margin: 0px;">Transaction ToDate</label>
							...
							<div class="input-field col s12 m3 l3">
								...
								<select name="txnType" id="txnType"
									...
									<option value="SHOPPY">SHOPEE PAY</option>

...
<script lang="JavaScript">
	...
	var toDate = new Date(e1);
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchBizappSettlement?date='
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">
			 <div class="d-flex align-items-center">
					...
					<fmt:parseDate value="${setDate}" pattern="dd/MM/yyyy" var="myDate"/>
						...
						<div class="row">
							...
							<div class="input-field col s12 m6 l6 ">
											 ...
											 <div class="d-flex align-items-center">Deduction Amount:
           									<h3 style="color:red;margin-top:10px">${DeductAmt}</h3>
          							</div>

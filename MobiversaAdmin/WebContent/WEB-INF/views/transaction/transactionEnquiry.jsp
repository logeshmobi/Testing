...
function openNewWin(txnID){
   ...
   // alert(newWindow);
	...
	function loadSelectData() {
       ...
       var endD =year1+"/"+month1+"/"+day1;
		...
		if(e == '' && e1 == ''){
			...
			+ '&toDate=' + todateString + '&mid=' + e2+ '&tid=' + e3 + '&currPage=' + PageNumber; 
	...
	function loadSelectData1() {
		...
		var e3 = document.getElementById("Tid2").value;
		var PageNumber = document.getElementById("pgnum").value;
...
<div id="pagination"></div>
      ...
      <script>
         ...
         var TID2 = document.getElementById("Tid2").value="${paginationBean.TID2}";

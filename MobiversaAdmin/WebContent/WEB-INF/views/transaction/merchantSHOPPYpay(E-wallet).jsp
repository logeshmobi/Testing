...
function initiateRefund(){
	 ...
	 /* 	console.log("Updatedamount : ",amount)
	    ...
	    $.ajax({
	        type: "GET",
	        url: "${pageContext.request.contextPath}/merchant/transaction/refund/spp",
	        data: {
	            "transactionId": rrn,
...
function closeForSuccessRefund(){
	...
	var url = "${pageContext.request.contextPath}/transactionUmweb/merchantSHOPPYTransaction";
...
function openTngpayslip(rrn){
	...
	function openShopeepayslip(date,time,txnamount,mid,rrn,authcode,reference,txntype,status,merchantName,mrn)
    {
    ...
    document.getElementById("spp_slip_mrn").innerText = mrn;
    document.getElementById("spp_slip_reference").innerText = reference; 
...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/searchShoppypaymerchantlist?date='
...
/* SEARCH IMPLEMENTATION */
	...
	function loadExpData() {
		...
		if (e == null ||e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transactionUmweb/exportShoppypaymerchantlist?fromDate=' +fromdateString
				...
				<div class="card blue-bg text-white">
					<div class="card-content">
						<div class="d-flex align-items-center">
							<h3 class="text-white">
								<strong>SHOPPEE PAY Transaction Summary</strong>
							</h3>
						</div>
						...
						<table>
							...
							<tr class="no_border_bottom">
								<th class="poppins-regular xpay_slip_whiteSpace">Payment
									Method</th>
								<td class="poppins-medium xpay_slip_wordBreak">Shopee Pay</td>
							</tr>
												...
												<c:if test="${dto.cardType == 'SPP'}">
													<c:if
														...
														<a href="javascript:void(0)" id="openShopeeslip"
															onclick="javascript: openShopeepayslip(
															'${dto.date}',
															'${dto.time}',
															'${dto.f007_TXNAMT}',
															'${dto.f001_MID}',

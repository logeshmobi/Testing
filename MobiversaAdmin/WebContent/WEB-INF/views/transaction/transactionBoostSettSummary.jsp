...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchBoostss?date='
					+ fromdateString ;
			form.submit; 
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Boost Summary </strong></h3>
          </div>
						...
						<div class="row">
							<div class="input-field col s12 m6 l6 ">
									...
									<div class="d-flex align-items-center">HOST MDR Amount:
           									<h3 style="color:red;margin-top:10px">${hostMdr}</h3>
          							</div>
								 </div>
							<div class="input-field col s12 m6 l6 ">
											
										<div class="d-flex align-items-center">MOBI MDR Amount:
           									<h3 style="color:red;margin-top:10px">${mobiMdr}</h3>
          							</div>
										</div>
							<div class="input-field col s12 m6 l6 ">
				
											<div class="d-flex align-items-center">Total Transaction Amount:
           									<h3 style="color:red;margin-top:10px">${totTxn}</h3>
          							</div>
										</div>
							<div class="input-field col s12 m6 l6 ">
											
											<div class="d-flex align-items-center">Total Net Amount:
           									<h3 style="color:red;margin-top:10px">${totNet}</h3>
          							</div>
										</div>
							</div>

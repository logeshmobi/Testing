...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchumEzywireplus?date='
...
return false;
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/exportUmEzywireplus?date='
									...
									<c:forEach items="${paginationBean.itemList}" var="dto">
										<tr>
											...
											<td align="center"><c:if
													test="${dto.status =='SETTLED' || dto.status =='NOT SETTLED' ||dto.status =='CANCELLED' }">

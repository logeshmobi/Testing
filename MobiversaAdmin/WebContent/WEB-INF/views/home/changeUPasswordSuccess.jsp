...
<%@page import="com.mobiversa.payment.controller.MerchantProfileController"%>
...
<form method="post"
		action="<c:url value='${pageContext.request.contextPath}/admProfileconfirm/adminConfirmPassword'/>">
        ...
        <div class="card-content padding-card">
         ...
         <div class="row"> 		
					...
					<div class="input-field col s12 ">
					 <input type="text" value ="${adminUserName}" readonly> 
...
<div class="row"> 		
					...
					<div class="input-field col s12 ">
			<input  type="submit"
				class="btn btn-primary blue-btn" value="submit">
			</div>

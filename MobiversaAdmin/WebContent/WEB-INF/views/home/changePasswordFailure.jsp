...
function loadSelectData() {
	//alert("fcancel data");
	 ...
	 document.location.href = "${pageContext.request.contextPath}/merchProf/confirmPasswordbyMerch";
	form.submit;
}
</script>
<body class="">
<div class="container-fluid">  
 ...
 <div class="row">
  <div class="col s12">
	...
	<form method="post">  
<%-- action="<c:url value='${pageContext.request.contextPath}/merchantProfile/confirmPassword' />" --%>
<div class="row">
	 <div class="col s12">

...
<%@page
	import="com.mobiversa.payment.controller.MerchantProfileController"%>
 ...
 <div class="row">
  <div class="col s12">
	...
	<form method="post" name="form1"
		action="<c:url value='/merchProf/confirmPasswordbyMerch' />"  onsubmit="return checkPassword();">  <!-- onsubmit="return checkPassword();" -->
<div class="row">

...
<body>
				...
				<div class="card blue-bg text-white">
					<div class="card-content status-check-cardcontent">
						<div class="d-flex lign-items-center">
							<h3 class="text-white">
								<strong>Check Boost Transaction Status</strong>
							</h3>
						</div>
						...
						<div class="row invoiceidfield">
							<div class=" col s12 m12 l12 ">
								...
								<form class="d-flex"
									...
									action="${pageContext.request.contextPath}/payoutDataUser/getBoostStatus"
									method="post">
									...
									<div class="d-flex"
										...
										<label for="invoiceid" class="invoiceidtext">Invoice
											ID</label> <input type="text" placeholder="00000000000"
										...
										<tbody class="responsedata">
											...
											<c:forEach items="${response.itemList}" var="dto"
												...
												<tr class="dto-${loop.index}">
													...
													<td>${dto.responseData.transactionType}</td>
	...
	document.getElementById("pop-bg-color").style.display ="none";
			...
			/* console.log("${response.itemList.get(0).responseCode}","${response.itemList.get(0).responseMessage}","${response.itemList.get(0).responseData.amount}"); */ 
			
			     if(${not empty response.itemList.get(0).responseMessage}) {

        ...
        <div class="card blue-bg text-white">
         ...
         <div class="card-content status-check-cardcontent" style="text-align: center;">
                 <h6 style="text-align: center;">
                    <strong style="font-size: 20px !important; margin-top:0px;">"The Payout was unsuccessful due to the inactive</strong><br>
                    <strong style="font-size: 20px !important; margin-top:0px;">status."</strong>
                </h6>
            </div>
			                ...
			                <div class="transaction-details-box">
							    ...
							    <div class="detail-item"
			                        ...
			                        <div class="detail-item"
												...
												<span style="min-width: 30%;">Failure Reason</span><span>:</span><span
													id="transaction-id">${failureReason}</span>
											</div>

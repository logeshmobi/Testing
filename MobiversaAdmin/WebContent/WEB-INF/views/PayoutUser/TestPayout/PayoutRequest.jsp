...
<body>
	...
	<script>
		function validateForm() {
			...
			} else if (Payoutid === '' || Payoutid == "") {
				alert('Please fill Payout Id ');
				return false;
			}
	...
	<div class="container-fluid mb-0" id="main-container">
		...
		<form
			action="${pageContext.request.contextPath}/testpayout/validate-uat"
							...
							<div class="row sellerorderfield">
								...
								<div class="row">
									...
									<div class="input-field col s12 m6 l6 ">
										<label for="mobiApiKey" style="font-size: 17px;">Mobi
											API Key</label> <input type="text" value="${mobiApiKey}"
											name="mobiapikey" id="mobiapikey" readonly>

									</div>

									<div class="input-field col s12 m6 l6 ">
										<label for="Service" style="font-size: 17px;">Service</label>
										<input type="text" value="${service}" name="Service"
											id="Service" readonly>
									</div>


									<div class="input-field col s12 m6 l6 ">
										<label for="BusRegNO" style="font-size: 17px;">Business
											Reg No</label> <input class="form-control" type="text"
											name="BusinessRegNo" id="BusinessRegNo"
											value="${businessRegNo}" readonly>
									</div>



									<div class="input-field col s12 m6 l6 ">
										<label for="BankName" style="font-size: 17px;">Bank
											Name</label> <input class="form-control" type="text" name="Bankname"
											id="Bankname" value="${bankName}" readonly>
									...
									<div class="input-field col s12 m6 l6 ">
										<label for="BIC_Code" style="font-size: 17px;">BIC
											Code</label> <input class="form-control" type="text" name="BIC_Code"
											id="BIC_Code" value="${bicCode}" readonly>
									</div>



									<div class="input-field col s12 m6 l6 ">
										<label for="BankAccNo" style="font-size: 17px;">Bank
											Account No</label> <input class="form-control" type="text"
											name="BankaccNo" id="BankaccNo" value="${bankAccNo}"
											readonly>
									...
									<div class="input-field col s12 m6 l6 ">
										<label for="CustomerName" style="font-size: 17px;">Customer
											Name <span style="color: red;">*</span>
										</label> <input class="form-control" type="text" name="Customername"
									...
									<div class="input-field col s12 m6 l6 ">
										<label for="Amount" style="font-size: 17px;">Amount <span
											style="color: red;">*</span></label> <input class="form-control"
											type="text" name="amount" id="amount"
											placeholder="Enter Amount" oninput="validateAmount()">
									</div>


									<div class="input-field col s12 m6 l6 ">
										<label for="SubMid" style="font-size: 17px;">Sub MID</label> <input
											class="form-control" type="text" name="Submid" id="Submid"
											value="${subMid}" readonly>
									</div>


									<div class="input-field col s12 m6 l6 ">
										<label for="PayoutId" style="font-size: 17px;">Payout
											ID <span style="color: red;">*</span>
										</label> <input class="form-control" type="text" name="PayoutId"
											id="PayoutId" placeholder="Enter Payout Id">
									</div>


									<div class="statuscheckbtn-container"
										style="width: 45%; display: flex; justify-content: center; width: 100%;">

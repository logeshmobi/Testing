...
<body>
    ...
    <div class="col s12">
        <div class="card blue-bg text-white">
         ...
         <div class="card-content status-check-cardcontent" style="text-align: center;">
                 <h6 style="text-align: center;">
                    <strong style="font-size: 20px !important; margin-top:0px;">"Congratulations on your successful registration</strong><br>
                    <strong style="font-size: 20px !important; margin-top:0px;">of the payout service."</strong>
                </h6>
            </div>
			            ...
			            <div class="card-content status-check-cardcontent">
			                <div class="transaction-details-box">
							    ...
							    <div class="detail-item"
												...
												<span>Response Code</span><span>:</span><span>${responseCode}</span>											
											</div>
			                        <div class="detail-item"
												style=" margin-bottom: 5px;font-size: 13px !important; margin-top: 0; color: #707070;">
	 ...
	 <script>
        ...
        function back() {
            window.location.href = "${pageContext.request.contextPath}/merchants/testPayout";
        }
    </script>

				...
				<div class="card blue-bg text-white">
					<div class="card-content status-check-cardcontent"
						...
						<img class="img-fluid mobi-close"
							src="${pageContext.request.contextPath}/resourcesNew1/assets/Successful.png"
					...
					<div class="card-content status-check-cardcontent"
						...
						<h6 style="text-align: center;">
							<strong style="font-size: 20px !important; margin-top: 0px;">"Successful
								retrieval of payout records"</strong><br>
						</h6>
					</div>
					...
					<div class="card blue-bg text-white">
						<div class="card-content status-check-cardcontent">
							<div class="transaction-details-box">
								<h6
									style="font-size: 17px !important; margin-top: 0; color: #005baa; font-weight: 600; padding-bottom: 5px;">Transaction
									Details</h6>
								...
								<div class="detail-item"
									style="margin-bottom: 5px; font-size: 13px !important; margin-top: 0; color: #707070;">
									<span style="min-width: 30%;">Response Data</span><span>:</span><span
										id="transaction-id">"Nested JSON Response"</span>
								</div>

								<div class="detail-item"
									style="margin-bottom: 5px; font-size: 13px !important; margin-top: 0; color: #707070;">
									<span style="min-width: 30%;">Customer Name</span><span>:</span><span
										id="transaction-id">${responseData.customerName}</span>
								</div>

								<div class="detail-item"
									style="margin-bottom: 5px; font-size: 13px !important; margin-top: 0; color: #707070;">
									<span style="min-width: 30%;">Merchant Name</span><span>:</span><span
										id="transaction-id">${responseData.merchantName}</span>
								</div>

								<div class="detail-item"
									style="margin-bottom: 5px; font-size: 13px !important; margin-top: 0; color: #707070;">
									<span style="min-width: 30%;">Transaction ID</span><span>:</span><span
										id="transaction-id">${responseData.transactionId}</span>
								</div>

								<div class="detail-item"
									style="margin-bottom: 5px; font-size: 13px !important; margin-top: 0; color: #707070;">
									<span style="min-width: 30%;">Amount</span><span>:</span><span
										id="transaction-id">${responseData.amount}</span>
								</div>

								<div class="detail-item"
									style="margin-bottom: 5px; font-size: 13px !important; margin-top: 0; color: #707070;">
									<span style="min-width: 30%;">Bank Name</span><span>:</span><span
										id="transaction-id">${responseData.bankName}</span>
								</div>

								<div class="detail-item"
									style="font-size: 13px !important; margin-top: 0; color: #707070;">
									<span style="min-width: 30%;">Bank Acc No</span><span>:</span><span
										id="transaction-id">${responseData.bankAccNo}</span>
								</div>
							</div>
							<div class="statuscheckbtn-container"
								style="width: 100%; display: flex; justify-content: center; width: 100%; margin-top: 30px; margin-bottom: 20px">

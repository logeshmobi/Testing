...
<div class="container-fluid mb-0" id="pop-bg">
                ...
                <div class="card-content">
                    <div class="d-flex align-items-center">
                        <h3 class="text-white" style="margin-bottom: 0;">
                            <strong style="margin-bottom: 0;font-size: 22px !important;">DuitNow Transaction Summary</strong>
                        </h3>
                    </div>
                </div>
            </div>
                            ...
                            <c:forEach items="${paginationBean.itemList}" var="dto"
                                ...
                                <tr>
                                    ...
                                    <c:if test="${dto.status =='SETTLED'|| dto.status =='EZYSETTLED' || dto.status =='NOT SETTLED' || dto.status =='VOIDED'}">
                                            <a href="javascript:void(0)" id="opeDuitnowSlip"  onclick="duitnowSlip('${dto.paidDate}','${dto.paidTime}','${dto.txnAmount}','${dto.invoiceId}','${dto.transactionId}','${dto.status}','${dto.merchantName}')">
                                                <img class="w24"
 ...
 <c:if test="${paginationBean.itemList.size() ne 0}">
    <div class="row" >
        <div class="col s12">
            <div class="card border-radius" id="pagination_row">
                ...
                <div class="transaction-details">
                    <table>
                        ...
                        <tr class="no_border_bottom">
                            ...
                            <td class="poppins-medium xpay_slip_wordBreak">Duit Now</td>
                        </tr>
        ...
        <div class="moreinfo_modal_content">
            ...
            <div class=" more_info_content" >
                ...
                <table>
                    ...
                    <tr>
                        <td class="left_info">MDR Amount</td>
                        <td class="hyphen">:</td>
                        <td class="right_info" id="mdrAmount_info"></td>
                    </tr>
                    <tr>
                        <td class="left_info">Net Amount</td>
                        <td class="hyphen">:</td>
                    ...
                    <tr>
                        <td class="left_info">Payment Receipt</td>
                        <td class="hyphen">:</td>
                        <td class="right_info" id="paymentReceipt_info">
                            ...
                            <a href="javascript:void(0)" id="paymentReceiptLink"  style="display: flex;align-items: center;justify-content: flex-start;" >
                                ...
                                <span style="margin-left: 5px; text-align: center;">Receipt</span>
                            </a>
                        </td>
                    </tr>
                    <tr>
    ...
    <script>
        ...
        function loadSearch()
        {
            ...
            $("#overlay").show();
            document.location.href = '${pageContext.request.contextPath}/duitnow/duitnowDataSearch?searchId='
        ...
        function loadSelectData() {
            ...
            if (e == null ||e == '' || e1 == null || e1 == '') {
                ...
                $("#overlay").show();
                document.location.href = '${pageContext.request.contextPath}/duitnow/getDuitnowTxn?fromDate='
        ...
        function loadExpData() {
            ...
            if (e == null ||e == '' || e1 == null || e1 == '') {
                ...
                document.location.href = '${pageContext.request.contextPath}/duitnow/exportDuitnowTransactions?fromDate=' +fromdateString

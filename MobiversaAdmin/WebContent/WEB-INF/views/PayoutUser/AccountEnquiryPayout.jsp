...
<script type="text/javascript">
    ...
    function loadSearch()
    {
        ...
        document.location.href = '${pageContext.request.contextPath}/payoutDataUser/searchOnHoldPayout?id='
            + Value+'&idType=' + type;
        form.submit;
                                ...
                                <c:forEach var="enquiry" items="${paginationBean.itemList}">
                                    <tr>
                                        ...
                                        <td style="text-align: center;cursor: pointer">
                                            <img onclick="openInfo('${enquiry.nameInBank}', '${enquiry.payoutId}', '${enquiry.name}', '${enquiry.accountNumber}', '${enquiry.amount}', '${enquiry.invoiceId}')" src="${pageContext.request.contextPath}/resourcesNew1/assets/blureye.svg"/>
                                        </td>
                                        <td></td>
                                    </tr>
                                </c:forEach>
...
<%--                            <p><span class="label">Transaction ID</span><span>-</span><span class="value" id="info-invoiceId-display">Invoice Id</span></p>--%>
    ...
    <script>
        ...
        function rejectPayout(invoiceID) {
            ...
            document.location.href = '${pageContext.request.contextPath}/searchNew/rejectPayout?invoiceID='+invoiceID+'&reason='+comment;
        }
    </script>
        ...
        <div class="approve-modal-content">
            <div>
                ...
                <div>
                    ...
                    align-items: center;
                    margin-bottom: 30px;">Are you sure want to approve this transaction ?</p>
                </div>
                ...
                <div class="approve-button"
                    ...
                    <button type="button" class="close-Approve" id="approval_cancel" onclick="approvePayout(document.getElementById('invoice-for-approve').value)">confirm
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="approve-modal-class" id="reject-modal-id-confirmation" >
        ...
        <div class="approve-modal-content" style="margin-top: 80px">
            <div>
                ...
                <div class="reason-div" style="padding: 15px 30px; text-align: center;">
                    <img src="${pageContext.request.contextPath}/resourcesNew1/assets/Cancel 2.svg" width="50" height="50"/>
                </div>
                <div class="center-text">
                ...
                <div>
                    <div>
                        <textarea placeholder="Enter the reason for rejection..."
                                  ...
                                  style="width: 85%; min-height: 6rem; background-color: transparent; color: #586570; resize: none; border-color: #ADADAD; border-radius: 6px; margin-top: 4px; height: auto; margin-left: 20px">
                ...
                <div class="approve-button"
                    ...
                    <button type="button" class="close-Approve" id="reject_cancel" onclick="rejectPayout(document.getElementById('invoice-for-rejecting-the-Payout').value)">confirm
                    </button>
                </div>
            </div>
        </div>
...
<script>
    ...
    function goToPage(pageNum) {
        document.location.href = '${pageContext.request.contextPath}/payoutDataUser/accountEnquiry?currentPage=' + pageNum;
    }

...
<script lang="JavaScript">
	...
	function loadExpData() {
	    ...
	    if (e == null || e == '' || e1 == null || e1 == '') {
	        ...
	        document.location.href = '${pageContext.request.contextPath}/payoutDataUser/exportPayout?date=' + fromdateString + '&date1=' + todateString + '&export=' + e2;
...
<body class="">
		...
		<div class="email-content-class">
			...
			<div style="text-align: center;display : inline-block; border-bottom: 1.5px solid #ffa500; width: 100%; vertical-align: middle;
				padding: 2%;">
					        ...
					        <p style="font-size: 16px; font-weight: 500 !important; margin-bottom: 1px; color:#005baa; margin-bottom:1px;">Notification</p>
				...
				<div style="width: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 8px;">
					...
					<div style = "display: flex; align-items: center;justify-content: center; flex-direction: column; padding:5px 0px; width:80%; gap:5px;">
							...
							<img src="${pageContext.request.contextPath}/resourcesNew1/assets/mail_box1.svg"
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width="45px !important;">
							<div style = "width:100%; display: flex; align-items: left;">
								<p style="margin-bottom:1px;color:#586570; letter-spacing:0.27px;">Please enter your email to receive the CSV file.</p>
							</div>
					...
					<div style="padding: 0 10%;width: 100% !important; ">
							<input type="email" id="email-input" name="email"
								placeholder="username@gomobi.io" style="text-align: left; font-size:13px;padding-bottom:5px; height: 20px;color:#858585;margin-bottom:25px; border-bottom:1.5px solid #ffa500;">
							<p id="emailErrorMessage" style="color: red;font-size:12px;text-align:center;margin:0;margin-top:-15px;padding:5px 0px; display: none;">Email must end with @gomobi.io</p>
					</div>
			...
			<div style="display: flex; flex-direction: row; gap:10px; width:100%; align-items:center;padding: 2%; justify-content:center;background-color: #b1dcfb30;
				    border-bottom-right-radius: 9px; border-bottom-left-radius: 9px;">
	    				<button type="button" id="email-submit-btn-cancel" class="email-submit-class" onclick="closeNotify()"
	    				style="background: transparent;border: 2px solid #005baa; color: #005baa;">Cancel</button>
	   					<button type="button" id="email-submit-btn-submit" class="email-submit-class" onclick="submitEmail()">Submit</button>
					</div>
		</div>
	...
	<!-- <div id="email-modal-id" class="email-modal-class">
		...
		<div class="email-content-class">
			...
			<div style="text-align: right;" id="email-close-btn">X</div>
			...
			<div class=""
				...
				<div
					style="width: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; height: 70%;    padding-bottom: 18px;">

					<div style="color: #005baa;">
						<p style="margin-bottom: 0px; font-size: 13px;">Note :</p>
						<p style="font-size: 13px;">Note :Please Enter your email to share
							the csv file to your email..</p>
					</div>

					<input type="email" id="email-input" name="email"
						placeholder="Enter email" style="text-align: center;">
					<p id="emailErrorMessage" style="color: red;font-size:14px; display: none;">Email must end with @gomobi.io</p>
				</div>
				<div
					style="display: flex; flex-direction: row; align-items: center; justify-content: center;">
					<button type="button" id="email-submit-btn"

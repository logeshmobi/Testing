				...
				<div class="card blue-bg text-white">
					<div class="card-content">
						...
						<!--
								...
								<Strong class="rightPositionDate">Updated Date :</Strong>
								<strong class="rightPositionDate1">${dto.settlementdate}</strong>
-->
							...
							<table id="data_list_table"
								...
								<thead>
									<tr>
										...
										<th  Style="text-align: right;">Settlement Balance</th>
								...
								<tbody>
									...
									<c:forEach items="${paginationBean.itemList}" var="dto"
										...
										<tr class="dto-${loop.index}">
											...
											<td  Style="text-align: right;">${dto.depositamount}</td>
											 <td  Style="text-align: right;">${dto.totalamount}</td>
											 <td  Style="text-align: right;">${dto.overDraftAmt}</td>

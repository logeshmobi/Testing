...
<div class="container-fluid" style="background-color: transparent !important;">
            ...
            <div class="card border-radius">
                <div class="card-content padding-card" id="new_old_pass">
                    <div class="center-container">
                        ...
                        <p style="color: #586570;font-weight: 500;font-size: 23px;margin-top: 10px; margin-bottom: 2px">
                            Enter OTP</p>
                        <p style="font-size:13.4px;color: #586570; margin-bottom: 20px">Please enter the OTP sent to your registered email
                            address & phone number
                        </p>
                        <div>
                            <label style="color: #848687;font-weight: 500;font-size: 16px;margin-bottom: 0px">OTP</label><br>
                            <form method="post" id="myform" name="myform"
                                  action="${pageContext.request.contextPath}/resetPwd/resetPwdByUserName">
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <input type="number" name="otp" id="otp" placeholder="Enter otp" oninput="enableOtpBtn()"
                                       style="border: none; border-bottom: 1px solid #ffa500; text-align: left; font-size: 13px; color: #858585; outline: none; max-width: 100%; box-sizing: border-box;" class="no-arrows">
                        ...
                        <div class="button-container" style="font-size: 15px; text-align: center; margin-top: 26px; background-color: transparent;">
                            <button class="rounded-button" id="otp-btn-otp" disabled onclick="load1()" style="font-weight: 600; opacity: 0.5; font-family: 'Poppins', sans-serif;">
                                Proceed
                            </button>
                        </div>
                        ...
                        <div style="display: flex;justify-content: space-between;color: #858585">
                            <div style="display: flex;gap: 15px;justify-content: center;align-items: center;">
                                <p id="sendOtpPage" style="color: #858585;font-size: 14px;display: none">
                                    Didn't Receive OTP ?</p>
                                <p id="resend_otp_new"
                                   style="color: #005BAA;cursor:pointer;font-size: 14px; font-weight: 500;display: none"
    ...
    <script>
        ...
        var countdown = setInterval(function () {
            var timerElement = document.getElementById('timer');
            // var enterOtpInput = document.getElementById('otp');
            var resed_otp = document.getElementById('resend_otp_new');
            var resend_msg = document.getElementById('sendOtpPage');
            var isOtpExpired = "${isExpired}";
            ...
            if (isOtpExpired !== '') {
                ...
                resed_otp.style.display = "block";
                resend_msg.style.display = "block";
                // enterOtpInput.disabled = true;  // Disable the OTP input field
            }
        ...
        document.getElementById('otp').addEventListener('input', function (e) {
            ...
            e.target.value = value.replace(/[^0-9]/g, ''); // Replace any non-numeric characters
        });
    ...
    <form id="resend_otp_form" action="${pageContext.request.contextPath}/resetPwd/sendOtpToUserIfExist" method="post">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
    ...
    <%--                    <div style="margin-left: -10px">--%>
    <%--                        <img class="img-fluid" src="resourcesNew1/assets/logo1.svg">--%>
    <%--                    </div>--%>
    ...
    <%--                            <label style="color: #848687;font-weight: 500;font-size: 16px">New Password</label><br>--%>
    <%--                            <input type="password" name="npassword" id="npswd1" placeholder=""--%>
    <%--                                   style="border: none; border-bottom: 1px solid #ffa500; text-align: left; font-size: 13px; color: #858585; margin-bottom: 25px; outline: none; width: 400px; max-width: 100%; box-sizing: border-box;">--%>
    ...
    <%--                            </div>--%>
    <%--                        </div>--%>
    <%--                        <div id="passwordInput2" style="position: relative;">--%>
    <%--                            <label style="color: #848687;font-weight: 500;font-size: 16px">Confirm Password</label><br>--%>
    <%--                            <input type="password" name="cpassword" id="npswd2" placeholder=""--%>
    <%--                                   style="border: none; border-bottom: 1px solid #ffa500; text-align: left; font-size: 13px; color: #858585; margin-bottom: 25px; outline: none; width: 400px; max-width: 100%; box-sizing: border-box;">--%>
    ...
    <%--                        <button class="rounded-button" id="otp_confirm_btn" onclick="confirmNewPass()"--%>
    <%--                                style="font-weight: 600;opacity: 0.5;"--%>
    <%--                                disabled>Confirm--%>
    <%--                        </button>--%>
    <%--                    </div>--%>
    <%--                    <br>--%>
    <%--                    <a href="#" style="color: #005BAA;font-size: 13px">< Back to login page</a>--%>
    <%--                </div>--%>
    <%--            </div>--%>
    <%--        </div>--%>
    <%--    </div>--%>
        ...
        <div class="col s12 m5 offset-m6 offset-l5 l5">
            <div class="card border-radius" id="confimr_pass_modal">
                <div class="card-content padding-card">
                    ...
                    <form method="post" id="confirm_pass" name="confirm_pass"
                          action="${pageContext.request.contextPath}/resetPwd/resetPwdByUserNameConfirmed">
                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>

                        <p style="color: #586570;font-weight: 500;font-size: 23px; margin-bottom: 2px !important;">
                            Password Setup</p>
                        <p style="font-size:13px;color: #586570; margin-bottom: 5px">We're exited to have you on board.
                            Let's get you started.</p>


                        <div id="passwordInput" class="password-container" style="margin-top: 15px;">
                            <label style="color: #586570;font-weight: 400;font-size: 16px;margin-bottom: 0px">Enter
                                Password</label><br>
                            <input type="password" name="npassword" id="npswd1" placeholder="Enter new password"
                                   style="border: none; border-bottom: 1px solid #ffa500; text-align: left; font-size: 15px; font-family: 'Poppins', sans-serif; color: #858585; margin-bottom: 25px; outline: none; max-width: 100%; box-sizing: border-box;">
                        ...
                        <div id="passwordInput2" class="password-container" style="position: relative;">
                            <label style="color: #586570;font-weight: 400;font-size: 16px;margin-bottom: 0px">Confirm
                                Password</label><br>
                            <input type="password" name="cpassword" id="npswd2" placeholder="Re-enter new password"
                                   style="border: none; border-bottom: 1px solid #ffa500; text-align: left; font-size: 15px; font-family: 'Poppins', sans-serif; color: #858585; outline: none; max-width: 100%; box-sizing: border-box;">
                    ...
                    <div class="button-container"
                         style="font-size: small; text-align-last: center; margin-top: 10px; text-align: -webkit-center; background-color: transparent;">
                        <button class="rounded-button" disabled id="otp_confirm_btn" onclick="confirmNewPass()"
                                style="font-weight: 600;opacity: 0.5; font-family: 'Poppins', sans-serif;!important;"
                        >Set Password
                        </button>
                    </div>
                </div>
...
<div id="delclined-modal-id" class="declined-modal-class">
    <div class="declined-modal-content">
        <div>
            <div
                    style="border-bottom: 1px solid orange; padding: 15px 24px; text-align: center; font-size: 16px; color: #005BAA; font-weight: 600">
                Confirmation
            </div>
            ...
            <div class="reason-div"
                ...
                <img
                        ...
                        width="50" height="50"/>
                <p>Are you sure yout want to confirm this as your password?</p>
            </div>
...
<style>
    ...
    .confirm-Declined {
        ...
        border: none;
        /*padding: 10px 27px;*/
        padding: 10px 27px 6px 27px !important;
        font-size: 12px;
        height: 35px;
        outline: none;
        cursor: pointer;

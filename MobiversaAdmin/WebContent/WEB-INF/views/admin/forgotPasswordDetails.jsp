 ...
 <div class="container">     
  ...
  <div class="col s12">
      <div class="card border-radius">
        ...
        <form method="post" id="myform" name="myform" action="${pageContext.request.contextPath}/forgotpwd/resetByPwdByMailId">
        ...
        <div class="row">
   			...
   			<input type="text" placeholder="Email" name="email" id="email" size="20">
   				...
   				<div class="input-field col s12 m4 l6">
   				<button class="btn btn-primary" type="button" onclick ="load()">Send new password</button>
   				</div>
   			</div>
        </form>
        </div></div></div></div>

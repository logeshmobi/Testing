...
<head>
    ...
    <meta name="title"
          content="Mobiversa | Online Payment Service | Mobile Payment Malaysia">
    ...
    <!--   rk -->
    <%-- <link href="${pageContext.request.contextPath}/resourcesNew1/dist/css/pages/styleLogin.css"
                        rel="stylesheet"> --%>
    <%-- <link href="${pageContext.request.contextPath}/resourcesNew1/dist/css/style.css"
                            rel="stylesheet"> --%>


    <%-- <link href="${pageContext.request.contextPath}/resourcesNew1/dist/css/pages/dashboard1.css"
                                rel="stylesheet"> --%>
...
<body class="loginBg login-bg" onload="return ajaxGet();" id="body"
      name="body" oncontextmenu="return false">
        ...
        <div class="col-md-4 offset-md-7  offset-lg-7 col-lg-4 col-12 mt-2 order-0">
            <div class="container p-4 bg-white rounded-3 mt-3">
                ...
                <form data-parsley-validate name='loginForm' class="login-form" id="user_input_form"
                      ...
                      id="login" name="form1"
                      onsubmit="return ValidatehiddenCaptcha();">

                    <p style="color: #586570;font-weight: 500;font-size: 24px; margin-bottom: 0px !important;">Welcome
                        !</p>
                    <p style="font-size:13px;color: #858585; margin: 0px 0px 0px 0px!important">Please enter your
                        credentials to access your account.</p>
                    ...
                    <div class="form-group">
                        <label class="text-dark mb-2"
                               style="color: #586570 !important; margin-top: .7rem!important; margin-bottom: 3px!important">User
                            Name</label> <br>
                        <input name="username" type="text" class="form-control" style="border: none"
                               id="username" placeholder="Enter Username" onkeyup="checkForm()">
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 1rem!important;">
                        ...
                        <div style="position: relative;">
                            <input type="password" id="password" class="form-control" placeholder="Enter Password"
                                   name="password" onkeydown="return onclickTab(event);" onkeyup="checkForm()">
            ...
            <img class="show-hide-pass" src="${pageContext.request.contextPath}/resourcesNew1/assets/show-password.svg"
                 alt="Toggle Password Visibility">
                    ...
                    <!-- <div class="form-group mt-2">
                                    ...
                                    <input name="captcha" type="text" class="form-control " id="txtCompare2"
                    ...
                    <%-- <div class="form-group mt-5">
                                    <div class="row">
                                        <div class="col-6"><button class="btn btn-captcha ls-5 c-005baa fw-bold"
                                                id="CaptchaDiv" onclick="return test();"> </button></div>
                                        <div class="col-6"><button class="btn btn-005baa fw-bold"
                                                onclick="return regenerateCaptcha();"><img width="12%"
                                                    src="${pageContext.request.contextPath}/resourcesNew1/assets/regenerte.png">
                    ...
                    <!-- <div class="form-group mt-2">
                        <button type="submit" name="submit" id="btnValid"
                            class="btn btn-005baa fw-bold w100-per"
                            onclick="return newlogin()" style="display: none"
                            onclick="this.disabled = true">Login</button>
                    </div> -->
                    <br>
                    ...
                    <!-- <div class="g-recaptcha" data-sitekey="6Le36VAoAAAAAPDntooRdXwhLZdj3DNaFiVXFce4"></div>
                    ...
                    <input type="hidden" name="${_csrf.parameterName}"
                        ...
                        name="hiddenCaptcha" id="hiddenCaptcha" value="false" /> --%>
...
<!-- 	<script -->
<%-- src="${pageContext.request.contextPath}/resourcesNew/js/jquery-2.1.4.min.js">
                </script> --%>
<script
        src="${pageContext.request.contextPath}/resourcesNew/js/essential-plugins.js"></script>
<!-- 	<script -->
<%-- src="${pageContext.request.contextPath}/resourcesNew/js/bootstrap.min.js">
                    </script> --%>

<%-- <script src="${pageContext.request.contextPath}/resourcesNew/plugins/pace.min.js">
                        </script>
                        --%>
...
<script>
    var inputRange = document.getElementsByClassName('pullee')[0], maxValue = 150, // the higher the smoother when dragging

...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">		
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resourcesNew1/dist/css/pages/customloginn.css" >
...
<%--     <link href="${pageContext.request.contextPath}/resourcesNew1/dist/css/pages/dashboard1.css" rel="stylesheet"> --%>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resourcesNew1/dist/css/pages/bootstrap.min1.css" >
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resourcesNew1/dist/css/fonts/fonts.css" >
...
<!-- 			<h1 class="c-092540 mt-2">Looks like you'r new to mobi. Welcome</h1> -->
			<h1 class=" mt-2"></h1>
				...
				action="<c:url value='/j_spring_security_check' />?sdfweirukwioer=${_csrf.token}" method='POST' id="login"
...
<!-- <div class="form-group mt-2">
			...
			<%-- 			<div class="form-group mt-5">
				...
				<div class="errormsg"><h9>INVALID USERNAME OR PASSWORD</h9></div> 

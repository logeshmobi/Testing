...
@
-moz-document url-prefix() { .slide-text { margin-top:-12px;
			...
			<div
				...
				<div class="container p-4 bg-white rounded-3 mt-3">
					...
					<form data-parsley-validate name='loginForm' class="login-form"
						action="<c:url value='/j_spring_security_check' />?sdfweirukwioer=${_csrf.token}"
						...
						<div class="form-group mt-2">
							...
							<input name="username" type="text" class="form-control"
								id="username" placeholder="Username" onkeyup="checkForm()">
						...
						<div class="form-group mt-2">
							<button type="submit" name="submit" id="btnValid"
								class="btn btn-005baa fw-bold w100-per" disabled>Login</button>
						</div>

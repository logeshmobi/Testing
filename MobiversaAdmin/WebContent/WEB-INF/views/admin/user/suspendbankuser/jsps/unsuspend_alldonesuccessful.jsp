...
<%@page import="com.mobiversa.common.bo.BankUserStatusHistory"%>
...
<div class="col-xs-12 padding-10">
		<div class="h2">Un-Suspend Bank User</div>
	</div>

	<div class="col-xs-12">
		<ul class="nav nav-pills nav-wizard">
			<li class="disabled"><a href="#" data-toggle="tab">Un-Suspension Detail</a>
...
<div class="pull-left">
Your Un-suspension request has been successfully submitted</div>

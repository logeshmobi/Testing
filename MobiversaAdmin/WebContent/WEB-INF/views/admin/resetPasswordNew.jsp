            ...
            <div class="card border-radius">
                <div class="card-content padding-card">
                    <div class="center-container">
                        ...
                        <p style="color: #586570;font-weight: 500;font-size: 23px; margin-bottom: 2px !important;">Welcome to portal</p>
                        <p style="font-size:13px;color: #858585; margin-bottom: 23px!important;"  >We're exited to have you on board. Let's get you started.</p>
                        <label style="color: #858585;font-weight: 500;font-size: 15px">User Name</label><br>
                        <form method="post" id="myform" name="myform"
                              action="${pageContext.request.contextPath}/resetPwd/sendOtpToUserIfExist">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <input type="text" id="email-input" name="username" placeholder="Enter username" value="${username}" readonly oninput="enableBtn()"
                                   style="border: none; border-bottom: 1px solid #ffa500; text-align: left; font-size: 15px; font-family: 'Poppins', sans-serif; color: #858585; margin-bottom: 23px; outline: none; max-width: 100%; box-sizing: border-box;">

                        <%--                            <p style="color: red;margin-top: -18px;margin-bottom: 20px;">${statusMsg}</p> --%>


                            <div class="button-container" style="font-size: small; text-align-last: center; margin-top: 10px; text-align: -webkit-center; background-color: transparent;">
                                <button class="rounded-button" id="otp-button" onclick="loadIt()" style="font-family: 'Poppins', sans-serif !important; font-weight: 600; font-size: 15px; opacity: 1; padding-top: 16px!important; padding-bottom: 16px!important;">
                                    Send OTP
                                </button>
                            </div>

...
<div id="successMailId" class="confirmation_email_class">
    <div class="confirmation_email_content_class">
        <div>
            ...
            <div class="confirmation_icon_div" style="display: flex;justify-content: center;margin-top: 8px">
            ...
            <div
                ...
                <button type="button" style="font-family: 'Poppins' !important" class="successMail_btn" id="closeSuccessEmail">Back to login page</button>

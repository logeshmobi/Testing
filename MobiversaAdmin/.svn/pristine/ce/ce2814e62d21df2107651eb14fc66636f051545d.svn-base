...
<body>
	<form:form method="post" action="transactionUmweb/sendTrackData" commandName="trackDet"
		name="form1" id="form1">
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Send Track Details</strong></h3>
          </div>
						...
						<div class="row">
							<div class="input-field col s12 m6 l6 ">
									...
									<input type="text" id="customerName"
										placeholder="customerName" name="customerName" path="customerName" 
										 value= "${trackDet.customerName}" readonly="readonly"/>
								</div>
							...
							<div class="input-field col s12 m6 l6 ">
									...
									<input type="text" id="tid"
										placeholder="tid" name="tid" path="tid" 
										 value= "${trackDet.tid}" readonly="readonly"/>
								</div>
								
								<div class="input-field col s12 m6 l6 ">
									<label for=name>Customer Phone Number</label>
									<input type="text" id="customerPhoneNo"
										placeholder="customerPhoneNo" name="customerPhoneNo" path="customerPhoneNo" 
										 value= "${trackDet.customerPhoneNo}" readonly="readonly"/>
								</div>
								
							<div class="input-field col s12 m6 l6 ">
									<label for="trackNumber">Track Number</label>
									<form:input type="text" class="" id="trackNumber"
										placeholder="trackNumber" name="trackNumber" path="trackNumber" />
							</div>
							<div class="input-field col s12 m6 l6 ">
									<label for="courierName">Courier Name</label>
									<form:input type="text" class="" id="courierName"
										placeholder="courierName" name="courierName" path="courierName" />
							</div>
							
							
							<div class="input-field col s12 m6 l6 ">
									<label for="courierName">Sent Date</label>
									<form:input type="text" class="" id="sentDate"
										placeholder="YYYY-MM-DD" name="sentDate" path="sentDate" />
							</div>
							...
							<input type="hidden" id=tid
										 ...
										 value= "${trackDet.amount}" readonly="readonly"/>
										 
										 <input type="hidden" id="businessName"
										 name="businessName" path="businessName" 
										 value= "${trackDet.businessName}" readonly="readonly"/>
										 
										  <input type="hidden" id="mrn"
										 name="mrn" path="mrn" 
										 value= "${trackDet.mrn}" readonly="readonly"/>

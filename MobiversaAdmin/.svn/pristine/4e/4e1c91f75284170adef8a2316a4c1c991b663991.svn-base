...
<!-- Content Header (Page header) -->
					...
					<div class="panel-body">
						...
						<div class="form-body">
							<div class="form-group">
								<label class="col-md-3 control-label" style="color:black;">Effective Date: </label>
								<div class="col-md-9">
	...
	<div id="dialog" class="web_dialog">
		<div class="content">Are you sure you want to suspend this user:${bankUser.username }

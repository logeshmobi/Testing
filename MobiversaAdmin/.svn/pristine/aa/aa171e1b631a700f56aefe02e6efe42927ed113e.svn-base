        ...
        <div class="card-content padding-card">
         ...
         <h3 >Merchant List</h3>
				...
				<select name="merchantName" style="width:100%"  class="browser-default select-filter"
								...
								<c:out value="business Name" /></option>
								...
								|| merchant1.mid.ezywayMid!=null || merchant1.mid.ezyrecMid!=null || merchant1.mid.umMotoMid != null 
								 || merchant1.mid.umEzyrecMid != null || merchant1.mid.umEzywayMid != null || merchant1.mid.umEzypassMid != null
								  || merchant1.mid.umMid != null}">
									<option value="${pageContext.request.contextPath}/admmerchant/MerchantDetailsToChangePassword?mid=${merchant1.id}">
...
Change Mobileuser Password</button></center>
  ...
  <style>
 	...
 	<form:form method="post"  id="form"
			name="form" action="${pageContext.request.contextPath}/admmerchant/ChangeMerchPass" >
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">	
			...
			<div class="input-field col s12 m6 l6 ">
									...
									<label for="MID">EZYWIRE MID</label>
									<input  type="text" placeholder="EZYWIRE MID"
										name="mid" id="mid" path="mid" value="${merchant.mid.mid}"
										readonly="readonly">
							</div>
						...
						<div class="input-field col s12 m6 l6 ">
								...
								<input type="text" placeholder="EZYMOTO MID"
									name="motoMid" id="motoMid" path="motoMid" value="${merchant.mid.motoMid}"
									readonly="readonly">
				...
				<div class="input-field col s12 m6 l6 ">
							...
							<label for="MID">EZYPASS MID</label>
							<input  type="text" placeholder="EZYPASS MID"
			 ...
			 <c:if test="${merchant.mid.ezywayMid!=null}">
					<div class="input-field col s12 m6 l6 ">
							...
							<label for="MID">EZYWAY MID</label>
							<input  type="text" placeholder="EZYWAY MID"
								name="ezywayMid" id="ezywayMid" path="ezywayMid"
			 ...
			 <c:if test="${merchant.mid.ezyrecMid!=null}">
					<div class="input-field col s12 m6 l6 ">
							...
							<label for="MID">EZYREC MID</label>
							<input type="text" placeholder="EZYREC MID"
								name="ezyrecMid" id="ezyrecMid" path="ezyrecMid"
			...
			<div class="input-field col s12 m6 l6 ">
						...
						<div class="input-field col s12 m6 l6 ">
								...
								<label for="MID">UM_EZYMOTO MID</label>
					...
					<div class="input-field col s12 m6 l6 ">
							...
							<label for="MID">UM_EZYPASS MID</label>
							<input type="text" placeholder="UM_EZYPASS MID"
			 ...
			 <c:if test="${merchant.mid.umEzywayMid!=null}">
					<div class="input-field col s12 m6 l6 ">
							...
							<input type="text" placeholder="UM_EZYWAY MID"
			 ...
			 <c:if test="${merchant.mid.umEzyrecMid!=null}">
					<div class="input-field col s12 m6 l6 ">
							...
							<label for="MID">UM_EZYREC MID</label>
							<input type="text" placeholder="UM_EZYREC MID"
			...
			<button class="submitBtn"  id="buttonSub1" type="submit" >
Submit</button>
  ...
  <form:form method="post"  id="form"
			name="form" action="${pageContext.request.contextPath}/admmerchant/ChangeMobileuserPass" htmlEscape="true">
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">	
			...
			<div class="row">
				<div class="input-field col s12 m3 l3">
							...
							<div class="row">
								...
								<div class="input-field col s12 m6 l6 " style="display:none;" id="motoTid1">
										<label for="MOTO TID">MOTO TID</label> <input
											 type="text"
				...
				<input class="form-control" type="text" placeholder="Enter Password To change" name="mobileuserPass"  

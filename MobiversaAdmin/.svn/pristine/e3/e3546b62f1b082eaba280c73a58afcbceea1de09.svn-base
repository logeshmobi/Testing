      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Add GrabPay User</strong></h3>
          </div>
					...
					<div class="row">
							<div class="input-field col s12 m5 l5">
								...
								<c:forEach items="${merchant1}" var="merchant1">
									<option value="${pageContext.request.contextPath}/grabPay/findgrabPayUserDetails?id=${merchant1.id}">
...
.select-search-hidden .select2-container{
	display:none !important;
				...
				<form:form method="POST" id="form1" action="${pageContext.request.contextPath}/grabPay/regGrabPay"
			name="form1" commandName="mobileUser">	
					...
					<c:if test="${mobileUser.businessName !=null }">
						<c:if test="${mobileUser.gPayMid ==null }">
						<div class="row">
  <div class="col s12">
      <div class="card border-radius">
        <div class="card-content padding-card">
        <div class="d-flex align-items-center">
					...
					<c:if test="${mobileUser.mid !=null}">
						<div class="input-field col s3 ">
									<label for="contactName">EZYWIRE MID</label>
						
							<input type="text" path="mid" id="mid"
								name="mid" Placeholder="EZYWIRE MID" value="${mobileUser.mid }" readonly="readonly"/>
						...
						<div class="input-field col s3 ">
									<label for="contactName">EZYMOTO MID</label>
						
							<input type="text"  path="motoMid" id="motoMid" readonly="readonly" 
								name="motoMid" Placeholder="EZYMOTO MID" value="${mobileUser.motoMid }"/>
						...
						<div class="input-field col s3 ">
									<label for="contactName">EZYPASS MID</label>
						
							<input type="text" path="ezypassMid" id="ezypassMid" readonly="readonly" 
								name="ezypassMid" Placeholder="EZYPASS MID" value="${mobileUser.ezypassMid }"/>
						...
						<div class="input-field col s3 ">
									<label for="contactName">EZYWAY MID</label>
						
							<input type="text"  path="ezywayMid" id="ezywayMid" readonly="readonly" 
								name="ezywayMid" Placeholder="EZYWAY MID" value="${mobileUser.ezywayMid }"/>
						...
						<div class="input-field col s3 ">
									<label for="contactName">EZYREC MID</label>
						
							<input type="text" class="form-control" path="ezyrecMid" id="ezyrecMid" readonly="readonly" 
								name="ezyrecMid" Placeholder="EZYREC MID" value="${mobileUser.ezyrecMid }"/>
      ...
      <div class="card border-radius">
        ...
        <div class="d-flex align-items-center">
					...
					<div class="input-field col s3 ">
							...
							<input type="text" path="ezyrecMid" id="gPayMid"
								name="gPayMid" Placeholder="GrabPay MID" value="${mobileUser.gPayMid }"/>
<input type="hidden" class="form-control" name="merchantID" id="merchantID" 

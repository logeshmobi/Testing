...
function msgCount()
{
	...
	if(e >= a)
	{
		alert("Merchant Count Dont exist:" + a);
		return false;
	}
...
<!-- <div style="overflow:auto;border:1px;width:100%"> -->
          ...
          <div class="card" >
              ...
              <!-- <h3 class="card-title userTitle">Edit<i class="fa fa-pencil pull-left" aria-hidden="true"></i> <span class="pull-right"> -->
					...
					<div class="form-group col-md-4">
								...
								<input type="text" class="form-control" id="deviceId" name="deviceId" value="${merchantPromo.deviceId}" readonly="readonly">
								</div>
							</div></div>
		...
		<!-- align="right" width ="100"  height="100"	 -->
					...
					<div class="form-group col-md-4">
								...
								<input type="hidden"
							name="validityDate1" id="validityDate1" value="${validityDate1}"> <input
							type="text" class="form-control" id="datepicker" name="validFrom" value="${merchantPromo.validFrom}"
							 placeholder="dd/mm/yyyy">
								...
								<input type="hidden"
							name="validityDate2" id="validityDate2" value="${validityDate2}"> <input

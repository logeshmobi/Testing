...
<!-- Content Header (Page header) -->
	...
	<form method="post" action="/mobileUserweb/suspend/doSuspend" id="form-suspend">
	<!-- <form method="get" action="/mobileUserweb/list" id="form-suspend"> -->
		<input type="hidden" name="id" value="${merchant.id }"> <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		<div class="col-xs-9">
			<div class="row">
					...
					<div class="panel-body">
						...
						<div class="form-body">
							<div class="form-group">
								<div class=" control-label"><b>Effective Date:</b> </div>
								<div class="col-md-9">
	...
	<div id="dialog" class="web_dialog">
		<div class="content">Are you sure you want to suspend this user:${mobileUser.username }

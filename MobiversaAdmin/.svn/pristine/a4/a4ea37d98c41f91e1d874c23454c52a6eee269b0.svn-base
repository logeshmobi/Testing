      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Update GrabPay User</strong></h3>
          </div>
						...
						<div class="row">
							...
							<div class="input-field col s12 m5 l5">
								...
								<c:forEach items="${merchant1}" var="merchant1">
									<option value="${pageContext.request.contextPath}/grabPay/finduser?id=${merchant1.id}">
...
.select-search-hidden .select2-container{
	display:none !important;
				...
				<form:form method="POST" id="form1" action="${pageContext.request.contextPath}/grabPay/updateGrabPayUser"
        ...
        <div class="d-flex align-items-center">
					...
					<div class="row">
						...
						<div class="input-field col s3 ">
									...
									<select name="mobileId" path="mobileId" 
										id="mobileId"  style="width:100%" value="">
										<option selected value=""><c:out value="mobilesusername" /></option>
										<c:forEach items="${mob}" var="mob">
											<option value="${mob.id}" title="${mob.id}">${mob.username}</option>


										</c:forEach>
									</select>
									<label for="Email">MobileUser List</label>
								</div>
							</div>	

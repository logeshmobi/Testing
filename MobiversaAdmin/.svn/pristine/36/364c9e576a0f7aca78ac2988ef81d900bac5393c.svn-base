...
public class MerchantResetTemplate {
	...
	public static String sentTempletContent(TempletFields templetFields) {
		...
		return "<!DOCTYPE html>"
				...
				+ "<meta property=\"og:title\" content=\"Account Password Reseted\">"
				+ "<meta property=\"fb:page_id\" content=\"43929265776\">"
				+ "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1, maximum-scale=1\">"
				+ "        <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">"
				+ "        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">"
				+ "		<title>Account Password Reseted</title>"
				...
				+ "                                        <img width=\"564\" align=\"center\" class=\"mcnImage\" style=\"max-width: 1200px;padding-bottom: 0;display: inline !important;vertical-align: bottom;border: 0;height: auto;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;\" alt=\"\" "
				+ "src=\"cid:mobiversa_logo1\" >"
				+ "                            </td>"
				+ "                        </tr>"
				+ "                    </tbody></table>"
				+ "                </td>" + "            </tr>" + "    </tbody>"
				...
				+ "                            <h1 style=\"display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 18px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: center;\">"
				//+ "Your Merchant WebPortal&nbsp;Account Password Has Been Reseted</h1>"
				+ "<center>The password of your Mobiversa Merchant account has been reset as per your request</center></h1>"
				...
				/*+ "Dear&nbsp;" +"Mr "
				+"Jackie Chan" + "&nbsp;,<br>" + "<br>"*/
				+ " Please&nbsp;follow the&nbsp;link below to sign into your account :<br>"
				+ "<br>"
				...
				+ "Please use your login username and password as below.<br>"
				+ "<br>"
				...
				/*+ " Jackie Chan" + "</font></strong><br>"
				+ "<font color=\"#000000\">PASSWORD : </font><strong><font color=\"#000000\">"
				+ "sjdfj3d90i" + "</font></strong><br>"
				*/
				
				/*+ "<font color=\"#000000\">DEVICE ID :</font><strong><font color=\"#000000\">"
				+ templetFields.getDeviceId()
				+ "</font></strong>"*/
				+ "</span></span></span><br>"/* + "<br>"*/
				+ "In case you need any clarification, please contact <i>info@gomobi.io</i>.<br>"
				+ "<br>"
				+ "This is an auto generated password, please feel free to change your credentials on your login.</p>"
				+ "                        </td>" + "                    </tr>"
				+ "                </tbody></table>" + "            </td>"
				+ "        </tr>" + "    </tbody>" + "</table></td>"
				+ "                            </tr>"
				...
				+"<table width=\"100%\" class=\"mcnDividerBlock\" style=\"min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;table-layout: fixed !important;\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">"
				 ...
				 +" <table width=\"100%\" class=\"mcnTextBlock\" style=\"min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">"
						  ...
						  /*+ "<span style=\"color:#ffffff\"><em>Copyright © 2016 Mobiversa, All rights reserved.</em><br>"
						  +

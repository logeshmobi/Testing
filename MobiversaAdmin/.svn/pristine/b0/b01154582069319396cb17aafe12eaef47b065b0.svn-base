...
<body>
	...
	id="mobiLogoCenterImg" alt="MobiLogo">
      ...
      <!--     <li>
         ...
         <li><a href="${pageContext.request.contextPath}/superagent/superagentProfportal/agentPassDetails"><i class="material-icons">account_circle</i> Change Password</a></li>      
...
<li>
    <ul class="collapsible">
      ...
      <li>
        <a href="${pageContext.request.contextPath}/superagent/txnagentdashBoard" class="collapsible-header "><i class="material-icons">dashboard</i><span class="hide-menu"> Dashboard</span></a> 
      </li> 
      <li>
        <a href="${pageContext.request.contextPath}/superagent/ChangeMerchantPasswordByAgent" class="collapsible-header "><i class="material-icons">phonelink_lock</i><span class="hide-menu">Change Password</span></a> 
      </li>
      
       <li>
        <a href="${pageContext.request.contextPath}/agent2/hotelMerchantslist/1" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu"> Merchant Summary</span></a> 
      </li>
      
      <%-- <li>  <a href="${pageContext.request.contextPath}/agentVolume/listHotelMerchantvolume" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu">Merchant Volume </span></a> --%>
      <li>  <a href="${pageContext.request.contextPath}/agentVolume/listHotelMerchantvolByAgent" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu">Merchant Volume </span></a>  
       <li>
                <a href="javascript: void(0);" class="collapsible-header has-arrow"><i class="material-icons">account_balance_wallet</i><span class="hide-menu">Transaction Summary</span></a>
                <div class="collapsible-body">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/superagent/transaction/umMotoList/1"><i class="material-icons">view_list</i><span class="hide-menu"> EZYMOTO Transaction Summary</span></a></li>

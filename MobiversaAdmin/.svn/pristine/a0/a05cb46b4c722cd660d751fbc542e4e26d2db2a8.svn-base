...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchUMEzyway?date='
					+ fromdateString + '&date1=' + todateString+ '&mid=' + mid;
			form.submit;
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong> EZYWAY Transaction Summary</strong></h3>
          </div>
        ...
        <div class="card-content padding-card">
						...
						<i class="material-icons prefix">date_range</i>
								...
								<div class="input-field col s12 m3 l3">
									...
									<div class="input-field col s12 m3 l3">
									<input
											type="hidden" name="umezywaymid" id="umezywaymid" value="">
										<select name="mid" id="mid"
											...
											<c:forEach items="${merchant1}" var="merchant1">
												<option
													value="${merchant1.mid.umEzywayMid}">
										...
										<label class="control-label">UMEZYWAY MID</label> 
									</div></div>
									...
									<tr>
										...
										<td>${dto.f023_RRN}</td>
											...
											<td align="center">
												...
												<input type="hidden" name="chBack" id="chBack" value="${dto.f007_TXNAMT}">
												<input type="hidden" name="mid" id="mid" value="${dto.f001_MID}"> 
											
											<button class="btn btn-primary" type="button"
											onclick="return loadChData(${dto.f007_TXNAMT},'${dto.f001_MID}','${dto.f263_MRN}');"><a><i class="material-icons">history</i></a></button>

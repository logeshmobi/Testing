...
<%-- <link rel="stylesheet" href="${pageContext.request.contextPath}/resourcesNew/css/main.css"> --%>
...
<div class="container-fluid">    
 ...
 function load()
 {
	var url = "${pageContext.request.contextPath}/superagent/getToypayMerchantRecentTxn";

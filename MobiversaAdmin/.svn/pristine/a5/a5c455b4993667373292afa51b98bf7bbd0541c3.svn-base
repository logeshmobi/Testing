...
<body>
	...
	id="mobiLogoCenterImg" alt="MobiLogo">
      ...
      <!--     <li>
         ...
         <li><a href="${pageContext.request.contextPath}/superagent/superagentProfportal/toypayPassDetails"><i class="material-icons">account_circle</i> Change Password</a></li>      
...
<li>
    <ul class="collapsible">
      ...
      <li>
        <a href="${pageContext.request.contextPath}/superagent/toypayMerchantdashBoard" class="collapsible-header "><i class="material-icons">dashboard</i><span class="hide-menu"> Dashboard</span></a> 
      </li> 
      <li>
        <a href="${pageContext.request.contextPath}/superagent/ChangeMerchantPasswordByToypay" class="collapsible-header "><i class="material-icons">phonelink_lock</i><span class="hide-menu">Change Password</span></a> 
      </li>
      
       <li>
        <a href="${pageContext.request.contextPath}/agent2/toyPayMerchantslist/1" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu"> Merchant Summary</span></a> 
      </li>
      
      
      <li>  <a href="${pageContext.request.contextPath}/agentVolume/listToypayMerchantvolByAgent" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu">Merchant Volume </span></a>  
       <li>
                ...
                <div class="collapsible-body">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/superagent/transaction/umEzywayList/1"><i class="material-icons">view_list</i><span class="hide-menu"> EZYWAY Transaction Summary</span></a></li>

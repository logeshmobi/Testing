...
<!-- Content Header (Page header) -->
	...
	<form method="post" action="/readerweb/suspend/doSuspend" id="form-suspend">
									...
									<select class="form-control" name="reason">
										<c:forEach items="${reasonList}" var="reason">
											<c:choose>
												...
												<c:when test="${readerUserStatusHistory.reason == reason }">
	...
	<div id="dialog" class="web_dialog">
		<div class="content">Are u sure u want to suspend this reader:${reader.serialNumber }

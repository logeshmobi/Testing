...
function loadCancelData() {
	//alert("fcancel data");
	 ...
	 document.location.href = "${pageContext.request.contextPath}/masterMerchant/list/1";
	form.submit;
}
...
//contact sal
	...
	var an = document.getElementById("agentName").value;
	//alert('state val : '+st);
	var agentName = document.getElementById("agentName1");
	loadtype1(an,agentName);
...
<div class="container-fluid">   
 ...
 <div class="row">
  ...
  <div class="col s12">
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong> Edit Master Merchant</strong></h3>
          </div>
    ...
    <form action="${pageContext.request.contextPath}<%=MasterMerchantController.URL_BASE%>/editMasterMerchant" 
...
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
 <input type="hidden" name="id" value="${masterMerchant.id}" />
 
        <div class="d-flex align-items-center">
		 <button type="button" class="btn btn-primary blue-btn"><a style="color:#fff !important;"
          href="${pageContext.request.contextPath}/masterMerchant/addMasterMerchant">Add New <i class="material-icons">add</i></a></button>
         </div>
			  ...
			  <div class="d-flex align-items-center">
          		...
          		<%--  Ag Code: ${agent.code}				
					...
					Mail Id:	${masterMerchant.mailId}
												
						<input type="hidden" class="form-control" id="mailId" name="mailId" value="${masterMerchant.mailId}">
						</h3>
            </div>
						 <div class="row">									
           ...
           <input type="hidden" class="form-control" value="${masterMerchant.salutation}" id="salutation" name="salutation"/>
						...
						onchange="document.getElementById('salutation').value=this.value;">
							...
							<option   value="" >Salutation</option>
								...
								<input type="text"  id="firstName" name="firstName" value="${masterMerchant.firstName}" >
								</div>
							
							<div class="input-field col s12 m6 l6 ">
									<label  for="lName">Last Name</label>
								<input type="text" id="lastName" name="lastName" value="${masterMerchant.lastName}" >
								</div>
							<div class="input-field col s12 m6 l6 ">
									<label  for="addr1">Address1</label>
								<input type="text" id="addr1" name="addr1" value="${masterMerchant.addr1}" >
								</div>
							</div>	
							<div class="row">
							<div class="input-field col s12 m6 l6 ">
									<label  for="addr2">Address2</label>
								<input type="text" id="addr2" name="addr2" value="${masterMerchant.addr2}" >
								</div>
							
							<div class="input-field col s12 m6 l6 ">
									<label  for="city">City</label>
								<input type="text"  id="city" name="city" value="${masterMerchant.city}" >
								</div>
							<div class="input-field col s12 m6 l6 ">
									<label  for="addr1">Post Code</label>
								<input type="text"  id="postCode" name="postCode" value="${masterMerchant.postCode}" >
								</div>
							</div>	
							...
							<div class="input-field col s12 m6 l6 ">
								...
								<input type="hidden" value="${masterMerchant.state}" id="state" name="state">
                              ...
                              <select class="form-control" name="state1" id="state1"
								...
								<input type="hidden" value="${masterMerchant.agentName}" id="agentName" name="agentName">
			
                              <select class="form-control" name="agentName1" id="agentName1"
									 onchange="document.getElementById('agentName').value=this.value;">
							...
							<div class="input-field col s12 m6 l6 ">
								...
								<input type="text"  id="phoneNo" name="phoneNo" value="${masterMerchant.phoneNo}" >
								</div>
				
							<div class="input-field col s12 m6 l6 ">
									
								<input type="hidden" class="form-control" id="status" name="status" value="${masterMerchant.status}" >
							...
							<div class="input-field col s12 m6 l6 ">
								...
								<input type="text" id="bankName" name="bankName" value="${masterMerchant.bankName}" >
								</div>
							
							
							<div class="input-field col s12 m6 l6 ">
									<label  for="bankAcc">Bank Account</label>
								<input type="text" id="bankAcc" name="bankAcc" value="${masterMerchant.bankAcc}" >
								</div>
							<div class="input-field col s12 m6 l6 ">
									<label  for="NricAccount">Nric Account</label>
								<input type="text" id="nricNo" name="nricNo" value="${masterMerchant.nricNo}" >
								</div>
								</div>
							</div>	

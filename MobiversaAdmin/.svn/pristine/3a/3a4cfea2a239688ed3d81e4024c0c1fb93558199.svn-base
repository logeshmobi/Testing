...
function cancel(){
	...
	document.getElementById('form1').action = '${pageContext.request.contextPath}/transactionweb/motolist';
...
<form:form method="post" id="form1" name="form1" commandName="txnDet"
		action="${pageContext.request.contextPath}/transactionweb/EzylinkCancelPaymentByMerchant" >
		 ...
		 <div class="d-flex align-items-center">
			...
			<p><h3 style="color: blue;font-weight: bold;">Transaction Details to Void</h3></p>
				...
				<div class="row">
						...
						<div class="d-flex align-items-center">
							<h3 class="card-title">EZYLINK Transaction Details</h3>
							</div>
						...
						<div class="input-field col s12 m6 l6 ">
											...
											<button type="submit" class="btn btn-primary" ><a href="${pageContext.request.contextPath}/transactionweb/motoLinklist"

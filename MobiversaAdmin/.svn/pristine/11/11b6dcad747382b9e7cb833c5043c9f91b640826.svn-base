...
function cancel(){
	...
	document.getElementById('form1').action = '${pageContext.request.contextPath}/transaction/ezypodList';
...
<form:form method="post" id="form1" name="form1" commandName="txnDet"
		action="${pageContext.request.contextPath}/transaction/cancelEzypodPaymentByMerchant" >
<div class="row">
  <div class="col s12">

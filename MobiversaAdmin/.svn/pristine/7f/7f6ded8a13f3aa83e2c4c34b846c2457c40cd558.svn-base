      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong> Edit  Master Merchant Details</strong></h3>
          </div>
...
<form action="editMasterMerchantUnsuccess" method="post">
...
<div class="col-xs-12">
		<ul class="nav nav-pills nav-wizard">
			<li class="disabled"><a href="#" data-toggle="tab">Master Merchant Detail</a>
	...
	<div class="bar-switch-record col-xs-12 padding-top-10">
		<div class="pull-left">Error Code: ${masterMerchant.error}</div>
	</div>

...
function openNewWin(txnID){
	...
	var src = document.getElementById('popOutiFrame').src;
	 src=url+'preauthtxn/details/'+txnID;
	//    alert(src);
	//src = pdffile_url;
	//alert(src);
	var h = 600;
    ...
    <div class="row">
					  <div class="col s12">
						 ...
						 <div class="d-flex align-items-center" style="width:25%">
					         <a class="btn btn-primary blue-btn" href="${pageContext.request.contextPath}/preauthtxn/list">Back</a>
 ...
 <style>
    ...
    <div class="table-responsive m-b-20 m-t-15">
						...
						<tr>
						<td>Merchant Name</td>
						<td> <c:out value="${namedd}"/> </td>
						</tr>
						<tr>
						<td>State</td>
						<td> <c:out value="${nameyy}"/> </td>
						</tr>
						</tbody>
						</table>
					...
					<tbody>
						<c:forEach items="${paginationBean.itemList}" var="dto">
							<tr>
								...
								<td style="text-align:right;"><c:out value="${dto.amount}"/></td>

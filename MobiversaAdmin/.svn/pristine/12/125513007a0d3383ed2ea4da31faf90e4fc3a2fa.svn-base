...
public class PaydeeTxnExcelView extends AbstractExcelView {
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(7).setCellValue("Name on Card");
		excelHeader.createCell(8).setCellValue("Reference");
		excelHeader.createCell(9).setCellValue("MID");
		excelHeader.createCell(10).setCellValue("RRN");
		excelHeader.createCell(11).setCellValue("Stan");
		excelHeader.createCell(12).setCellValue("Approve Code");
	}
	...
	public void setExcelRows(HSSFSheet excelSheet, List<ForSettlement> txnList){
		...
		for (ForSettlement txn : txnList) {
			...
			excelRow.createCell(7).setCellValue(txn.getNumOfRefund());
			excelRow.createCell(8).setCellValue(txn.getInvoiceId());
			excelRow.createCell(9).setCellValue(txn.getMid());
			excelRow.createCell(10).setCellValue(txn.getRrn());
			excelRow.createCell(11).setCellValue(txn.getStan());
			excelRow.createCell(12).setCellValue(txn.getAidResponse());

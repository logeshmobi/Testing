...
public class mobiliteSettlementMDRExcel extends AbstractExcelView {
	...
	public void setExcelRows(HSSFSheet excelSheet, List<SettlementMDR> txnList){
		...
		for (SettlementMDR txn : txnList) {
			...
			excelRow.createCell(0).setCellValue(txn.getSubSettleDate());
			excelRow.createCell(1).setCellValue(txn.getSubMerchantName());
			
			excelRow.createCell(2).setCellValue(txn.getSubMid());
			excelRow.createCell(3).setCellValue(txn.getSubTid());
			...
			excelRow.createCell(9).setCellValue(txn.getSubHostMdrAmt());
			excelRow.createCell(10).setCellValue(txn.getSubMobiMdrAmt());
			
			excelRow.createCell(11).setCellValue(txn.getSubMdrAmt());
			excelRow.createCell(12).setCellValue(txn.getExtraDeductAmt());
			excelRow.createCell(13).setCellValue(txn.getSubNetAmount());

...
public class UMMobiliteMerchantMotoTxnExcel extends AbstractExcelView {
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(8).setCellValue("Customer Email");
		excelHeader.createCell(9).setCellValue("Customer Phone Number");
		excelHeader.createCell(10).setCellValue("Goods Status");
		excelHeader.createCell(11).setCellValue("Updated date");
	...
	public void setExcelRows(HSSFSheet excelSheet, List<UMEzyway> txnList){
		...
		for (UMEzyway txn : txnList) {
			...
			excelRow.createCell(8).setCellValue(txn.getF278_EMAILADDR());	
			excelRow.createCell(9).setCellValue(txn.getF279_HP());	
			excelRow.createCell(10).setCellValue(txn.getGoodsStatus());	
			excelRow.createCell(11).setCellValue(txn.getUpdatedDate());	
		}
	}

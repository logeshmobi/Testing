...
<div class="container-fluid">    
  <div class="row">
        ...
        <div class="card-content padding-card">
		 ...
		 <div class="d-flex align-items-center">
			...
			<p><h3 style="color: blue;font-weight: bold;">Transaction Details</h3></p>
				...
				<div class="row">
							<div class="d-flex align-items-center">
							<h3 class="card-title">UM-EZYAUTH Transaction Details</h3>
							</div>
	...
	<form method="post" id="form1" name="form1" action="${pageContext.request.contextPath}/transactionUmweb/umAuthByMerchant?${_csrf.parameterName}=${_csrf.token}">

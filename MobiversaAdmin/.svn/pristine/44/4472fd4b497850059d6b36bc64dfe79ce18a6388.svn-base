	 ...
	 $(document).ready(function() {
		...
		/* 	function validateForm1(){ */
			if (validateForm() && SubmitFormAmount()) {
			 ...
			 var r = confirm("Yours Requested Amount Of MOTO Transaction RM "+document.getElementById("amount").value
...
<body >
 ...
 <form method="post" id="form1" name="form1" commandName="motoTxnDet"
	...
	<%-- <form method="post" id="form1" name="form1" 
		...
		<div class="row" >
			...
			<input type="hidden" path="motoMid" name="motoMid" id="motoMid" value="${merchant.mid.motoMid }"/>
			<div style="overflow: auto; border: 1px; width: 100%;">
				...
				<div class="content-wrapper" >
					...
					<h3 class="card-title">EZYMOTO Transaction</h3>
					<div class="row" >
								...
								<div class="card-body" style="width:100%;">
									...
									<div class="row" style="width:100%;">
										...
										<div class="form-group col-md-4" style="width:100%;">
											<div class="form-group">
												...
												</select> <input class="form-control" type="tel" value="" id="phno"
									...
									<div class="row" style="width:100%;">
										<div class="form-group col-md-4 i" style="width:100%;" >
											<div class="form-group">
												<label class="control-label">Reference</label> <input
													class="form-control" value="" id="referrence" path="referrence"
													name="referrence" placeholder="Enter referrence">
					...
					<div class="row">
						<div class="form-group col-md-4 i">
							<div class="form-group">
								...
								<input type="hidden" name="latitude" value="" id="latitude" path="latitude"/>
                				<input type="hidden" name="longitude" value="" id="longitude" path="longitude"/>

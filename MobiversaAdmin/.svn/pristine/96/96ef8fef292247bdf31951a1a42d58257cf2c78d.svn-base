...
<div class="container-fluid">  
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Reset Password </strong></h3>
          </div>
 ...
 <form   data-parsley-validate   method="post" name= "form1"  class="form-horizontal"
		action="<c:url value='/admProfileconfirm/adminConfirmPassword'/>" onsubmit="return checkPassword();"> 
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">
          <div class="d-flex align-items-center">
           ...
           <b><input style="border-bottom:0px!important; color:#005baa;" type="text" value ="${adminUserName}" readonly> </b></h5>
				...
				<div class="row passwordcard"> 		
					...
					<div class="input-field col s12 ">
						<input type="password" placeholder="ConfirmPassword"  placeholder="ConfirmPassword" name="confirmPassword"  id="confirmPassword" >

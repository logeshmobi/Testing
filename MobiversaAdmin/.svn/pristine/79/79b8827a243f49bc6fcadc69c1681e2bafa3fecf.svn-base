...
<form action="/admin/bankUserDetails/${bankUser.id}" >
<div>
<input type="hidden" name="id" value="${bankUser.id }"> 
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
<div class="col-xs-12">
		<ul class="nav nav-pills nav-wizard">
			<li class="disabled"><a href="#" data-toggle="tab">Bank User Detail</a>
				<div class="nav-arrow"></div></li>
			<li class=""><div class="nav-wedge"></div> <a href="#">Review & Confirm</a></li>

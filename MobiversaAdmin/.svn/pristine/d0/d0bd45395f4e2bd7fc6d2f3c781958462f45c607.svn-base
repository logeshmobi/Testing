...
<script type="text/javascript">
jQuery(document).ready(function() {
	$('#ezyrecrefNo').change(function(){
	  if($(this).val() == $('#motorefNo').val()) {
	    alert('Duplicate value');
	    return false;
	   /*  $(this).val(''); */
	  }
	  if($(this).val() == $('#ezypasssrefNo').val()) {
		    alert('Duplicate value');
		    return false;
	  }
	}); 
						...
						<c:if test="${mobileUser.ezywiretidList !=null }">
							...
							<div class="input-field col s12 m6 l6 ">
									...
									<input type="text"  id="tid" value="${mobileUser.tid }"
												placeholder="tid" name="tid" path="tid"  readonly="true"/>
									
								</div>
							<div class="input-field col s12 m6 l6 ">
											<label for="merchantusername">User Name</label>
											<input type="text"  id="ezywiremobusername" value="${mobileUser.ezywiremobusername }"
												placeholder="ezywiremobusername" name="ezywiremobusername" path="ezywiremobusername"
												readonly="true"/>
		 ...
		 <div class="d-flex align-items-center">
						...
						<div class="row">
							...
							<div class="input-field col s12 m6 l6 ">
									...
									<select  name="tid3" id="tid3" path="tid3">
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">
		 <div class="d-flex align-items-center">
						...
						<div class="row">
							<c:if test="${mobileUser.um_tidList !=null }">
							<div class="input-field col s12 m6 l6 ">
									
									<select name="um_tid1" id="um_tid1" path="um_tid1">
								 		<option selected value=""><c:out value="EZYPASS TID" /></option>
								
											<c:forEach items="${mobileUser.um_tidList}" var="um_tid">
												<%-- <option <c:out value="${tid}"/>> --%>
									
												<option value="${pageContext.request.contextPath}/mobileUser/findEzypassTidUserDetails?um_tid=${um_tid}&um_mid=${mobileUser.um_mid}">
											 			${um_tid}
												</option>

...
<body>
	...
	id="mobiLogoCenterImg" alt="MobiLogo">
      ...
      <!--     <li>
         ...
         <li><a href="${pageContext.request.contextPath}/agentProfportal/agentPassDetails"><i class="material-icons">account_circle</i> Change Password</a></li>      
...
<li>
    <ul class="collapsible">
      ...
      <li>
        <a href="${pageContext.request.contextPath}/admin/agent/dashBoard" class="collapsible-header"><i class="material-icons">dashboard</i><span class="hide-menu"> Dashboard</span></a> 
      </li> 
      
      <li>
        <a href="${pageContext.request.contextPath}/agent2/list" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu"> Merchant Summary</span></a> 
      </li> 
      
      <li>
        <a href="${pageContext.request.contextPath}/agentVolume/listMerchantGPV" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu"> Merchant GPV Summary</span></a> 
      </li>
      
      <li>
          <a href="javascript: void(0);" class="collapsible-header has-arrow"><i class="material-icons">view_list</i><span class="hide-menu">Agent Volume</span></a>
          <div class="collapsible-body">
              <ul>
              <li>
			     	<a href="${pageContext.request.contextPath}/agentVolume/list" class="collapsible-header has-arrow"><i class="material-icons">view_list</i><span class="hide-menu">Agent Volume</span></a></li>
			     <li>  <a href="${pageContext.request.contextPath}/agentVolume/listmerchantvolume" class="collapsible-header has-arrow"><i class="material-icons">view_list</i><span class="hide-menu">Merchant Volume Summary</span></a> 
			    </li>
              </ul>
             </div>
             </li>
      ...
      <li>
        <a href="${pageContext.request.contextPath}/agentVolume/listMasterMerchantVolume" class="collapsible-header"><i class="material-icons">view_list</i><span class="hide-menu">Master Merchant Summary</span></a> 
      </li>

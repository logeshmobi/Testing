...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/searchEzypass?date='
...
return false;
	...
	function loaddata() {
		...
		if (e == null || e == '' || e1 == null || e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/transaction/exportEzypass?date='

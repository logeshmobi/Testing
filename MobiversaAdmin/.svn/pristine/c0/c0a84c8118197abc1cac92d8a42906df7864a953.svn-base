...
<form:form method="post" id="form1" name="form1" commandName="txnDet"
		action="${pageContext.request.contextPath}/transactionUmweb/cancelEzyrecPaymentByAdmin1" >
						...
						<div class="d-flex align-items-center">
							...
							<table class="table table-striped" width="100%">
								...
								<div class="input-field col s12 m6 l6 ">
											...
											<a href="${pageContext.request.contextPath}/transactionUmweb/umEzyrecList"

...
public class EmailTemplet11 {
	...
	public static String sentTempletContent(TempletFields templetFields) {
		...
		return "<!DOCTYPE html>"
				...
				//+ "                            <h1 style=\"display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;\">Your Agent&nbsp;Account Has Been Created</h1>"
				+ "                            <h1 style=\"display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: center;\"> We have created and activated of your Mobiversa web portal account.</h1>"
				...
				+ "Congratulations! your agent account has been created on Mobiversa. Please&nbsp;follow the&nbsp;link below to sign into your account :<br>"
				+ "<br>"

...
<form:form method="post" id="form1" name="form1" commandName="txnDet"
		action="${pageContext.request.contextPath}/transaction/MotoCancelPaymentByAdmin" >
			...
			<p><h3 style="color: blue;font-weight: bold;">Transaction Details to Void</h3></p>
				...
				<div class="row">
						...
						<div class="input-field col s12 m6 l6 ">
											...
											<button type="submit" class="btn btn-primary" ><a href="${pageContext.request.contextPath}/transaction1/list/1"

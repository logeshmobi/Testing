...
function load1()
 {
	var url = "${pageContext.request.contextPath}/agent1/addAgent";
...
function load()
{
 ...
 swal({
   		title: "Are you sure? you want to add this Agent Details",
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>Add Agent Details</strong></h3>
          </div>
...
<form:form action="agent1/agentDetailsReviewAndConfirm" method="post" commandName="agent" id="form-add">
 ...
 <div class="input-field col s12 m6 l6 ">
								...
								<%-- 	${agent.salutation} --%>
									<input type="text" id="firstName"
										placeholder="mailId" name="mailId" path="mailId"  value= "${agent.mailId}" readonly="readonly"/>
									</div>
									<div class="input-field col s12 m6 l6 ">
									<label for="salutation">Salutation</label>
								<%-- 	${agent.salutation} --%>
									<input type="text"  id="firstName"
										placeholder="firstName" name="firstName" path="firstName"  value= "${agent.salutation}" readonly="readonly"/>
									</div>
							<div class="input-field col s12 m6 l6 ">
									...
									<input type="text" class="form-control" id="lastName"
										placeholder="lastName" name="lastName" path="firstName"  value= "${agent.lastName}" readonly="readonly"/>
									</div>
									</div>
							 ...
							 <div class="row">
									...
									<%-- <input type="text" class="form-control" id="addr1"
										...
										id="addr1" style="word-break:break-all;" name="addr1"  readonly="readonly">${agent.addr1}</textarea>
									</div>
									<div class="input-field col s12 m6 l6 ">
									...
									<%-- <input type="text" class="form-control" id="firstName"
										placeholder="firstName" name="firstName" path="firstName"  value= "${agent.firstName}" readonly="readonly"/> --%>
										<textarea  readonly="readonly" row="2"  column="2" max-length="120" class="form-control" 
										id="addr2" style="word-break:break-all;" name="addr2"  readonly="readonly">${agent.addr2}</textarea>
									</div>
									<div class="input-field col s12 m6 l6 ">
									<label for="city">City</label>
									<%-- ${agent.city} --%>
									<input type="text" class="form-control" id="city"
										placeholder="city" name="city" path="city"  value= "${agent.city}" readonly="readonly"/>
									</div>
									<div class="input-field col s12 m6 l6 ">
									<label for="PostCode">Post Code</label>
									<%-- ${agent.postCode} --%>
									<input type="text" class="form-control" id="postCode"
										placeholder="postCode" name="postCode" path="postCode"  value= "${agent.postCode}" readonly="readonly"/>
									</div>
									</div>
									...
									<input type="text" class="form-control" id="phoneNo"
										placeholder="phoneNo" name="phoneNo" path="phoneNo"  value= "${agent.phoneNo}" readonly="readonly"/>
									</div>
									<div class="input-field col s12 m6 l6 ">
									<label for="state">State</label>
									<%-- ${agent.state} --%>
									<input type="text" class="form-control" id="state"
										placeholder="state" name="state" path="state"  value= "${agent.state}" readonly="readonly"/>
									</div>
									<div class="input-field col s12 m6 l6 ">
							...
							<div  style="display: none;" id="BankDetails">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="bankName"
										placeholder="bankName" name="bankName" path="bankName"  value= "${agent.bankName}" readonly="readonly"/>
									</div>
									</div>
								</div>	
								...
								<div class="input-field col s12 m6 l6 ">
									...
									<input type="text" class="form-control" id="bankAcc"
										placeholder="bankAcc" name="bankAcc" path="bankAcc"  value= "${agent.bankAcc}" readonly="readonly"/>
									</div>
									<!-- </div> -->
								<div class="input-field col s12 m6 l6 ">
									...
									<input type="text" class="form-control" id="nricNo"
										placeholder="nricNo" name="nricNo" path="nricNo"  value= "${agent.nricNo}" readonly="readonly"/>
									</div>

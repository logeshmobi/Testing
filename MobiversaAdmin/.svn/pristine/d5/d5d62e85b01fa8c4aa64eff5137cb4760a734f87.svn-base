...
<script lang="JavaScript">
	function loadSelectData() {
		...
		if (e == '' &&  e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/fpxSettlementMDRMerchant?date='
	...
	function loadExpData() {
		...
		if (fromdateString == '' &&  e1 == '') {
			...
			document.location.href = '${pageContext.request.contextPath}/MDR/fpxSettlementMDRExport?date=' + fromdateString + '&id=' + e1 +'&export='+e2; 
			//form.submit;
			//document.getElementById("dateval1").value = e;
			//document.getElementById("dateval2").value = e1;
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong>FPX Settlement MDR</strong></h3>
          </div>
					...
					<div class="input-field col s12 m5 l5">
						<select name="merchantName" id="merchantName"   class="browser-default select-filter"
											...
											<c:forEach items="${merchant1}" var="merchant1">
											   <option <c:out value="${merchant1.state}"/>>${merchant1.businessName}~MID~${merchant1.referralId}</option>
											</c:forEach>
										</select>
															</div>	
      ...
      <div class="card border-radius">
        <div class="card-content padding-card">
					...
					<div class="input-field col s12 m4 l4">
						...
						<input type="hidden"
					name="date11" id="date11" <c:out value="${formDate}"/>>
        ...
        <div class="card-content padding-card">
		   ...
		   <div class="table-responsive m-b-20 m-t-15">
            ...
            <thead align="center">
							...
							<th>Host MDR Amount</th>
							<th>Mobi MDR Amount</th>
							<th>Merchant MDR Amount</th>

...
function load() {
	//alert("fcancel data");
	 document.location.href = "${pageContext.request.contextPath}/transactionMoto/motoTransaction";
	form.submit;
}
</script>
      ...
      <div class="card blue-bg text-white">
        <div class="card-content">
          <div class="d-flex align-items-center">
           <h3 class="text-white">  <strong> EZYMOTO Transaction Details</strong> </h3>
          </div>
...
<div class="row">
  <div class="col s12">
      <div class="card border-radius">
		...
		<p><h3 style="color: blue;font-weight: bold;">${rd.responseDescription}</h3></p>
		<div class="d-flex align-items-center">
				 <h3>EZYMOTO Transaction Details</h3>
				 </div>

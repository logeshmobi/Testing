...
function cancel(res){
	...
	if(res =="sale"){
		...
		document.getElementById('status').value ="reverse"
	}
	
	document.getElementById('form1').action = '${pageContext.request.contextPath}/transactionUmweb/umAuthReverseByMerchant';
		...
		<div class="d-flex align-items-center">
			...
			<p><h3 style="color: blue;font-weight: bold;">Transaction Details</h3></p>
				...
				<div class="row">
						...
						<form:input type="hidden" value="${txnDet.h001_MTI}" path="h001_MTI" />
						...
						<form:input id="status" type="hidden" value="" path="status" />
						
						<div class="d-flex align-items-center">
							<h3 class="card-title">UM-EZYAUTH Void Details</h3></div>
							<table class="table table-striped" width="100%">
								...
								<div class="input-field col s12 m6 l6 ">
											<button onclick="cancel('reverse')" class="btn btn-primary" >Void Payment</button>
										</div>
									...
									<div class="input-field col s12 m6 l6 ">
											...
											<a href="${pageContext.request.contextPath}/transactionUmweb/umEzyauthList/1"

...
public class HotelMerchantUMExcel extends AbstractExcelView {
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(9).setCellValue("Merchant Name");
		excelHeader.createCell(10).setCellValue("MID");
		excelHeader.createCell(11).setCellValue("TID");
	...
	public void setExcelRows(HSSFSheet excelSheet, List<UMEzyway> txnList){
		...
		for (UMEzyway txn : txnList) {
			...
			excelRow.createCell(9).setCellValue(txn.getMerchantName());
			excelRow.createCell(10).setCellValue(txn.getF001_MID());
			excelRow.createCell(11).setCellValue(txn.getF354_TID());

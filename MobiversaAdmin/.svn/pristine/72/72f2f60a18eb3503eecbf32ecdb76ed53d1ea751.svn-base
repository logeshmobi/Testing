...
function cancel(){
	...
	document.getElementById('form1').action = '${pageContext.request.contextPath}/transaction1/list/1';
...
<form:form method="post" id="form1" name="form1" commandName="txnDet"
		action="${pageContext.request.contextPath}/transaction/MotoLinkCancelPaymentByAdmin" >
				...
				<div class="row">
						...
						<div class="row">
										<div class="input-field col s12 m6 l6 ">
											...
											<button type="submit" class="btn btn-primary blue-btn" ><a href="${pageContext.request.contextPath}/transaction1/list/1"

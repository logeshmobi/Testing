...
public class EmailTemplet2 {
	...
	public static String sentTempletContent(TempletFields templetFields) {
		...
		return "<!DOCTYPE html><html><head><meta charset=\"ISO-8859-1\"><title></title>"
				...
				+ "<p>Your Merchant login has been created on Mobiversa."
				+ "<a href=\"portal.mobiversa.com\"portal.mobiversa.com </a><br>Your login id and temporary password has been created as below:<br><br>USER ID :<B>"

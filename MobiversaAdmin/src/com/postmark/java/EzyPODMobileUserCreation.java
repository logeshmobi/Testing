...
public class EzyPODMobileUserCreation {

	public static String getEzywireDeviceID(TempletFields templetFields){
		
		String ezywireDeviceID="";
		if(templetFields.getDeviceId()!=null){
		ezywireDeviceID=  "<center><span style=\"font-size:14px\"><span style=\"font-family:arial,helvetica neue,helvetica,sans-serif\">"
				+ "<span lang=\"EN-MY\">"
				/*+ "<font color=\"#000000\">USER ID :</font><strong><font color=\"#000000\">"
				+ templetFields.getUserName() + "</font></strong><br>"
				+ "<font color=\"#000000\">PASSWORD : </font><strong><font color=\"#000000\">"
				+ templetFields.getPassword() + "</font></strong><br>"*/
				+ "<font color=\"#000000\">EZYWIRE DEVICE ID :</font><strong><font color=\"#000000\">"
				+ templetFields.getDeviceId()
				/*+"<br>"
				+ templetFields.getMotodeviceId()
				+"<br>"
				+ templetFields.getEzypassdeviceId()
				+"<br>"*/
				+ "</font></strong></span></span></span></center>";
	}
		return ezywireDeviceID;
		
		
	}
public static String getMotoDeviceID(TempletFields templetFields){
		
		String ezyMotoDeviceID="";
		if(templetFields.getMotodeviceId()!=null){
		ezyMotoDeviceID=  "<center><span style=\"font-size:14px\"><span style=\"font-family:arial,helvetica neue,helvetica,sans-serif\">"
				+ "<span lang=\"EN-MY\">"
				/*+ "<font color=\"#000000\">USER ID :</font><strong><font color=\"#000000\">"
				+ templetFields.getUserName() + "</font></strong><br>"
				+ "<font color=\"#000000\">PASSWORD : </font><strong><font color=\"#000000\">"
				+ templetFields.getPassword() + "</font></strong><br>"*/
				+ "<font color=\"#000000\">MOTO DEVICE ID :</font><strong><font color=\"#000000\">"
				+ templetFields.getMotodeviceId()
				/*+"<br>"
				+ templetFields.getMotodeviceId()
				+"<br>"
		...
		return ezyMotoDeviceID;
		
		
	}
public static String getEzypassDeviceID(TempletFields templetFields){
	
	String ezypassDeviceID="";
	if(templetFields.getEzypassdeviceId()!=null){
	ezypassDeviceID=  "<center><span style=\"font-size:14px\"><span style=\"font-family:arial,helvetica neue,helvetica,sans-serif\">"
			+ "<span lang=\"EN-MY\">"
			/*+ "<font color=\"#000000\">USER ID :</font><strong><font color=\"#000000\">"
			+ templetFields.getUserName() + "</font></strong><br>"
			+ "<font color=\"#000000\">PASSWORD : </font><strong><font color=\"#000000\">"
			+ templetFields.getPassword() + "</font></strong><br>"*/
			+ "<font color=\"#000000\">EZYPASS DEVICE ID :</font><strong><font color=\"#000000\">"
			+ templetFields.getEzypassdeviceId()
			/*+"<br>"
			+ templetFields.getMotodeviceId()
			+"<br>"
	...
	public static String sentTempletContent(TempletFields templetFields) {
		...
		return "<!DOCTYPE html>"
				...
				//+ "                            <h1 style=\"display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;\">Your MobileUser&nbsp;Account Has Been Created</h1>"
				+ "                            <h1 style=\"display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: center;\">Welcome to Mobiversa!.</h1>"// We have created and activated of your EZYWIRE MOBILE APP account.</h1>"
				...
				+ templetFields.getFirstName() + "&nbsp;,<br>" + "<br>"
				
				+ "We welcome you to the Mobiversa family with open arms. We value the opportunity to serve you.  "
				+ "Please activate your account by below given details:  <br>"
				//+ "<br>"
				/*+ "<center><a href=\"http://www.ezywire.com\" style=\"mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #656565;font-weight: normal;text-decoration: underline;\"><span style=\"color:#656565\">"
				+ "ezywire.com</span></a></center>" + "<br>" + "<br>"*/
				//+ "Please use your temporary login username and password as below.<br>"
				//+ "<br>"
				
				//deviceID
				
				+ EzyPODMobileUserCreation.getEzywireDeviceID(templetFields)
				/*+ EmailTemplet13.getMotoDeviceID(templetFields)
				+ EmailTemplet13.getEzypassDeviceID(templetFields)*/
				...
				+ "<font color=\"#000000\">USER ID :</font><strong><font color=\"#000000\">"
				+ templetFields.getUserName() + "</font></strong><br>"
				+ "<font color=\"#000000\"> </font><strong><font color=\"#000000\">"
				+ templetFields.getPassword() + "</font></strong><br>"
				+ "<font color=\"#000000\">MID : </font><strong><font color=\"#000000\">"
				+ templetFields.getEzywayMid() + "</font></strong><br>"
				+ "<font color=\"#000000\">TID : </font><strong><font color=\"#000000\">"
				+ templetFields.getEzywayTid() + "</font></strong><br>"
				+ "<font color=\"#000000\">ApiKey : </font><strong><font color=\"#000000\">"
				+ templetFields.getEzywayApiKey() + "</font></strong><br>"
				*/
				...
				+ "style=\"padding: 9px; font-family:Helvetica;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;\">"
				+ "<center>"
				+ "                    <table width=\"70%\" align=\"center\" class=\"mcnImageContentContainer\" "
				+ "style=\"min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;\" "
				+ "border=\"0\" cellspacing=\"10\" cellpadding=\"0\">"
				+ "                        <tbody>"
				+ "								<tr> <td class=\"mcnImageContent\" valign=\"top\" "
				+ "style=\"text-align: left;color: #3F72D8;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;\">"
				+ "                                  USER ID"
				+ "                            </td>"
				+"<td class=\"mcnImageContent\" valign=\"top\" "
						+ "style=\"width:10%;text-align: center;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;\">"
						+ ":"
						+ "                            </td>"
				+"								<td class=\"mcnImageContent\" valign=\"top\""
				+ " style=\"text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;\">"
				+                                  templetFields.getUserName()     
				+ "                            </td>"
				+ "</tr>"
				//
				+ "								<tr> <td class=\"mcnImageContent\" valign=\"top\" "
				...
				+ "                            </td>"
				+"<td class=\"mcnImageContent\" valign=\"top\" "
				+ "style=\"text-align: center;width:10%;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;\">"
				+ ":"
				+ "                            </td>"
				+"								<td class=\"mcnImageContent\" valign=\"top\" "
				+ "style=\"text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;\">"
				...
				/*+ "<font color=\"#000000\">ACTIVATION CODE :</font><strong><font color=\"#000000\">"
				+ templetFields.getActivationCode()*/
				/*+"<br>"
				+ templetFields.getMotodeviceId()
				+"<br>"
				+ templetFields.getEzypassdeviceId()
				...
				//+ "<br>"
				//+ "This is an auto generated ID and password, please feel free to change your credentials on your first login.
				+"</p>"
				+ "                        </td>" + "                    </tr>"
				+ "                </tbody></table>" + "            </td>"
				+ "        </tr>" + "    </tbody>" + "</table></td>"

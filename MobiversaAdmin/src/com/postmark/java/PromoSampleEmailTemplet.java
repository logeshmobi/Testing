...
public class PromoSampleEmailTemplet {
	...
	public static String sentTempletContent(TempletFields templetFields) {
		...
		return "<!DOCTYPE html>"
				...
				+ "                            <h1 style=\"display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;\">Welcome to EZYWIRE! Our Merchant Promotion have been created our EZYWIRE web portal.</h1>"
*/			//	+ "<p style=\"margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;\">"
				+ "Dear&nbsp;" + templetFields.getFirstName()+ "&nbsp;,<br>" + "<br>"
				//+ templetFields.getFirstName() + "&nbsp;,<br>" + "<br>"
				+  "&nbsp;" + "&nbsp;" +"&nbsp;"+"&nbsp;" + "&nbsp;" + "&nbsp;" + " Our merchant EZYAds has been created on Mobiversa Merchant Web Portal.Kindly&nbsp;do action &nbsp;for merchant EZYAds in Ezywire Admin portal.<br>"
				+ "<br>"
				//+ "<a href=\"http://www.ezywire.com\" style=\"mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #656565;font-weight: normal;text-decoration: underline;\"><span style=\"color:#656565\">"
				//+ "ezywire.com</span></a>" + "<br>" + "<br>"
				+ "Merchant name and EZYAds code as below.<br>"
				+ "<br>"
				+ "<span style=\"font-size:14px\"><span style=\"font-family:arial,helvetica neue,helvetica,sans-serif\"><span lang=\"EN-MY\">"
				+ "<font color=\"#000000\">MERCHANT NAME :</font><strong><font color=\"#000000\">"
				+ templetFields.getMerchantName() + "</font></strong><br>"
				+ "<font color=\"#000000\">EZYAds CODE : </font><strong><font color=\"#000000\">"
				+ templetFields.getPromoCode()
				+ "</font></strong></span></span></span><br>" + "<br>"
				//+ "In case you need any clarification, please contact <i>info@gomobi.io</i>.<br>"
				+ "<br>"
				+ "This is an auto generated Mail.</p>"
				+ "                        </td>" + "                    </tr>"
				+ "                </tbody></table>" + "            </td>"
				+ "        </tr>" + "    </tbody>" + "</table></td>"
				+ "                            </tr>"

...
public class EmailTemplet12 {
	...
	public static String sentTempletContent(TempletFields templetFields) {
		...
		return "<!DOCTYPE html>"
				...
				+ "                            <h1 style=\"display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;\">Welcome to Mobiversa! We have created and activated of your Mobiversa MOBILE APP account.</h1>"
				...
				+ "Congratulations! your Mobileuser account has been created on Mobiversa. Please&nbsp;follow the&nbsp;link below to sign into your account :<br>"
				+ "<br>"

...
public class UMMerchantWireTxnExcel extends AbstractExcelView {
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(14).setCellValue("PREAUTH Fee");
		excelHeader.createCell(15).setCellValue("Payment Date");
	...
	public void setExcelRows(HSSFSheet excelSheet, List<UMEzyway> txnList){
		...
		for (UMEzyway txn : txnList) {
			...
			excelRow.createCell(11).setCellValue(txn.getCardscheme()+ " " +txn.getCardType());		
			excelRow.createCell(12).setCellValue(txn.getMdrAmt());
			excelRow.createCell(13).setCellValue(txn.getNetAmount());
			excelRow.createCell(14).setCellValue(txn.getPreauthfee());
			excelRow.createCell(15).setCellValue(txn.getSettlementDate());
		}
	}

...
public class BnplListExcel extends AbstractExcelView {

	@Override
	protected void buildExcelDocument(Map model, HSSFWorkbook workbook, HttpServletRequest request,
			HttpServletResponse response) throws Exception {

		HSSFSheet excelSheet = workbook.createSheet("BNPL Transaction List");
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(12).setCellValue("Sub Merchant Mid");
	...
	public void setExcelRows(HSSFSheet excelSheet, List<SettlementModel> txnList) {
		...
		for (SettlementModel txn : txnList) {
			...
			excelRow.createCell(12).setCellValue(txn.getSubmerchantid());

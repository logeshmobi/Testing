...
public class UMMerchantFailExcel extends AbstractExcelView {
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(10).setCellValue("MRN");
		excelHeader.createCell(11).setCellValue("Status");		
		excelHeader.createCell(12).setCellValue("Payment Method");	
		excelHeader.createCell(13).setCellValue("Response Message");
	...
	public void setExcelRows(HSSFSheet excelSheet, List<UMEzyway> txnList){
		...
		for (UMEzyway txn : txnList) {
			...
			excelRow.createCell(10).setCellValue(txn.getF263_MRN());
			excelRow.createCell(11).setCellValue(txn.getSTATUS());
			excelRow.createCell(12).setCellValue(txn.getCardType());
			excelRow.createCell(13).setCellValue(txn.getRespMessage());

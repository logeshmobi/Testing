...
public class fpxSettlementMerchantTxnExcel extends AbstractExcelView {
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(4).setCellValue("Net Amount");
		excelHeader.createCell(5).setCellValue("Mdr Amount");
		excelHeader.createCell(6).setCellValue("Reference");
		excelHeader.createCell(7).setCellValue("Sub Merchant MID");
	...
	public void setExcelRows(HSSFSheet excelSheet, List<FpxTransaction> txnList){
		...
		for (FpxTransaction txn : txnList) {
			...
			excelRow.createCell(6).setCellValue(txn.getSellerOrderNo());
			excelRow.createCell(7).setCellValue(txn.getSubMerchantMID());

...
public class UMMerchantEnquiryExcel extends AbstractExcelView {
	...
	public void setExcelHeader(HSSFSheet excelSheet) {
		...
		excelHeader.createCell(8).setCellValue("Response Message");
	...
	public void setExcelRows(HSSFSheet excelSheet, List<UMEzyway> txnList){
		...
		for (UMEzyway txn : txnList) {
			...
			excelRow.createCell(8).setCellValue(txn.getRespMessage());

...
public class MerchantTxnListExcelView extends AbstractExcelView {
	...
	public void setExcelRows(HSSFSheet excelSheet, List<ForSettlement> txnList){
		...
		for (ForSettlement txn : txnList) {
			...
			excelRow.createCell(5).setCellValue(txn.getCardType());
			excelRow.createCell(6).setCellValue(txn.getTid());
			excelRow.createCell(7).setCellValue(txn.getTxnType());
			excelRow.createCell(8).setCellValue(txn.getMid());

...
public class MotoTxnDet 
{
	...
	public String getReceiptVia() {
		return receiptVia;
	}
	public void setReceiptVia(String receiptVia) {
		this.receiptVia = receiptVia;
	}
	public String getMultiOption() {
		return multiOption;
	}
	public void setMultiOption(String multiOption) {
